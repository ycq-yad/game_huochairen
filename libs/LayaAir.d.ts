...
declare module Laya {
	...
	class Bone {
		...
		parentBone: Bone;
		length: number;
		transform: Laya.Transform;
		resultTransform: Laya.Transform;
		resultMatrix: Laya.Matrix;
		...
		constructor();
		setTempMatrix(matrix: Laya.Matrix): void;
		update(pMatrix?: Laya.Matrix | null): void;
		updateChild(): void;
...
declare module Laya {
	class BoneSlot {
		 ...
		 * 显示对象对应的数据
		 */
		currDisplayData: Laya.SkinSlotDisplayData | null;
		 ...
		 */
		showSlotData(slotData: Laya.SlotData, freshIndex?: boolean): void;
		 ...
		 * @param parentMatrix 
		 */
		setParentMatrix(parentMatrix: Laya.Matrix): void;
		...
		static isSameMatrix(mtA: Laya.Matrix, mtB: Laya.Matrix): boolean;
...
declare module Laya.canvasmesh {
	...
	class MeshData {
		 ...
		 * @return 
		 */
		getBounds(): Laya.Rectangle;
	}

}

declare module Laya.canvasmesh {
	class SkinMeshForGraphic extends Laya.canvasmesh.MeshData {
...
<td>2</td> <td>使用动态方式，去实时去画（内存开销小，计算开销大，支持换装,不建议使用）</td>
		 ...
		 */
		init(templet: Laya.Templet, aniMode?: number): void;
		 ...
		 * @return 插槽的引用
		 */
		getSlotByName(name: string): Laya.BoneSlot;
...
declare module Laya {
	...
	class Templet extends laya.ani.AnimationTemplet {
		 ...
		 * 实际显示对象列表，用于销毁用
		 */
		skinSlotDisplayDataArr: Laya.SkinSlotDisplayData[];
		 ...
		 * @return 
		 */
		buildArmature(aniMode?: number): Laya.Skeleton;
...
declare module Laya {
	class Transform {
		...
		getMatrix(): Laya.Matrix;
		skew(m: Laya.Matrix, x: number, y: number): Laya.Matrix;
	}
...
declare module laya.ani {
	class GraphicsAni extends laya.display.Graphics {
		 ...
		 * @param skin 
		 */
		drawSkin(skinA: Laya.canvasmesh.SkinMeshForGraphic, alpha: number): void;
...
declare module Laya {
	...
	class AnimationClip extends laya.resource.Resource {
		 ...
		 * 添加动画事件。
		 */
		addEvent(event: Laya.AnimationEvent): void;
...
declare module Laya {
	...
	class AnimationTransform3D extends laya.events.EventDispatcher {
		...
		constructor(owner: Laya.AnimationNode, localPosition?: Float32Array, localRotation?: Float32Array, localScale?: Float32Array, worldMatrix?: Float32Array);
...
declare module laya.d3.component {
	...
	class AnimatorState implements laya.d3.resource.IReferenceCounter, laya.d3.core.IClone {
		 ...
		 * @return 脚本。
		 */
		addScript(type: new () => any): Laya.AnimatorStateScript;
		 ...
		 * @return 脚本。
		 */
		getScript(type: new () => any): Laya.AnimatorStateScript;
		 ...
		 * @return 脚本集合。
		 */
		getScripts(type: new () => any): Laya.AnimatorStateScript[];
...
declare module laya.display.cmd {
	...
	class DrawTextureCmd {
		 ...
		 * @private 
		 */
		static create(texture: laya.resource.Texture, x: number, y: number, width: number, height: number, matrix: Laya.Matrix, alpha: number, color: string, blendMode: string, uv?: number[]): DrawTextureCmd;
...
declare module laya.display.cmd {
	...
	class DrawTrianglesCmd {
		 ...
		 * @private 
		 */
		static create(texture: laya.resource.Texture, x: number, y: number, vertices: Float32Array, uvs: Float32Array, indices: Uint16Array, matrix: Laya.Matrix, alpha: number, color: string, blendMode: string, colorNum: number): DrawTrianglesCmd;
...
declare module laya.display.cmd {
	...
	class FillTextureCmd {
		 ...
		 * @private 
		 */
		static create(texture: laya.resource.Texture, x: number, y: number, width: number, height: number, type: string, offset: Laya.Point, other: any): FillTextureCmd;
...
declare module laya.display.cmd {
	...
	class TransformCmd {
		 ...
		 * @private 
		 */
		static create(matrix: Laya.Matrix, pivotX: number, pivotY: number): TransformCmd;
...
declare module laya.display {
	...
	class Graphics {
		 ...
		 */
		getBounds(realSize?: boolean): Laya.Rectangle;
...
获取端点列表。
		 ...
		 */
		drawTexture(texture: laya.resource.Texture | null, x?: number, y?: number, width?: number, height?: number, matrix?: Laya.Matrix | null, alpha?: number, color?: string | null, blendMode?: string | null, uv?: number[]): laya.display.cmd.DrawTextureCmd | null;
		 ...
		 */
		drawTriangles(texture: laya.resource.Texture, x: number, y: number, vertices: Float32Array, uvs: Float32Array, indices: Uint16Array, matrix?: Laya.Matrix, alpha?: number, color?: string, blendMode?: string, colorNum?: number): laya.display.cmd.DrawTrianglesCmd;
		 ...
		 */
		fillTexture(texture: laya.resource.Texture, x: number, y: number, width?: number, height?: number, type?: string, offset?: Laya.Point | null): laya.display.cmd.FillTextureCmd | null;
		 ...
		 */
		transform(matrix: Laya.Matrix, pivotX?: number, pivotY?: number): laya.display.cmd.TransformCmd;
...
declare module laya.display {
	...
	class Node extends laya.events.EventDispatcher {
		...
		_addComponentInstance(comp: laya.components.Component): any;
...
class Sprite_Example {
	...
	class Sprite extends laya.display.Node {
		 ...
		 */
		setSelfBounds(bound: Laya.Rectangle): void;
		 ...
		 */
		getGraphicBounds(realSize?: boolean): Laya.Rectangle;
		 ...
		 * @private 
		 */
		protected _adjustTransform(): Laya.Matrix;

		/**
		 * <p>对象的矩阵信息。通过设置矩阵可以实现节点旋转，缩放，位移效果。</p>
		 * <p>矩阵更多信息请参考 <code>Matrix</code></p>
		 */
		transform: Laya.Matrix;
		get_transform(): Laya.Matrix;
		set_transform(value: Laya.Matrix): void;
		 ...
		 * @return 转换后的坐标的点。
		 */
		localToGlobal(point: Laya.Point, createNewPoint?: boolean, globalNode?: Sprite): Laya.Point;
		 ...
		 * @return 转换后的坐标的点。
		 */
		globalToLocal(point: Laya.Point, createNewPoint?: boolean, globalNode?: Sprite): Laya.Point;
		 ...
		 * @return 转换后的点。
		 */
		toParentPoint(point: Laya.Point): Laya.Point;
		 ...
		 * @return 转换后的点。
		 */
		fromParentPoint(point: Laya.Point): Laya.Point;
		 ...
		 * @return 转换后的点。
		 */
		fromStagePoint(point: Laya.Point): Laya.Point;
		 ...
		 */
		startDrag(area?: Laya.Rectangle, hasInertia?: boolean, elasticDistance?: number, elasticBackTime?: number, data?: any, disableMouseEvent?: boolean, ratio?: number): void;
...
function onInit()
{
	...
	class Text extends laya.display.Sprite {
		 ...
		 * @private 
		 */
		protected _words: Laya.WordText[] | null;
		 ...
		 */
		getCharPoint(charIndex: number, out?: Laya.Point): Laya.Point;
...
declare module laya.filters {
	...
	class Filter implements laya.filters.IFilter {
		 ...
		 */
		readonly type: number;
		static _filter: (sprite: Laya.Sprite, context: Laya.Context, x: number, y: number) => void;
	}
...
declare module laya.map {
	...
	class MapLayer extends laya.display.Sprite {
		 ...
		 */
		getScreenPositionByTilePos(tileX: number, tileY: number, screenPos?: Laya.Point): void;
		 ...
		 * @return 
		 */
		getTilePositionByScreenPos(screenX: number, screenY: number, result?: Laya.Point): boolean;
...
declare module laya.map {
	...
	class TiledMap {
		 ...
		 */
		createMap(mapName: string, viewRect: Laya.Rectangle, completeHandler: laya.utils.Handler, viewRectPadding?: Laya.Rectangle, gridSize?: Laya.Point, enableLinear?: boolean, limitRange?: boolean): void;
		 ...
		 * @return 
		 */
		changeViewPortBySize(width: number, height: number, rect?: Laya.Rectangle): Laya.Rectangle;
...
declare module Laya {
	...
	class GrahamScan {
		...
		static multiply(p1: Laya.Point, p2: Laya.Point, p0: Laya.Point): number;
		 ...
		 * @return 
		 */
		static dis(p1: Laya.Point, p2: Laya.Point): number;
...
declare module Laya {
	...
	class Matrix {
		 ...
		 * @return 返回out
		 */
		invertTransformPoint(out: Laya.Point): Laya.Point;
		 ...
		 * @return 返回out
		 */
		transformPoint(out: Laya.Point): Laya.Point;
		 ...
		 * @return 返回out
		 */
		transformPointN(out: Laya.Point): Laya.Point;
...
declare module laya.resource {
	...
	class Context {
		...
		static MAXCLIPRECT: Laya.Rectangle;
		 ...
		 * @private 
		 */
		drawTexture2(x: number, y: number, pivotX: number, pivotY: number, m: Laya.Matrix, args2: any[]): void;
		transformByMatrix(matrix: Laya.Matrix, tx: number, ty: number): void;
		saveTransform(matrix: Laya.Matrix): void;
		restoreTransform(matrix: Laya.Matrix): void;
		...
		fillTexture(texture: laya.resource.Texture, x: number, y: number, width: number, height: number, type: string, offset: Laya.Point, other: any): void;
		 ...
		 * @param out 输出
		 */
		transform4Points(a: any[], m: Laya.Matrix, out: any[]): void;
		 ...
		 */
		transformQuad(x: number, y: number, w: number, h: number, italicDeg: number, m: Laya.Matrix, out: any[]): void;
		pushRT(): void;
		popRT(): void;
		 ...
		 * @param alpha 
		 */
		drawTextureWithTransform(tex: laya.resource.Texture, x: number, y: number, width: number, height: number, transform: Laya.Matrix, tx: number, ty: number, alpha: number, blendMode: string, colorfilter?: laya.filters.ColorFilter, uv?: number[]): void;
		...
		drawTarget(rt: laya.resource.RenderTexture2D, x: number, y: number, width: number, height: number, m: Laya.Matrix, shaderValue: laya.webgl.shader.d2.value.Value2D, uv?: ArrayLike<number>, blend?: number): boolean;
		drawTriangles(tex: laya.resource.Texture, x: number, y: number, vertices: Float32Array, uvs: Float32Array, indices: Uint16Array, matrix: Laya.Matrix, alpha: number, color: laya.filters.ColorFilter, blendMode: string, colorNum?: number): void;
		transform(a: number, b: number, c: number, d: number, tx: number, ty: number): void;
		setTransformByMatrix(value: Laya.Matrix): void;
		 ...
		 * @param offset 
		 */
		drawMesh(x: number, y: number, ib: laya.webgl.utils.IndexBuffer2D, vb: laya.webgl.utils.VertexBuffer2D, numElement: number, mat: Laya.Matrix, shader: laya.webgl.shader.Shader, shaderValues: laya.webgl.shader.d2.value.Value2D, startIndex?: number): void;
...
declare module laya.ui {
	...
	class ScrollBar extends laya.ui.UIComponent {
		 ...
		 * @private 
		 */
		protected _lastPoint: Laya.Point;
...
declare module laya.ui {
	...
	class Slider extends laya.ui.UIComponent {
		 ...
		 * @private 
		 */
		protected _globalSacle: Laya.Point;
...
declare module laya.utils {
	...
	class Dragging {
		 ...
		 * @param ratio 惯性阻尼系数
		 */
		start(target: laya.display.Sprite, area: Laya.Rectangle, hasInertia: boolean, elasticDistance: number, elasticBackTime: number, data: any, disableMouseEvent: boolean, ratio?: number): void;
...
declare module laya.utils {
	...
	class GraphicAnimation extends laya.display.FrameAnimation {
		...
		protected _updateNodeGraphic(node: any, frame: number, parentTransfrom: Laya.Matrix, g: laya.display.Graphics, alpha?: number): void;
...
<b>注意：</b>若 参数 a 不为空，则会改变参数 source 的值为连接后的数组。
		 ...
		 */
		static getGlobalRecByPoints(sprite: laya.display.Sprite, x0: number, y0: number, x1: number, y1: number): Laya.Rectangle;
		 ...
		 */
		static getGlobalPosAndScale(sprite: laya.display.Sprite): Laya.Rectangle;
...
declare module laya.webgl.text {
	class AtlasGrid {
		...
		addRect(type: number, width: number, height: number, pt: Laya.Point): boolean;
...
declare module laya.webgl.text {
	...
	class TextAtlas {
		 ...
		 * @return 
		 */
		getAEmpty(w: number, h: number, pt: Laya.Point): boolean;
...
declare module laya.webgl.text {
	class TextRender {
		...
		_fast_filltext(ctx: laya.resource.Context, data: string | laya.utils.WordText | null, htmlchars: Laya.HTMLChar[] | null, x: number, y: number, font: laya.utils.FontInfo, color: string, strokeColor: string, lineWidth: number, textAlign: number, underLine?: number): void;
...
declare module laya.webgl.utils {
	...
	class MeshTexture extends laya.webgl.utils.Mesh2D {
		...
		addData(vertices: Float32Array, uvs: Float32Array, idx: Uint16Array, matrix: Laya.Matrix, rgba: number): void;
...
declare module laya.webgl.utils {
	class RenderState2D {
		...
		static worldMatrix: Laya.Matrix;
		static matWVP: any;
		...
		static mat2MatArray(mat: Laya.Matrix, matArray: any[]): any[];
...
declare module Laya {
	...
	// class Bone extends  Laya.Bone {}

	// class BoneSlot extends  Laya.BoneSlot {}

	/**
	 */

	class MeshData extends Laya.canvasmesh.MeshData { }

	class SkinMeshForGraphic extends Laya.canvasmesh.SkinMeshForGraphic { }

	// class EventData extends  Laya.EventData {}
	...
	// class Skeleton extends  Laya.Skeleton {}

	// class SkinSlotDisplayData extends  Laya.SkinSlotDisplayData {}

	// class SlotData extends  Laya.SlotData {}
	...
	// class Templet extends  Laya.Templet {}

	// class Transform extends  Laya.Transform {}
	...
	// class AnimationClip extends  Laya.AnimationClip {}

	/**
	 * <code>AnimationEvent</code> 类用于实现动画事件。
	 */

	// class AnimationEvent extends  Laya.AnimationEvent {}

	/**
	 * <code>BoneNode</code> 类用于实现骨骼节点。
	 */

	// class AnimationNode extends  Laya.AnimationNode {}

	/**
	 * <code>AnimationTransform3D</code> 类用于实现3D变换。
	 */

	// class AnimationTransform3D extends  Laya.AnimationTransform3D {}
...
对HTML的显示对象进行排版
	...
	// class Bezier extends  Laya.Bezier {}

	/**
	 * @private 凸包算法。
	 */

	// class GrahamScan extends  Laya.GrahamScan {}

	/**
	 * @private <code>MathUtil</code> 是一个数据处理工具类。
	 */

	// class MathUtil extends  Laya.MathUtil {}
	...
	// class Matrix extends  Laya.Matrix {}
