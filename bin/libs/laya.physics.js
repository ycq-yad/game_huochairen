...
goog.exportSymbol("box2d.b2_minParticleSystemBufferCapacity", box2d.b2_minParticleSystemBufferCapacity);
box2d.b2_barrierCollisionTime = 2.5;
goog.exportSymbol("box2d.b2_barrierCollisionTime", box2d.b2_barrierCollisionTime);
...
box2d.b2Color.prototype.MakeStyleString = function (a) {
    return box2d.b2Color.MakeStyleString(Math.round(Math.max(0, Math.min(255, 255 * this.r))), Math.round(Math.max(0, Math.min(255, 255 * this.g))), Math.round(Math.max(0, Math.min(255, 255 * this.b))), "undefined" === typeof a ? this.a : Math.max(0, Math.min(1, a)))
}
    ;
...
box2d.b2Draw.prototype.DrawParticles = function (a, b, c, d) { }
    ;
goog.exportProperty(box2d.b2Draw.prototype, "DrawParticles", box2d.b2Draw.prototype.DrawParticles);
...
box2d.b2Wrap = function (a, b, c) {
    return b < c ? a < b ? c - (b - a) % (c - b) : b + (a - b) % (c - b) : b === c ? b : a
}
    ;
goog.exportSymbol("box2d.b2Wrap", box2d.b2Wrap);
box2d.b2WrapAngle = function (a) {
    return 0 > a ? (a - box2d.b2_pi) % box2d.b2_two_pi + box2d.b2_pi : (a + box2d.b2_pi) % box2d.b2_two_pi - box2d.b2_pi
}
    ;
...
box2d.b2Mat33.prototype.GetSymInverse33 = function (a) {
    var b = box2d.b2Dot_V3_V3(this.ex, box2d.b2Cross_V3_V3(this.ey, this.ez, box2d.b2Vec3.s_t0));
    0 !== b && (b = 1 / b);
    var c = this.ex.x
        , d = this.ey.x
        , e = this.ez.x
...
box2d.b2Rot.prototype.Set = function (a) {
    Math.abs(this.angle - a) >= box2d.b2_epsilon && (this.angle = a,
        this.s = Math.sin(a),
        this.c = Math.cos(a));
    return this
}
...
box2d.b2Cross = function (a, b, c) {
    ...
    if (a instanceof box2d.b2Vec2 && "number" === typeof b && c instanceof box2d.b2Vec2)
        return box2d.b2Cross_V2_S(a, b, c);
    if ("number" === typeof a && b instanceof box2d.b2Vec2 && c instanceof box2d.b2Vec2)
        return box2d.b2Cross_S_V2(a, b, c);
    if (a instanceof box2d.b2Vec3 && b instanceof box2d.b2Vec3 && c instanceof box2d.b2Vec3)
...
box2d.b2Add = function (a, b, c) {
    if (a instanceof box2d.b2Vec2 && b instanceof box2d.b2Vec2 && c instanceof box2d.b2Vec2)
...
box2d.b2Mul = function (a, b, c) {
    if (a instanceof box2d.b2Mat22 && b instanceof box2d.b2Vec2 && c instanceof box2d.b2Vec2)
        return box2d.b2Mul_M22_V2(a, b, c);
    if (a instanceof box2d.b2Mat22 && b instanceof box2d.b2Mat22 && c instanceof box2d.b2Mat22)
        return box2d.b2Mul_M22_M22(a, b, c);
    if (a instanceof box2d.b2Mat33 && b instanceof box2d.b2Vec3 && c instanceof box2d.b2Vec3)
        return box2d.b2Mul_M33_V3(a, b, c);
    if (a instanceof box2d.b2Rot && b instanceof box2d.b2Rot && c instanceof box2d.b2Rot)
        return box2d.b2Mul_R_R(a, b, c);
    if (a instanceof box2d.b2Rot && b instanceof box2d.b2Vec2 && c instanceof box2d.b2Vec2)
        return box2d.b2Mul_R_V2(a, b, c);
    if (a instanceof box2d.b2Transform && b instanceof box2d.b2Vec2 && c instanceof box2d.b2Vec2)
        return box2d.b2Mul_X_V2(a, b, c);
    if (a instanceof box2d.b2Transform && b instanceof box2d.b2Transform && c instanceof box2d.b2Transform)
...
box2d.b2DistanceProxy.prototype.GetSupport = function (a) {
    for (var b = 0, c = box2d.b2Dot_V2_V2(this.m_vertices[0], a), d = 1; d < this.m_count; ++d) {
...
box2d.b2DistanceProxy.prototype.GetSupportVertex = function (a, b) {
    for (var c = 0, d = box2d.b2Dot_V2_V2(this.m_vertices[0], a), e = 1; e < this.m_count; ++e) {
...
box2d.b2Simplex.prototype.ReadCache = function (a, b, c, d, e) {
    ...
    1 < this.m_count && (a = a.metric,
        g = this.GetMetric(),
        g < .5 * a || 2 * a < g || g < box2d.b2_epsilon) && (this.m_count = 0);
...
box2d.b2Simplex.prototype.GetSearchDirection = function (a) {
    switch (this.m_count) {
        ...
        case 2:
            ...
            return 0 < box2d.b2Cross_V2_V2(b, box2d.b2Vec2.s_t0.Copy(this.m_v1.w).SelfNeg()) ? box2d.b2Cross_S_V2(1, b, a) : box2d.b2Cross_V2_S(b, 1, a);
        default:
...
box2d.b2Simplex.prototype.Solve2 = function () {
    ...
    0 >= a ? this.m_count = this.m_v1.a = 1 : (b = box2d.b2Dot_V2_V2(b, c),
        0 >= b ? (this.m_count = this.m_v2.a = 1,
            this.m_v1.Copy(this.m_v2)) : (c = 1 / (b + a),
                this.m_v1.a = b * c,
                this.m_v2.a = a * c,
                this.m_count = 2))
}
...
box2d.b2Simplex.prototype.Solve3 = function () {
    ...
    0 >= e && 0 >= h ? this.m_count = this.m_v1.a = 1 : 0 < f && 0 < e && 0 >= a ? (k = 1 / (f + e),
        this.m_v1.a = f * k,
        this.m_v2.a = e * k,
        this.m_count = 2) : 0 < k && 0 < h && 0 >= c ? (f = 1 / (k + h),
            this.m_v1.a = k * f,
            this.m_v3.a = h * f,
            this.m_count = 2,
            this.m_v2.Copy(this.m_v3)) : 0 >= f && 0 >= m ? (this.m_count = this.m_v2.a = 1,
                this.m_v1.Copy(this.m_v2)) : 0 >= k && 0 >= l ? (this.m_count = this.m_v3.a = 1,
                    this.m_v1.Copy(this.m_v3)) : 0 < l && 0 < m && 0 >= d ? (f = 1 / (l + m),
                        this.m_v2.a = l * f,
                        this.m_v3.a = m * f,
                        this.m_count = 2,
                        this.m_v1.Copy(this.m_v3)) : (f = 1 / (d + c + a),
                            this.m_v1.a = d * f,
                            this.m_v2.a = c * f,
                            this.m_v3.a = a * f,
                            this.m_count = 3)
...
box2d.b2ShapeDistance = function (a, b, c) {
    ...
    for (var k = h.m_vertices, l = box2d.b2Distance.s_saveA, m = box2d.b2Distance.s_saveB, n = 0, p = 0; 20 > p;) {
        ...
        if (q.LengthSquared() < box2d.b2_epsilon_sq)
            break;
        r = k[h.m_count];
        r.indexA = d.GetSupport(box2d.b2MulT_R_V2(f.q, box2d.b2Vec2.s_t0.Copy(q).SelfNeg(), box2d.b2Distance.s_supportA));
        box2d.b2Mul_X_V2(f, d.GetVertex(r.indexA), r.wA);
        r.indexB = e.GetSupport(box2d.b2MulT_R_V2(g.q, q, box2d.b2Distance.s_supportB));
    ...
    a.iterations = p;
    h.WriteCache(b);
    c.useRadii && (b = d.m_radius,
        e = e.m_radius,
        a.distance > b + e && a.distance > box2d.b2_epsilon ? (a.distance -= b + e,
            c = box2d.b2Sub_V2_V2(a.pointB, a.pointA, box2d.b2Distance.s_normal),
            c.Normalize(),
            a.pointA.SelfMulAdd(b, c),
            a.pointB.SelfMulSub(e, c)) : (r = box2d.b2Mid_V2_V2(a.pointA, a.pointB, box2d.b2Distance.s_p),
                a.pointA.Copy(r),
                a.pointB.Copy(r),
                a.distance = 0))
}
...
goog.exportProperty(box2d.b2ContactFeature.prototype, "_key", box2d.b2ContactFeature.prototype._key);
box2d.b2ContactFeature.prototype._key_invalid = !1;
goog.exportProperty(box2d.b2ContactFeature.prototype, "_key_invalid", box2d.b2ContactFeature.prototype._key_invalid);
...
Object.defineProperty(box2d.b2ContactFeature.prototype, "key", {
    ...
    configurable: !0,
    get: function () {
        this._key_invalid && (this._key_invalid = !1,
    ...
    if (0 !== a.pointCount)
        switch (a.type) {
            case box2d.b2ManifoldType.e_circles:
                this.normal.Set(1, 0);
                b = box2d.b2Mul_X_V2(b, a.localPoint, box2d.b2WorldManifold.prototype.Initialize.s_pointA);
                a = box2d.b2Mul_X_V2(d, a.points[0].localPoint, box2d.b2WorldManifold.prototype.Initialize.s_pointB);
                box2d.b2DistanceSquared(b, a) > box2d.b2_epsilon_sq && box2d.b2Sub_V2_V2(a, b, this.normal).SelfNormalize();
                var f = box2d.b2AddMul_V2_S_V2(b, c, this.normal, box2d.b2WorldManifold.prototype.Initialize.s_cA)
                    , g = box2d.b2SubMul_V2_S_V2(a, e, this.normal, box2d.b2WorldManifold.prototype.Initialize.s_cB);
                box2d.b2Mid_V2_V2(f, g, this.points[0]);
                this.separations[0] = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(g, f, box2d.b2Vec2.s_t0), this.normal);
                break;
            case box2d.b2ManifoldType.e_faceA:
                box2d.b2Mul_R_V2(b.q, a.localNormal, this.normal);
                for (var h = box2d.b2Mul_X_V2(b, a.localPoint, box2d.b2WorldManifold.prototype.Initialize.s_planePoint), k = 0, l = a.pointCount; k < l; ++k) {
                    var m = box2d.b2Mul_X_V2(d, a.points[k].localPoint, box2d.b2WorldManifold.prototype.Initialize.s_clipPoint)
                        , f = c - box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(m, h, box2d.b2Vec2.s_t0), this.normal)
                        , f = box2d.b2AddMul_V2_S_V2(m, f, this.normal, box2d.b2WorldManifold.prototype.Initialize.s_cA)
                        , g = box2d.b2SubMul_V2_S_V2(m, e, this.normal, box2d.b2WorldManifold.prototype.Initialize.s_cB);
                    box2d.b2Mid_V2_V2(f, g, this.points[k]);
                    this.separations[k] = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(g, f, box2d.b2Vec2.s_t0), this.normal)
                }
                break;
            case box2d.b2ManifoldType.e_faceB:
                box2d.b2Mul_R_V2(d.q, a.localNormal, this.normal);
                h = box2d.b2Mul_X_V2(d, a.localPoint, box2d.b2WorldManifold.prototype.Initialize.s_planePoint);
                k = 0;
                for (l = a.pointCount; k < l; ++k)
                    m = box2d.b2Mul_X_V2(b, a.points[k].localPoint, box2d.b2WorldManifold.prototype.Initialize.s_clipPoint),
                        f = e - box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(m, h, box2d.b2Vec2.s_t0), this.normal),
                        g = box2d.b2AddMul_V2_S_V2(m, f, this.normal, box2d.b2WorldManifold.prototype.Initialize.s_cB),
                        f = box2d.b2SubMul_V2_S_V2(m, c, this.normal, box2d.b2WorldManifold.prototype.Initialize.s_cA),
                        box2d.b2Mid_V2_V2(f, g, this.points[k]),
                        this.separations[k] = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(f, g, box2d.b2Vec2.s_t0), this.normal);
                this.normal.SelfNeg()
        }
}
    ;
...
box2d.b2AABB.prototype.RayCast = function (a, b) {
    ...
    if (k < box2d.b2_epsilon) {
        if (e < this.lowerBound.x || this.upperBound.x < e)
            return !1
    } else if (k = 1 / g,
...
box2d.b2TestOverlap = function (a, b, c, d, e, f) {
    ...
    if (a instanceof box2d.b2Shape && "number" === typeof b && c instanceof box2d.b2Shape && "number" === typeof d && e instanceof box2d.b2Transform && f instanceof box2d.b2Transform)
...
box2d.b2CollideCircles = function (a, b, c, d, e) {
    ...
    e > c * c || (a.type = box2d.b2ManifoldType.e_circles,
...
box2d.b2CollidePolygonAndCircle = function (a, b, c, d, e) {
    ...
    b = b.m_normals;
    for (var l = 0; l < h; ++l) {
        var m = box2d.b2Dot_V2_V2(b[l], box2d.b2Sub_V2_V2(c, k[l], box2d.b2Vec2.s_t0));
        if (m > e)
            return;
        m > g && (g = m,
            f = l)
    ...
    m = k[l];
    h = k[(l + 1) % h];
    g < box2d.b2_epsilon ? (a.pointCount = 1,
        a.type = box2d.b2ManifoldType.e_faceA,
        a.localNormal.Copy(b[f]),
        box2d.b2Mid_V2_V2(m, h, a.localPoint),
        a.points[0].localPoint.Copy(d.m_p),
        a.points[0].id.key = 0) : (g = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(c, m, box2d.b2Vec2.s_t0), box2d.b2Sub_V2_V2(h, m, box2d.b2Vec2.s_t1)),
            f = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(c, h, box2d.b2Vec2.s_t0), box2d.b2Sub_V2_V2(m, h, box2d.b2Vec2.s_t1)),
            0 >= g ? box2d.b2DistanceSquared(c, m) > e * e || (a.pointCount = 1,
                a.type = box2d.b2ManifoldType.e_faceA,
                box2d.b2Sub_V2_V2(c, m, a.localNormal).SelfNormalize(),
                a.localPoint.Copy(m),
                a.points[0].localPoint.Copy(d.m_p),
                a.points[0].id.key = 0) : 0 >= f ? box2d.b2DistanceSquared(c, h) > e * e || (a.pointCount = 1,
                    a.type = box2d.b2ManifoldType.e_faceA,
                    box2d.b2Sub_V2_V2(c, h, a.localNormal).SelfNormalize(),
                    a.localPoint.Copy(h),
                    a.points[0].localPoint.Copy(d.m_p),
                    a.points[0].id.key = 0) : (f = box2d.b2Mid_V2_V2(m, h, box2d.b2CollidePolygonAndCircle.s_faceCenter),
                        g = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(c, f, box2d.b2Vec2.s_t1), b[l]),
                        g > e || (a.pointCount = 1,
                            a.type = box2d.b2ManifoldType.e_faceA,
...
box2d.b2CollideEdgeAndCircle = function (a, b, c, d, e) {
    a.pointCount = 0;
    c = box2d.b2MulT_X_V2(c, box2d.b2Mul_X_V2(e, d.m_p, box2d.b2Vec2.s_t0), box2d.b2CollideEdgeAndCircle.s_Q);
    var f = b.m_vertex1
        , g = b.m_vertex2
    ...
    if (0 >= l) {
        ...
        if (!(k > m * m)) {
            if (b.m_hasVertex0 && (b = box2d.b2Sub_V2_V2(f, b.m_vertex0, box2d.b2CollideEdgeAndCircle.s_e1),
        ...
        if (n = g,
            ...
            k = box2d.b2Dot_V2_V2(k, k),
            !(k > m * m)) {
            if (b.m_hasVertex3 && (f = box2d.b2Sub_V2_V2(b.m_vertex3, g, box2d.b2CollideEdgeAndCircle.s_e2),
        ...
        b = box2d.b2Dot_V2_V2(h, h),
            ...
            k = box2d.b2Sub_V2_V2(c, n, box2d.b2CollideEdgeAndCircle.s_d),
            k = box2d.b2Dot_V2_V2(k, k),
            k > m * m || (n = box2d.b2CollideEdgeAndCircle.s_n.Set(-h.y, h.x),
                0 > box2d.b2Dot_V2_V2(n, box2d.b2Sub_V2_V2(c, f, box2d.b2Vec2.s_t0)) && n.Set(-n.x, -n.y),
                n.Normalize(),
                e.cf.indexA = 0,
...
box2d.b2EPCollider.prototype.Collide = function (a, b, c, d, e) {
    ...
    var f = box2d.b2Dot_V2_V2(this.m_normal1, box2d.b2Sub_V2_V2(this.m_centroidB, this.m_v1, box2d.b2Vec2.s_t0))
        , g = 0
        , h = 0
        , k = !1
        , l = !1;
    c && (g = box2d.b2Sub_V2_V2(this.m_v1, this.m_v0, box2d.b2EPCollider.s_edge0),
        g.Normalize(),
        this.m_normal0.Set(g.y, -g.x),
        k = 0 <= box2d.b2Cross_V2_V2(g, e),
        g = box2d.b2Dot_V2_V2(this.m_normal0, box2d.b2Sub_V2_V2(this.m_centroidB, this.m_v0, box2d.b2Vec2.s_t0)));
    b && (h = box2d.b2Sub_V2_V2(this.m_v3, this.m_v2, box2d.b2EPCollider.s_edge2),
        h.Normalize(),
        this.m_normal2.Set(h.y, -h.x),
        l = 0 < box2d.b2Cross_V2_V2(e, h),
        h = box2d.b2Dot_V2_V2(this.m_normal2, box2d.b2Sub_V2_V2(this.m_centroidB, this.m_v2, box2d.b2Vec2.s_t0)));
    c && b ? k && l ? (this.m_front = 0 <= g || 0 <= f || 0 <= h) ? (this.m_normal.Copy(this.m_normal1),
        this.m_lowerLimit.Copy(this.m_normal0),
        this.m_upperLimit.Copy(this.m_normal2)) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
            this.m_lowerLimit.Copy(this.m_normal1).SelfNeg(),
            this.m_upperLimit.Copy(this.m_normal1).SelfNeg()) : k ? (this.m_front = 0 <= g || 0 <= f && 0 <= h) ? (this.m_normal.Copy(this.m_normal1),
                this.m_lowerLimit.Copy(this.m_normal0),
                this.m_upperLimit.Copy(this.m_normal1)) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
                    this.m_lowerLimit.Copy(this.m_normal2).SelfNeg(),
                    this.m_upperLimit.Copy(this.m_normal1).SelfNeg()) : l ? (this.m_front = 0 <= h || 0 <= g && 0 <= f) ? (this.m_normal.Copy(this.m_normal1),
                        this.m_lowerLimit.Copy(this.m_normal1),
                        this.m_upperLimit.Copy(this.m_normal2)) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
                            this.m_lowerLimit.Copy(this.m_normal1).SelfNeg(),
                            this.m_upperLimit.Copy(this.m_normal0).SelfNeg()) : (this.m_front = 0 <= g && 0 <= f && 0 <= h) ? (this.m_normal.Copy(this.m_normal1),
                                this.m_lowerLimit.Copy(this.m_normal1),
                                this.m_upperLimit.Copy(this.m_normal1)) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
                                    this.m_lowerLimit.Copy(this.m_normal2).SelfNeg(),
                                    this.m_upperLimit.Copy(this.m_normal0).SelfNeg()) : c ? k ? ((this.m_front = 0 <= g || 0 <= f) ? (this.m_normal.Copy(this.m_normal1),
                                        this.m_lowerLimit.Copy(this.m_normal0)) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
                                            this.m_lowerLimit.Copy(this.m_normal1)),
                                        this.m_upperLimit.Copy(this.m_normal1).SelfNeg()) : (this.m_front = 0 <= g && 0 <= f) ? (this.m_normal.Copy(this.m_normal1),
                                            this.m_lowerLimit.Copy(this.m_normal1),
                                            this.m_upperLimit.Copy(this.m_normal1).SelfNeg()) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
                                                this.m_lowerLimit.Copy(this.m_normal1),
                                                this.m_upperLimit.Copy(this.m_normal0).SelfNeg()) : b ? l ? (this.m_front = 0 <= f || 0 <= h) ? (this.m_normal.Copy(this.m_normal1),
                                                    this.m_lowerLimit.Copy(this.m_normal1).SelfNeg(),
                                                    this.m_upperLimit.Copy(this.m_normal2)) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
                                                        this.m_lowerLimit.Copy(this.m_normal1).SelfNeg(),
                                                        this.m_upperLimit.Copy(this.m_normal1)) : ((this.m_front = 0 <= f && 0 <= h) ? (this.m_normal.Copy(this.m_normal1),
                                                            this.m_lowerLimit.Copy(this.m_normal1).SelfNeg()) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
                                                                this.m_lowerLimit.Copy(this.m_normal2).SelfNeg()),
                                                            this.m_upperLimit.Copy(this.m_normal1)) : (this.m_front = 0 <= f) ? (this.m_normal.Copy(this.m_normal1),
                                                                this.m_lowerLimit.Copy(this.m_normal1).SelfNeg(),
                                                                this.m_upperLimit.Copy(this.m_normal1).SelfNeg()) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
                                                                    this.m_lowerLimit.Copy(this.m_normal1),
    ...
    if (!(c.type === box2d.b2EPAxisType.e_unknown || c.separation > this.m_radius || (b = this.ComputePolygonSeparation(box2d.b2EPCollider.s_polygonAxis),
        b.type !== box2d.b2EPAxisType.e_unknown && b.separation > this.m_radius))) {
        c = b.type === box2d.b2EPAxisType.e_unknown ? c : b.separation > .98 * c.separation + .001 ? b : c;
        ...
        if (c.type === box2d.b2EPAxisType.e_edgeA) {
            ...
            this.m_front ? (b.i1 = 0,
                ...
                b.v1.Copy(this.m_v1),
                b.v2.Copy(this.m_v2),
                b.normal.Copy(this.m_normal1)) : (b.i1 = 1,
                    b.i2 = 0,
                    b.v1.Copy(this.m_v2),
                    b.v2.Copy(this.m_v1),
        ...
        if (!(g < box2d.b2_maxManifoldPoints || (g = box2d.b2ClipSegmentToLine(h, f, b.sideNormal2, b.sideOffset2, b.i2),
            g < box2d.b2_maxManifoldPoints))) {
            c.type === box2d.b2EPAxisType.e_edgeA ? (a.localNormal.Copy(b.normal),
                a.localPoint.Copy(b.v1)) : (a.localNormal.Copy(d.m_normals[b.i1]),
                    a.localPoint.Copy(d.m_vertices[b.i1]));
            f = d = 0;
            for (g = box2d.b2_maxManifoldPoints; f < g; ++f)
                box2d.b2Dot_V2_V2(b.normal, box2d.b2Sub_V2_V2(h[f].v, b.v1, box2d.b2Vec2.s_t0)) <= this.m_radius && (e = a.points[d],
                    c.type === box2d.b2EPAxisType.e_edgeA ? (box2d.b2MulT_X_V2(this.m_xf, h[f].v, e.localPoint),
                        e.id = h[f].id) : (e.localPoint.Copy(h[f].v),
...
box2d.b2EPCollider.prototype.ComputeEdgeSeparation = function (a) {
    ...
    for (var b = 0, c = this.m_polygonB.count; b < c; ++b) {
        var d = box2d.b2Dot_V2_V2(this.m_normal, box2d.b2Sub_V2_V2(this.m_polygonB.vertices[b], this.m_v1, box2d.b2Vec2.s_t0));
...
box2d.b2EPCollider.prototype.ComputePolygonSeparation = function (a) {
    ...
    a.index = -1;
    a.separation = -box2d.b2_maxFloat;
    for (var b = box2d.b2EPCollider.s_perp.Set(-this.m_normal.y, this.m_normal.x), c = 0, d = this.m_polygonB.count; c < d; ++c) {
        var e = box2d.b2EPCollider.s_n.Copy(this.m_polygonB.normals[c]).SelfNeg()
            , f = box2d.b2Dot_V2_V2(e, box2d.b2Sub_V2_V2(this.m_polygonB.vertices[c], this.m_v1, box2d.b2Vec2.s_t0))
            , g = box2d.b2Dot_V2_V2(e, box2d.b2Sub_V2_V2(this.m_polygonB.vertices[c], this.m_v2, box2d.b2Vec2.s_t0))
            , f = box2d.b2Min(f, g);
        if (f > this.m_radius) {
        ...
        if (0 <= box2d.b2Dot_V2_V2(e, b)) {
            if (box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(e, this.m_upperLimit, box2d.b2Vec2.s_t0), this.m_normal) < -box2d.b2_angularSlop)
                continue
        } else if (box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(e, this.m_lowerLimit, box2d.b2Vec2.s_t0), this.m_normal) < -box2d.b2_angularSlop)
            continue;
        f > a.separation && (a.type = box2d.b2EPAxisType.e_edgeB,
            a.index = c,
            a.separation = f)
    }
    return a
...
box2d.b2FindMaxSeparation = function (a, b, c, d, e) {
    ...
    for (var k = -box2d.b2_maxFloat, l = 0; l < f; ++l) {
        for (var m = box2d.b2Mul_R_V2(c.q, h[l], box2d.b2FindMaxSeparation.s_n), n = box2d.b2Mul_X_V2(c, b[l], box2d.b2FindMaxSeparation.s_v1), p = box2d.b2_maxFloat, q = 0; q < g; ++q) {
            var r = box2d.b2Dot_V2_V2(m, box2d.b2Sub_V2_V2(d[q], n, box2d.b2Vec2.s_t0));
            r < p && (p = r)
        }
        p > k && (k = p,
            e = l)
...
box2d.b2FindIncidentEdge = function (a, b, c, d, e, f) {
    ...
    c = box2d.b2MulT_R_V2(f.q, box2d.b2Mul_R_V2(c.q, h[d], box2d.b2Vec2.s_t0), box2d.b2FindIncidentEdge.s_normal1);
...
box2d.b2CollidePolygons = function (a, b, c, d, e) {
    ...
    if (!(h > f)) {
        ...
        if (!(l > f)) {
            ...
            if (!(2 > g || (g = box2d.b2ClipSegmentToLine(p, u, l, r, h),
                2 > g))) {
                a.localNormal.Copy(e);
                a.localPoint.Copy(d);
                for (k = g = 0; k < box2d.b2_maxManifoldPoints; ++k)
                    e = p[k],
                        box2d.b2Dot_V2_V2(m, e.v) - b <= f && (h = a.points[g],
...
box2d.b2DynamicTree.prototype.RayCast = function (a, b) {
    if (null !== this.m_root) {
        ...
        for (m.Push(this.m_root); 0 < m.GetCount();)
            if (k = m.Pop(),
                null !== k && box2d.b2TestOverlap_AABB(k.aabb, h)) {
                var l = k.aabb.GetCenter()
                    , n = k.aabb.GetExtents();
                if (!(0 < box2d.b2Abs(box2d.b2Dot_V2_V2(e, box2d.b2Sub_V2_V2(c, l, box2d.b2Vec2.s_t0))) - box2d.b2Dot_V2_V2(f, n)))
                    if (k.IsLeaf()) {
...
box2d.b2DynamicTree.prototype.InsertLeaf = function (a) {
    ...
    if (null === this.m_root)
        ...
        for (var c = this.m_root, d, e; !c.IsLeaf();) {
            ...
            g.Combine2(c.aabb, b);
            var h = g.GetPerimeter(), g = 2 * h, h = 2 * (h - f), k = box2d.b2DynamicTree.s_aabb, l, m;
            d.IsLeaf() ? (k.Combine2(b, d.aabb),
                f = k.GetPerimeter() + h) : (k.Combine2(b, d.aabb),
                    l = d.aabb.GetPerimeter(),
                    m = k.GetPerimeter(),
                    f = m - l + h);
            e.IsLeaf() ? (k.Combine2(b, e.aabb),
                h = k.GetPerimeter() + h) : (k.Combine2(b, e.aabb),
        ...
        e.height = c.height + 1;
        d ? (d.child1 === c ? d.child1 = e : d.child2 = e,
            e.child1 = c,
            e.child2 = a,
            c.parent = e,
            a.parent = e) : (e.child1 = c,
                e.child2 = a,
                c.parent = e,
...
box2d.b2DynamicTree.prototype.RemoveLeaf = function (a) {
    if (a === this.m_root)
        ...
        if (c)
            for (c.child1 === b ? c.child1 = a : c.child2 = a,
                a.parent = c,
                this.FreeNode(b),
                b = c; b;)
                b = this.Balance(b),
...
box2d.b2DynamicTree.prototype.Balance = function (a) {
    ...
    if (1 < d) {
        ...
        c.parent = a.parent;
        a.parent = c;
        null !== c.parent ? c.parent.child1 === a ? c.parent.child1 = c : (box2d.ENABLE_ASSERTS && box2d.b2Assert(c.parent.child2 === a),
            c.parent.child2 = c) : this.m_root = c;
        d.height > e.height ? (c.child2 = d,
            a.child2 = e,
            e.parent = a,
            a.aabb.Combine2(b.aabb, e.aabb),
            c.aabb.Combine2(a.aabb, d.aabb),
            a.height = 1 + box2d.b2Max(b.height, e.height),
            c.height = 1 + box2d.b2Max(a.height, d.height)) : (c.child2 = e,
                a.child2 = d,
                d.parent = a,
    ...
    return -1 > d ? (d = b.child1,
        e = b.child2,
        b.child1 = a,
        b.parent = a.parent,
        a.parent = b,
        null !== b.parent ? b.parent.child1 === a ? b.parent.child1 = b : (box2d.ENABLE_ASSERTS && box2d.b2Assert(b.parent.child2 === a),
            b.parent.child2 = b) : this.m_root = b,
        d.height > e.height ? (b.child2 = d,
            a.child1 = e,
            e.parent = a,
            a.aabb.Combine2(c.aabb, e.aabb),
            b.aabb.Combine2(a.aabb, d.aabb),
            a.height = 1 + box2d.b2Max(c.height, e.height),
            b.height = 1 + box2d.b2Max(a.height, d.height)) : (b.child2 = e,
                a.child1 = d,
                d.parent = a,
...
box2d.b2DynamicTree.prototype.ValidateStructure = function (a) {
    if (null !== a) {
        ...
        var b = a.child1
            , c = a.child2;
        a.IsLeaf() ? (box2d.ENABLE_ASSERTS && box2d.b2Assert(null === b),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(null === c),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(0 === a.height)) : (box2d.ENABLE_ASSERTS && box2d.b2Assert(b.parent === a),
...
box2d.b2DynamicTree.prototype.ValidateMetrics = function (a) {
    if (null !== a) {
        ...
        if (a.IsLeaf())
            ...
            box2d.ENABLE_ASSERTS && box2d.b2Assert(d.lowerBound === a.aabb.lowerBound);
            box2d.ENABLE_ASSERTS && box2d.b2Assert(d.upperBound === a.aabb.upperBound);
...
box2d.b2DynamicTree.prototype.GetMaxBalance = function () {
    var a;
    a = this.m_root;
    null === a ? a = 0 : 1 >= a.height ? a = 0 : (box2d.ENABLE_ASSERTS && box2d.b2Assert(!a.IsLeaf()),
    ...
    for (var b = this.m_pairCount = 0; b < this.m_moveCount; ++b) {
        ...
        if (null !== c) {
            ...
            this.m_tree.Query(function (a) {
                ...
                a.m_id < c.m_id ? (b.proxyA = a,
                    b.proxyB = c) : (b.proxyA = c,
                        b.proxyB = a);
                ++d.m_pairCount;
                return !0
            }, e)
...
box2d.b2CircleShape.prototype.TestPoint = function (a, b) {
    var c = box2d.b2Mul_X_V2(a, this.m_p, box2d.b2CircleShape.prototype.TestPoint.s_center)
...
box2d.b2CircleShape.prototype.ComputeDistance = function (a, b, c, d) {
    a = box2d.b2Mul_X_V2(a, this.m_p, box2d.b2CircleShape.prototype.ComputeDistance.s_center);
...
box2d.b2CircleShape.prototype.RayCast = function (a, b, c, d) {
    c = box2d.b2Mul_X_V2(c, this.m_p, box2d.b2CircleShape.prototype.RayCast.s_position);
    ...
    var f = box2d.b2Dot_V2_V2(c, d)
        ...
        , e = f * f - g * e;
    if (0 > e || g < box2d.b2_epsilon)
        return !1;
    f = -(f + box2d.b2Sqrt(e));
    return 0 <= f && f <= b.maxFraction * g ? (f /= g,
        a.fraction = f,
...
box2d.b2CircleShape.prototype.ComputeAABB = function (a, b, c) {
    b = box2d.b2Mul_X_V2(b, this.m_p, box2d.b2CircleShape.prototype.ComputeAABB.s_p);
...
box2d.b2CircleShape.prototype.ComputeMass = function (a, b) {
    ...
    a.I = a.mass * (.5 * c + box2d.b2Dot_V2_V2(this.m_p, this.m_p))
}
    ;
...
box2d.b2CircleShape.prototype.ComputeSubmergedArea = function (a, b, c, d) {
    ...
    if (e < -this.m_radius + box2d.b2_epsilon)
        return 0;
    if (e > this.m_radius)
        return d.Copy(c),
    ...
    var f = e * e
        , e = b * (box2d.b2Asin(e / this.m_radius) + box2d.b2_pi / 2) + e * box2d.b2Sqrt(b - f);
...
box2d.b2EdgeShape.prototype.ComputeDistance = function (a, b, c, d) {
    ...
    a = box2d.b2Mul_X_V2(a, this.m_vertex2, box2d.b2EdgeShape.prototype.ComputeDistance.s_v2);
    d = box2d.b2Sub_V2_V2(b, e, box2d.b2EdgeShape.prototype.ComputeDistance.s_d);
    var e = box2d.b2Sub_V2_V2(a, e, box2d.b2EdgeShape.prototype.ComputeDistance.s_s)
...
box2d.b2EdgeShape.prototype.ComputeAABB = function (a, b, c) {
    c = box2d.b2Mul_X_V2(b, this.m_vertex1, box2d.b2EdgeShape.prototype.ComputeAABB.s_v1);
    b = box2d.b2Mul_X_V2(b, this.m_vertex2, box2d.b2EdgeShape.prototype.ComputeAABB.s_v2);
...
box2d.b2ChainShape.prototype.CreateLoop = function (a, b) {
    ...
    if (box2d.ENABLE_ASSERTS)
        for (var c = 1; c < b; ++c)
            box2d.b2Assert(box2d.b2DistanceSquared(a[c - 1], a[c]) > box2d.b2_linearSlop * box2d.b2_linearSlop);
    this.m_count = b + 1;
...
box2d.b2ChainShape.prototype.GetChildEdge = function (a, b) {
    ...
    0 < b ? (a.m_vertex0.Copy(this.m_vertices[b - 1]),
        a.m_hasVertex0 = !0) : (a.m_vertex0.Copy(this.m_prevVertex),
            a.m_hasVertex0 = this.m_hasPrevVertex);
    b < this.m_count - 2 ? (a.m_vertex3.Copy(this.m_vertices[b + 2]),
        a.m_hasVertex3 = !0) : (a.m_vertex3.Copy(this.m_nextVertex),
...
box2d.b2ChainShape.prototype.ComputeAABB = function (a, b, c) {
    ...
    c = box2d.b2Mul_X_V2(b, this.m_vertices[c], box2d.b2ChainShape.prototype.ComputeAABB.s_v1);
...
box2d.b2PolygonShape.prototype.Set = function (a, b, c) {
    ...
    for (var d = box2d.b2PolygonShape.prototype.Set.s_ps, e = 0, f = 0; f < b; ++f) {
        for (var g = a[c + f], h = !0, k = 0; k < e; ++k)
            if (box2d.b2DistanceSquared(g, d[k]) < .25 * box2d.b2_linearSlop * box2d.b2_linearSlop) {
                h = !1;
                break
            }
        h && d[e++].Copy(g)
    ...
    for (f = a; ;) {
        ...
        for (k = 1; k < b; ++k)
            if (h === f)
                ...
                var l = box2d.b2Sub_V2_V2(d[h], d[e[c]], box2d.b2PolygonShape.prototype.Set.s_r)
                    , g = box2d.b2Sub_V2_V2(d[k], d[e[c]], box2d.b2PolygonShape.prototype.Set.s_v)
    ...
    this.m_count = c;
    for (f = 0; f < c; ++f)
        this.m_vertices[f].Copy(d[e[f]]);
    f = 0;
    for (b = c; f < b; ++f)
        d = box2d.b2Sub_V2_V2(this.m_vertices[(f + 1) % b], this.m_vertices[f], box2d.b2Vec2.s_t0),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(d.LengthSquared() > box2d.b2_epsilon_sq),
...
box2d.b2PolygonShape.prototype.TestPoint = function (a, b) {
    for (var c = box2d.b2MulT_X_V2(a, b, box2d.b2PolygonShape.prototype.TestPoint.s_pLocal), d = 0, e = this.m_count; d < e; ++d)
        if (0 < box2d.b2Dot_V2_V2(this.m_normals[d], box2d.b2Sub_V2_V2(c, this.m_vertices[d], box2d.b2Vec2.s_t0)))
            return !1;
    return !0
}
    ;
...
box2d.b2PolygonShape.prototype.ComputeDistance = function (a, b, c, d) {
    b = box2d.b2MulT_X_V2(a, b, box2d.b2PolygonShape.prototype.ComputeDistance.s_pLocal);
    var e = -box2d.b2_maxFloat
        , f = box2d.b2PolygonShape.prototype.ComputeDistance.s_normalForMaxDistance.Copy(b);
    for (d = 0; d < this.m_count; ++d) {
        var g = box2d.b2Dot_V2_V2(this.m_normals[d], box2d.b2Sub_V2_V2(b, this.m_vertices[d], box2d.b2Vec2.s_t0));
        g > e && (e = g,
            f.Copy(this.m_normals[d]))
    }
    if (0 < e) {
        f = box2d.b2PolygonShape.prototype.ComputeDistance.s_minDistance.Copy(f);
        e *= e;
        for (d = 0; d < this.m_count; ++d) {
            var g = box2d.b2Sub_V2_V2(b, this.m_vertices[d], box2d.b2PolygonShape.prototype.ComputeDistance.s_distance)
                , h = g.LengthSquared();
            e > h && (f.Copy(g),
                e = h)
        }
...
box2d.b2PolygonShape.prototype.RayCast = function (a, b, c, d) {
    ...
    for (var e = box2d.b2MulT_X_V2(c, b.p2, box2d.b2PolygonShape.prototype.RayCast.s_p2), e = box2d.b2Sub_V2_V2(e, d, box2d.b2PolygonShape.prototype.RayCast.s_d), f = 0, g = b.maxFraction, h = -1, k = 0, l = this.m_count; k < l; ++k) {
        var m = box2d.b2Dot_V2_V2(this.m_normals[k], box2d.b2Sub_V2_V2(this.m_vertices[k], d, box2d.b2Vec2.s_t0))
    ...
    return 0 <= h ? (a.fraction = f,
        box2d.b2Mul_R_V2(c.q, this.m_normals[h], a.normal),
        !0) : !1
}
    ;
...
box2d.b2PolygonShape.prototype.ComputeAABB = function (a, b, c) {
    ...
    for (var d = 0, e = this.m_count; d < e; ++d) {
        var f = box2d.b2Mul_X_V2(b, this.m_vertices[d], box2d.b2PolygonShape.prototype.ComputeAABB.s_v);
...
box2d.b2PolygonShape.prototype.ComputeMass = function (a, b) {
    ...
    for (var c = box2d.b2PolygonShape.prototype.ComputeMass.s_center.SetZero(), d = 0, e = 0, f = box2d.b2PolygonShape.prototype.ComputeMass.s_s.SetZero(), g = 0, h = this.m_count; g < h; ++g)
        f.SelfAdd(this.m_vertices[g]);
    f.SelfMul(1 / this.m_count);
    for (var k = 1 / 3, g = 0, h = this.m_count; g < h; ++g) {
        var l = box2d.b2Sub_V2_V2(this.m_vertices[g], f, box2d.b2PolygonShape.prototype.ComputeMass.s_e1)
            , m = box2d.b2Sub_V2_V2(this.m_vertices[(g + 1) % h], f, box2d.b2PolygonShape.prototype.ComputeMass.s_e2)
            , n = box2d.b2Cross_V2_V2(l, m)
            , p = .5 * n
            , d = d + p;
        c.SelfAdd(box2d.b2Mul_S_V2(p * k, box2d.b2Add_V2_V2(l, m, box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t1));
        var p = l.x
            , l = l.y
            , q = m.x
            , m = m.y
            , e = e + .25 * k * n * (p * p + q * p + q * q + (l * l + m * l + m * m))
    }
    a.mass = b * d;
    ...
    a.I = b * e;
    a.I += a.mass * (box2d.b2Dot_V2_V2(a.center, a.center) - box2d.b2Dot_V2_V2(c, c))
}
    ;
...
box2d.b2PolygonShape.prototype.Validate = function () {
    for (var a = 0; a < this.m_count; ++a)
        for (var b = a, c = (a + 1) % this.m_count, d = this.m_vertices[b], e = box2d.b2Sub_V2_V2(this.m_vertices[c], d, box2d.b2PolygonShape.prototype.Validate.s_e), f = 0; f < this.m_count; ++f)
            if (f !== b && f !== c) {
                var g = box2d.b2Sub_V2_V2(this.m_vertices[f], d, box2d.b2PolygonShape.prototype.Validate.s_v);
                if (0 > box2d.b2Cross_V2_V2(e, g))
                    return !1
            }
    return !0
}
...
box2d.b2PolygonShape.prototype.ComputeSubmergedArea = function (a, b, c, d) {
    ...
    switch (h) {
        case 0:
            return l ? (a = box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_md,
    ...
    f = (0 - g[k]) / (g[a] - g[k]);
    g = (0 - g[b]) / (g[e] - g[b]);
    k = box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_intoVec.Set(this.m_vertices[k].x * (1 - f) + this.m_vertices[a].x * f, this.m_vertices[k].y * (1 - f) + this.m_vertices[a].y * f);
    b = box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_outoVec.Set(this.m_vertices[b].x * (1 - g) + this.m_vertices[e].x * g, this.m_vertices[b].y * (1 - g) + this.m_vertices[e].y * g);
    g = 0;
    ...
    for (l = null; a !== e;)
        a = (a + 1) % this.m_count,
            ...
            m = .5 * ((h.x - k.x) * (l.y - k.y) - (h.y - k.y) * (l.x - k.x)),
            g += m,
            f.x += m * (k.x + h.x + l.x) / 3,
            f.y += m * (k.y + h.y + l.y) / 3,
            h = l;
...
box2d.b2PolygonShape.ComputeCentroid = function (a, b, c) {
    box2d.ENABLE_ASSERTS && box2d.b2Assert(3 <= b);
    c.SetZero();
    for (var d = 0, e = box2d.b2PolygonShape.ComputeCentroid.s_pRef.SetZero(), f = 1 / 3, g = 0; g < b; ++g) {
        var h = e
            , k = a[g]
            , l = a[(g + 1) % b]
...
box2d.b2SeparationFunction.prototype.Initialize = function (a, b, c, d, e, f) {
    ...
    1 === b ? (this.m_type = box2d.b2SeparationFunctionType.e_points,
        ...
        this.m_localPoint.SetZero()) : (a.indexA[0] === a.indexA[1] ? (this.m_type = box2d.b2SeparationFunctionType.e_faceB,
            b = this.m_proxyB.GetVertex(a.indexB[0]),
            d = this.m_proxyB.GetVertex(a.indexB[1]),
            box2d.b2Cross_V2_S(box2d.b2Sub_V2_V2(d, b, box2d.b2Vec2.s_t0), 1, this.m_axis).SelfNormalize(),
            f = box2d.b2Mul_R_V2(e.q, this.m_axis, box2d.b2TimeOfImpact.s_normal),
            box2d.b2Mid_V2_V2(b, d, this.m_localPoint),
            e = box2d.b2Mul_X_V2(e, this.m_localPoint, box2d.b2TimeOfImpact.s_pointB),
            b = this.m_proxyA.GetVertex(a.indexA[0]),
            c = box2d.b2Mul_X_V2(c, b, box2d.b2TimeOfImpact.s_pointA),
            a = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(c, e, box2d.b2Vec2.s_t0), f)) : (this.m_type = box2d.b2SeparationFunctionType.e_faceA,
                b = this.m_proxyA.GetVertex(a.indexA[0]),
                d = this.m_proxyA.GetVertex(a.indexA[1]),
                box2d.b2Cross_V2_S(box2d.b2Sub_V2_V2(d, b, box2d.b2Vec2.s_t0), 1, this.m_axis).SelfNormalize(),
                f = box2d.b2Mul_R_V2(c.q, this.m_axis, box2d.b2TimeOfImpact.s_normal),
                box2d.b2Mid_V2_V2(b, d, this.m_localPoint),
                c = box2d.b2Mul_X_V2(c, this.m_localPoint, box2d.b2TimeOfImpact.s_pointA),
                a = this.m_proxyB.GetVertex(a.indexB[0]),
                e = box2d.b2Mul_X_V2(e, a, box2d.b2TimeOfImpact.s_pointB),
                a = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(e, c, box2d.b2Vec2.s_t0), f)),
            0 > a && (this.m_axis.SelfNeg(),
                a = -a));
    return a
}
    ;
    ...
    switch (this.m_type) {
        case box2d.b2SeparationFunctionType.e_points:
            var f = box2d.b2MulT_R_V2(d.q, this.m_axis, box2d.b2TimeOfImpact.s_axisA)
                , g = box2d.b2MulT_R_V2(e.q, box2d.b2Vec2.s_t0.Copy(this.m_axis).SelfNeg(), box2d.b2TimeOfImpact.s_axisB);
            ...
            return b = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(e, d, box2d.b2Vec2.s_t0), this.m_axis);
        case box2d.b2SeparationFunctionType.e_faceA:
            return c = box2d.b2Mul_R_V2(d.q, this.m_axis, box2d.b2TimeOfImpact.s_normal),
                d = box2d.b2Mul_X_V2(d, this.m_localPoint, box2d.b2TimeOfImpact.s_pointA),
                g = box2d.b2MulT_R_V2(e.q, box2d.b2Vec2.s_t0.Copy(c).SelfNeg(), box2d.b2TimeOfImpact.s_axisB),
                a[0] = -1,
                b[0] = this.m_proxyB.GetSupport(g),
                b = this.m_proxyB.GetVertex(b[0]),
                e = box2d.b2Mul_X_V2(e, b, box2d.b2TimeOfImpact.s_pointB),
        ...
        case box2d.b2SeparationFunctionType.e_faceB:
            return c = box2d.b2Mul_R_V2(e.q, this.m_axis, box2d.b2TimeOfImpact.s_normal),
                e = box2d.b2Mul_X_V2(e, this.m_localPoint, box2d.b2TimeOfImpact.s_pointB),
                f = box2d.b2MulT_R_V2(d.q, box2d.b2Vec2.s_t0.Copy(c).SelfNeg(), box2d.b2TimeOfImpact.s_axisA),
                b[0] = -1,
                a[0] = this.m_proxyA.GetSupport(f),
                a = this.m_proxyA.GetVertex(a[0]),
                d = box2d.b2Mul_X_V2(d, a, box2d.b2TimeOfImpact.s_pointA),
...
box2d.b2SeparationFunction.prototype.Evaluate = function (a, b, c) {
    ...
    switch (this.m_type) {
        case box2d.b2SeparationFunctionType.e_points:
            return a = this.m_proxyA.GetVertex(a),
                b = this.m_proxyB.GetVertex(b),
                d = box2d.b2Mul_X_V2(d, a, box2d.b2TimeOfImpact.s_pointA),
                e = box2d.b2Mul_X_V2(e, b, box2d.b2TimeOfImpact.s_pointB),
                d = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(e, d, box2d.b2Vec2.s_t0), this.m_axis);
        case box2d.b2SeparationFunctionType.e_faceA:
            return c = box2d.b2Mul_R_V2(d.q, this.m_axis, box2d.b2TimeOfImpact.s_normal),
                d = box2d.b2Mul_X_V2(d, this.m_localPoint, box2d.b2TimeOfImpact.s_pointA),
                b = this.m_proxyB.GetVertex(b),
...
box2d.b2TimeOfImpact = function (a, b) {
    ...
    g.Normalize();
    var h = b.tMax
        , k = box2d.b2Max(box2d.b2_linearSlop, d.m_radius + e.m_radius - 3 * box2d.b2_linearSlop)
    ...
    for (q.useRadii = !1; ;) {
        ...
        for (var u = !1, t = h, w = 0; ;) {
            ...
            ++w;
            if (w === box2d.b2_maxPolygonVertices)
                break
        }
        ++n;
        ++box2d.b2_toiIters;
...
box2d.b2Fixture.prototype.Synchronize = function (a, b, c) {
    if (0 !== this.m_proxyCount)
        for (var d = 0; d < this.m_proxyCount; ++d) {
            ...
            e.aabb.Combine2(f, g);
            f = box2d.b2Sub_V2_V2(c.p, b.p, box2d.b2Fixture.prototype.Synchronize.s_displacement);
...
box2d.b2Fixture.prototype.SetSensor = function (a) {
    a !== this.m_isSensor && (this.m_body.SetAwake(!0),
        this.m_isSensor = a)
}
    ;
...
goog.exportProperty(box2d.b2Body.prototype, "m_flag_awakeFlag", box2d.b2Body.prototype.m_flag_awakeFlag);
box2d.b2Body.prototype.m_flag_autoSleepFlag = !1;
goog.exportProperty(box2d.b2Body.prototype, "m_flag_autoSleepFlag", box2d.b2Body.prototype.m_flag_autoSleepFlag);
box2d.b2Body.prototype.m_flag_bulletFlag = !1;
goog.exportProperty(box2d.b2Body.prototype, "m_flag_bulletFlag", box2d.b2Body.prototype.m_flag_bulletFlag);
box2d.b2Body.prototype.m_flag_fixedRotationFlag = !1;
goog.exportProperty(box2d.b2Body.prototype, "m_flag_fixedRotationFlag", box2d.b2Body.prototype.m_flag_fixedRotationFlag);
box2d.b2Body.prototype.m_flag_activeFlag = !1;
goog.exportProperty(box2d.b2Body.prototype, "m_flag_activeFlag", box2d.b2Body.prototype.m_flag_activeFlag);
box2d.b2Body.prototype.m_flag_toiFlag = !1;
goog.exportProperty(box2d.b2Body.prototype, "m_flag_toiFlag", box2d.b2Body.prototype.m_flag_toiFlag);
...
goog.exportProperty(box2d.b2Body.prototype, "m_xf0", box2d.b2Body.prototype.m_xf0);
...
box2d.b2Body.prototype.CreateFixture_Def = function (a) {
    ...
    b.Create(this, a);
    this.m_flag_activeFlag && b.CreateProxies(this.m_world.m_contactManager.m_broadPhase, this.m_xf);
...
box2d.b2Body.prototype.DestroyFixture = function (a) {
    ...
    if (!this.m_world.IsLocked()) {
        ...
        this.m_flag_activeFlag && a.DestroyProxies(this.m_world.m_contactManager.m_broadPhase);
        a.Destroy();
        a.m_body = null;
        a.m_next = null;
        --this.m_fixtureCount;
...
box2d.b2Body.prototype.SetTransform = function (a, b, c) {
    ...
    else if ("number" === typeof a && "number" === typeof b && "number" === typeof c)
...
box2d.b2Body.prototype.SetTransform_X_Y_A = function (a, b, c) {
    box2d.ENABLE_ASSERTS && box2d.b2Assert(!this.m_world.IsLocked());
    if (!this.m_world.IsLocked() && (this.m_xf.p.x !== a || this.m_xf.p.y !== b || this.m_xf.q.GetAngle() !== c))
        for (this.m_xf.q.SetAngle(c),
            this.m_xf.p.Set(a, b),
            this.m_xf0.Copy(this.m_xf),
            ...
            b = this.m_fixtureList; b; b = b.m_next)
...
box2d.b2Body.prototype.SetLinearVelocity = function (a) {
    this.m_type !== box2d.b2BodyType.b2_staticBody && (0 < box2d.b2Dot_V2_V2(a, a) && this.SetAwake(!0),
...
box2d.b2Body.prototype.SetAngularVelocity = function (a) {
    this.m_type !== box2d.b2BodyType.b2_staticBody && (0 < a * a && this.SetAwake(!0),
...
box2d.b2Body.prototype.ApplyForce = function (a, b, c) {
    this.m_type === box2d.b2BodyType.b2_dynamicBody && (!this.m_flag_awakeFlag && this.SetAwake(!0),
        this.m_flag_awakeFlag && (this.m_force.x += a.x,
            this.m_force.y += a.y,
            this.m_torque += (b.x - this.m_sweep.c.x) * a.y - (b.y - this.m_sweep.c.y) * a.x))
}
    ;
...
box2d.b2Body.prototype.ApplyForceToCenter = function (a, b) {
    this.m_type === box2d.b2BodyType.b2_dynamicBody && (("boolean" === typeof b ? b : 1) && !this.m_flag_awakeFlag && this.SetAwake(!0),
        this.m_flag_awakeFlag && (this.m_force.x += a.x,
            this.m_force.y += a.y))
}
    ;
...
box2d.b2Body.prototype.ApplyLinearImpulse = function (a, b, c) {
    this.m_type === box2d.b2BodyType.b2_dynamicBody && (("boolean" === typeof c ? c : 1) && !this.m_flag_awakeFlag && this.SetAwake(!0),
        this.m_flag_awakeFlag && (this.m_linearVelocity.x += this.m_invMass * a.x,
            this.m_linearVelocity.y += this.m_invMass * a.y,
            this.m_angularVelocity += this.m_invI * ((b.x - this.m_sweep.c.x) * a.y - (b.y - this.m_sweep.c.y) * a.x)))
}
    ;
...
box2d.b2Body.prototype.GetMassData = function (a) {
    a.mass = this.m_mass;
    a.I = this.m_I + this.m_mass * box2d.b2Dot_V2_V2(this.m_sweep.localCenter, this.m_sweep.localCenter);
...
box2d.b2Body.prototype.SetMassData = function (a) {
    box2d.ENABLE_ASSERTS && box2d.b2Assert(!this.m_world.IsLocked());
    if (!this.m_world.IsLocked() && this.m_type === box2d.b2BodyType.b2_dynamicBody) {
        this.m_invI = this.m_I = this.m_invMass = 0;
        this.m_mass = a.mass;
        0 >= this.m_mass && (this.m_mass = 1);
        this.m_invMass = 1 / this.m_mass;
        0 < a.I && !this.m_flag_fixedRotationFlag && (this.m_I = a.I - this.m_mass * box2d.b2Dot_V2_V2(a.center, a.center),
        ...
        box2d.b2Mul_X_V2(this.m_xf, this.m_sweep.localCenter, this.m_sweep.c);
        this.m_sweep.c0.Copy(this.m_sweep.c);
        box2d.b2AddCross_V2_S_V2(this.m_linearVelocity, this.m_angularVelocity, box2d.b2Sub_V2_V2(this.m_sweep.c, b, box2d.b2Vec2.s_t0), this.m_linearVelocity)
    }
}
    ;
...
box2d.b2Body.prototype.ResetMassData = function () {
    ...
    if (this.m_type === box2d.b2BodyType.b2_staticBody || this.m_type === box2d.b2BodyType.b2_kinematicBody)
        ...
        0 < this.m_mass ? (this.m_invMass = 1 / this.m_mass,
            a.x *= this.m_invMass,
            a.y *= this.m_invMass) : this.m_invMass = this.m_mass = 1;
        0 < this.m_I && !this.m_flag_fixedRotationFlag ? (this.m_I -= this.m_mass * box2d.b2Dot_V2_V2(a, a),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(0 < this.m_I),
...
box2d.b2Body.prototype.GetLinearVelocityFromWorldPoint = function (a, b) {
    return box2d.b2AddCross_V2_S_V2(this.m_linearVelocity, this.m_angularVelocity, box2d.b2Sub_V2_V2(a, this.m_sweep.c, box2d.b2Vec2.s_t0), b)
}
    ;
...
box2d.b2Body.prototype.SetSleepingAllowed = function (a) {
    a ? this.m_flag_autoSleepFlag = !0 : (this.m_flag_autoSleepFlag = !1,
        this.SetAwake(!0))
}
    ;
...
box2d.b2Body.prototype.SetAwake = function (a) {
    a ? this.m_flag_awakeFlag || (this.m_flag_awakeFlag = !0,
        this.m_sleepTime = 0) : (this.m_flag_awakeFlag = !1,
            this.m_sleepTime = 0,
...
box2d.b2Body.prototype.SetFixedRotation = function (a) {
    this.m_flag_fixedRotationFlag !== a && (this.m_flag_fixedRotationFlag = a,
        this.m_angularVelocity = 0,
        this.ResetMassData())
}
    ;
...
box2d.b2Body.prototype.ShouldCollide = function (a) {
    ...
    return this.m_type === box2d.b2BodyType.b2_staticBody && a.m_type === box2d.b2BodyType.b2_staticBody ? !1 : this.ShouldCollideConnected(a)
}
    ;
...
box2d.b2Body.prototype.ShouldCollideConnected = function (a) {
    for (var b = this.m_jointList; b; b = b.next)
        if (b.other === a && !b.joint.m_collideConnected)
            return !1;
    return !0
}
    ;
...
goog.exportProperty(box2d.b2TimeStep.prototype, "particleIterations", box2d.b2TimeStep.prototype.particleIterations);
...
box2d.b2ContactFilter.prototype.ShouldCollide = function (a, b) {
    var c = a.GetBody()
        , d = b.GetBody();
    if (d.GetType() === box2d.b2BodyType.b2_staticBody && c.GetType() === box2d.b2BodyType.b2_staticBody || !1 === d.ShouldCollideConnected(c))
        return !1;
    c = a.GetFilterData();
    d = b.GetFilterData();
...
box2d.b2ContactFilter.prototype.ShouldCollideFixtureParticle = function (a, b, c) {
    return !0
}
    ;
...
box2d.b2ContactFilter.prototype.ShouldCollideParticleParticle = function (a, b, c) {
    return !0
}
    ;
...
goog.exportProperty(box2d.b2ContactImpulse.prototype, "tangentImpulses", box2d.b2ContactImpulse.prototype.tangentImpulses);
box2d.b2ContactImpulse.prototype.count = 0;
goog.exportProperty(box2d.b2ContactImpulse.prototype, "count", box2d.b2ContactImpulse.prototype.count);
...
box2d.b2ContactListener.prototype.BeginContactFixtureParticle = function (a, b) { }
    ;
...
box2d.b2ContactListener.prototype.EndContactFixtureParticle = function (a, b, c) { }
    ;
...
box2d.b2ContactListener.prototype.BeginContactParticleParticle = function (a, b) { }
    ;
...
box2d.b2ContactListener.prototype.EndContactParticleParticle = function (a, b, c) { }
    ;
...
goog.exportProperty(box2d.b2Contact.prototype, "m_flag_touchingFlag", box2d.b2Contact.prototype.m_flag_touchingFlag);
box2d.b2Contact.prototype.m_flag_enabledFlag = !1;
goog.exportProperty(box2d.b2Contact.prototype, "m_flag_enabledFlag", box2d.b2Contact.prototype.m_flag_enabledFlag);
box2d.b2Contact.prototype.m_flag_filterFlag = !1;
goog.exportProperty(box2d.b2Contact.prototype, "m_flag_filterFlag", box2d.b2Contact.prototype.m_flag_filterFlag);
box2d.b2Contact.prototype.m_flag_bulletHitFlag = !1;
goog.exportProperty(box2d.b2Contact.prototype, "m_flag_bulletHitFlag", box2d.b2Contact.prototype.m_flag_bulletHitFlag);
box2d.b2Contact.prototype.m_flag_toiFlag = !1;
goog.exportProperty(box2d.b2Contact.prototype, "m_flag_toiFlag", box2d.b2Contact.prototype.m_flag_toiFlag);
...
box2d.b2ChainAndCircleContact.prototype.Evaluate = function (a, b, c) {
    ...
    box2d.b2CollideEdgeAndCircle(a, f, b, e instanceof box2d.b2CircleShape ? e : null, c)
}
    ;
...
box2d.b2ChainAndPolygonContact.prototype.Evaluate = function (a, b, c) {
    ...
    (d instanceof box2d.b2ChainShape ? d : null).GetChildEdge(f, this.m_indexA);
    box2d.b2CollideEdgeAndPolygon(a, f, b, e instanceof box2d.b2PolygonShape ? e : null, c)
}
    ;
...
box2d.b2ContactFactory.prototype.AddType = function (a, b, c, d) {
    ...
    c !== d && (this.m_registers[d][c].pool = e,
...
box2d.b2ContactFactory.prototype.Create = function (a, b, c, d) {
    /////暂时处理
    if (a == null || c == null) {
        console.warn('Create  GetType ', a, c);
        return null;
    }

    var e = a.GetType(), f = c.GetType();
    if (e == null || f == null) {
        console.warn('Create  GetType ', a, c);
        return null;
    }
    box2d.ENABLE_ASSERTS && box2d.b2Assert(0 <= e && e < box2d.b2ShapeType.e_shapeTypeCount);
    box2d.ENABLE_ASSERTS && box2d.b2Assert(0 <= f && f < box2d.b2ShapeType.e_shapeTypeCount);
    e = this.m_registers[e][f];
    f = e.createFcn;
    return null !== f ? (e.primary ? (e = f(this.m_allocator),
        e.Reset(a, b, c, d)) : (e = f(this.m_allocator),
            e.Reset(c, d, a, b)),
        e) : null
}
    ;
...
box2d.b2ContactFactory.prototype.Destroy = function (a) {
    var b = a.m_fixtureA
        , c = a.m_fixtureB;
    0 < a.m_manifold.pointCount && !b.IsSensor() && !c.IsSensor() && (b.GetBody().SetAwake(!0),
        c.GetBody().SetAwake(!0));
    b = b.GetType();
    c = c.GetType();
...
goog.exportProperty(box2d.b2ContactManager.prototype, "m_broadPhase", box2d.b2ContactManager.prototype.m_broadPhase);
box2d.b2ContactManager.prototype.m_contactList = null;
goog.exportProperty(box2d.b2ContactManager.prototype, "m_contactList", box2d.b2ContactManager.prototype.m_contactList);
box2d.b2ContactManager.prototype.m_contactCount = 0;
goog.exportProperty(box2d.b2ContactManager.prototype, "m_contactCount", box2d.b2ContactManager.prototype.m_contactCount);
...
goog.exportProperty(box2d.b2ContactManager.prototype, "m_allocator", box2d.b2ContactManager.prototype.m_allocator);
...
box2d.b2ContactManager.prototype.Collide = function () {
    for (var a = this.m_contactList; a;) {
        ...
        f || g ? this.m_broadPhase.TestOverlap(b.m_proxies[d].proxy, c.m_proxies[e].proxy) ? (a.Update(this.m_contactListener),
            a = a.m_next) : (b = a,
                a = b.m_next,
                this.Destroy(b)) : a = a.m_next
    }
}
    ;
    ...
    if (h && g !== h) {
        for (var k = h.GetContactList(); k;) {
            if (k.other === g) {
                ...
                if (l === c && m === d && n === e && p === f || l === d && m === c && n === f && p === e)
                    return
            }
            k = k.next
        }
        !h.ShouldCollide(g) || this.m_contactFilter && !this.m_contactFilter.ShouldCollide(c, d) || (e = this.m_contactFactory.Create(c, e, d, f),
            null !== e && (c = e.GetFixtureA(),
                d = e.GetFixtureB(),
                g = c.m_body,
                h = d.m_body,
                e.m_prev = null,
                ...
                c.IsSensor() || d.IsSensor() || (g.SetAwake(!0),
                    h.SetAwake(!0)),
                ++this.m_contactCount))
    }
}
...
box2d.b2ContactSolver.prototype.Initialize = function (a) {
    ...
    if (this.m_velocityConstraints.length < this.m_count)
        for (b = box2d.b2Max(2 * this.m_velocityConstraints.length, this.m_count),
            box2d.DEBUG && window.console.log("box2d.b2ContactSolver.m_velocityConstraints: " + b); this.m_velocityConstraints.length < b;)
    ...
    for (b = this.m_count; a < b; ++a)
        for (e = this.m_contacts[a],
            ...
            h = g.points[c],
                l = f.points[c],
                this.m_step.warmStarting ? (l.normalImpulse = this.m_step.dtRatio * h.normalImpulse,
                    l.tangentImpulse = this.m_step.dtRatio * h.tangentImpulse) : (l.normalImpulse = 0,
                        l.tangentImpulse = 0),
                l.rA.SetZero(),
                l.rB.SetZero(),
                l.normalMass = 0,
...
box2d.b2ContactSolver.prototype.InitializeVelocityConstraints = function () {
    var a, b, c, d, e, f, g, h, k, l, m, n, p, q, r, u, t, w, x, v, y = box2d.b2ContactSolver.prototype.InitializeVelocityConstraints.s_xfA, z = box2d.b2ContactSolver.prototype.InitializeVelocityConstraints.s_xfB, B = box2d.b2ContactSolver.prototype.InitializeVelocityConstraints.s_worldManifold;
    a = 0;
    for (b = this.m_count; a < b; ++a) {
        ...
        for (c = 0; c < d; ++c)
            g = e.points[c],
                ...
                g.velocityBias = 0,
                q = box2d.b2Dot_V2_V2(e.normal, box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(v, k, g.rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(t, h, g.rA, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t0)),
                q < -box2d.b2_velocityThreshold && (g.velocityBias += -e.restitution * q);
        2 === e.pointCount && box2d.g_blockSolve && (t = e.points[0],
            w = e.points[1],
            ...
            v = l + m + n * h * h + p * k * k,
            l = l + m + n * f * h + p * t * k,
            w * w < 1E3 * (w * v - l * l) ? (e.K.ex.Set(w, l),
                e.K.ey.Set(l, v),
                e.K.GetInverse(e.normalMass)) : e.pointCount = 1)
    }
}
    ;
...
box2d.b2ContactSolver.prototype.WarmStart = function () {
    var a, b, c, d, e, f, g, h, k, l, m, n, p, q, r, u, t, w, x = box2d.b2ContactSolver.prototype.WarmStart.s_P;
    a = 0;
    for (b = this.m_count; a < b; ++a) {
        e = this.m_velocityConstraints[a];
        f = e.indexA;
        ...
        for (c = 0; c < d; ++c)
            w = e.points[c],
                box2d.b2Add_V2_V2(box2d.b2Mul_S_V2(w.normalImpulse, u, box2d.b2Vec2.s_t0), box2d.b2Mul_S_V2(w.tangentImpulse, t, box2d.b2Vec2.s_t1), x),
...
box2d.b2ContactSolver.prototype.SolveVelocityConstraints = function () {
    var a, b, c, d, e, f, g, h, k, l, m, n, p, q, r, u, t, w, x, v, y = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_dv, z = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_dv1, B = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_dv2, E, F, G = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P, H = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_a, I = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_b, C = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_x, A = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_d, K = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P1, J = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P2, D = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P1P2;
    a = 0;
    for (b = this.m_count; a < b; ++a) {
        e = this.m_velocityConstraints[a];
        f = e.indexA;
        ...
        for (d = n; c < d; ++c)
            v = e.points[c],
                box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(r, u, v.rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(p, q, v.rA, box2d.b2Vec2.s_t1), y),
        ...
        if (1 !== e.pointCount && box2d.g_blockSolve)
            for (n = e.points[0],
                ...
                box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(r, u, n.rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(p, q, n.rA, box2d.b2Vec2.s_t1), z),
                box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(r, u, v.rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(p, q, v.rA, box2d.b2Vec2.s_t1), B),
                ...
                if (0 <= C.x && 0 <= C.y) {
                    ...
                    p.SelfMulSub(h, D);
                    q -= k * (box2d.b2Cross_V2_V2(n.rA, K) + box2d.b2Cross_V2_V2(v.rA, J));
                    r.SelfMulAdd(l, D);
                    u += m * (box2d.b2Cross_V2_V2(n.rB, K) + box2d.b2Cross_V2_V2(v.rB, J));
                    n.normalImpulse = C.x;
                    v.normalImpulse = C.y;
                    break
                }
...
box2d.b2ContactSolver.prototype.StoreImpulses = function () {
    ...
    a = 0;
    for (b = this.m_count; a < b; ++a)
        for (e = this.m_velocityConstraints[a],
            f = this.m_contacts[e.contactIndex].GetManifold(),
            c = 0,
            d = e.pointCount; c < d; ++c)
...
box2d.b2PositionSolverManifold.prototype.Initialize = function (a, b, c, d) {
    ...
    switch (a.type) {
        case box2d.b2ManifoldType.e_circles:
            ...
            this.separation = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(f, e, box2d.b2Vec2.s_t0), this.normal) - a.radiusA - a.radiusB;
            break;
        case box2d.b2ManifoldType.e_faceA:
            box2d.b2Mul_R_V2(b.q, a.localNormal, this.normal);
            box2d.b2Mul_X_V2(b, a.localPoint, g);
            box2d.b2Mul_X_V2(c, a.localPoints[d], h);
            this.separation = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(h, g, box2d.b2Vec2.s_t0), this.normal) - a.radiusA - a.radiusB;
            this.point.Copy(h);
            break;
        case box2d.b2ManifoldType.e_faceB:
...
box2d.b2ContactSolver.prototype.SolvePositionConstraints = function () {
    var a, b, c, d, e, f, g, h, k, l, m, n, p, q, r, u, t, w = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_xfA, x = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_xfB, v = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_psm, y, z, B, E = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_rA, F = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_rB, G, H = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_P, I = 0;
    a = 0;
    for (b = this.m_count; a < b; ++a) {
        e = this.m_positionConstraints[a];
        f = e.indexA;
        ...
        for (c = 0; c < d; ++c)
            w.q.SetAngle(r),
                ...
                I = box2d.b2Min(I, B),
                z = box2d.b2Clamp(box2d.b2_baumgarte * (B + box2d.b2_linearSlop), -box2d.b2_maxLinearCorrection, 0),
    ...
    for (d = this.m_count; c < d; ++c) {
        ...
        for (e = 0; e < f; ++e)
            v.q.SetAngle(t),
                ...
                A = box2d.b2Min(A, F),
                E = box2d.b2Clamp(box2d.b2_toiBaumgarte * (F + box2d.b2_linearSlop), -box2d.b2_maxLinearCorrection, 0),
...
box2d.b2Island.prototype.Initialize = function (a, b, c, d, e) {
    ...
    if (this.m_positions.length < a)
        for (b = box2d.b2Max(2 * this.m_positions.length, a),
            box2d.DEBUG && window.console.log("box2d.b2Island.m_positions: " + b); this.m_positions.length < b;)
            this.m_positions[this.m_positions.length] = new box2d.b2Position;
    if (this.m_velocities.length < a)
        for (b = box2d.b2Max(2 * this.m_velocities.length, a),
            box2d.DEBUG && window.console.log("box2d.b2Island.m_velocities: " + b); this.m_velocities.length < b;)
...
box2d.b2Island.prototype.Solve = function (a, b, c, d) {
    for (var e = box2d.b2Island.s_timer.Reset(), f = b.dt, g = 0; g < this.m_bodyCount; ++g) {
        ...
        h.m_type === box2d.b2BodyType.b2_dynamicBody && (m.x += f * (h.m_gravityScale * c.x + h.m_invMass * h.m_force.x),
    ...
    for (g = 0; g < this.m_bodyCount; ++g) {
        ...
        box2d.b2Dot_V2_V2(p, p) > box2d.b2_maxTranslationSquared && (p = box2d.b2_maxTranslation / p.Length(),
            m.SelfMul(p));
        p = f * n;
        p * p > box2d.b2_maxRotationSquared && (p = box2d.b2_maxRotation / box2d.b2Abs(p),
            n *= p);
        k.x += f * m.x;
        k.y += f * m.y;
        l += f * n;
    ...
    for (g = 0; g < b.positionIterations; ++g) {
        ...
        n = !0;
        for (l = 0; l < this.m_jointCount; ++l)
            p = this.m_joints[l].SolvePositionConstraints(h),
                n = n && p;
        if (m && n) {
            k = !0;
            break
    ...
    if (d) {
        ...
        for (g = 0; g < this.m_bodyCount; ++g)
            h = this.m_bodies[g],
                h.GetType() !== box2d.b2BodyType.b2_staticBody && (!h.m_flag_autoSleepFlag || h.m_angularVelocity * h.m_angularVelocity > e || box2d.b2Dot_V2_V2(h.m_linearVelocity, h.m_linearVelocity) > d ? a = h.m_sleepTime = 0 : (h.m_sleepTime += f,
                    a = box2d.b2Min(a, h.m_sleepTime)));
...
box2d.b2Island.prototype.SolveTOI = function (a, b, c) {
    ...
    for (d = 0; d < a.positionIterations && !e.SolveTOIPositionConstraints(b, c); ++d)
        ;
    ...
    for (d = 0; d < this.m_bodyCount; ++d) {
        ...
        box2d.b2Dot_V2_V2(h, h) > box2d.b2_maxTranslationSquared && (h = box2d.b2_maxTranslation / h.Length(),
            f.SelfMul(h));
        h = a * g;
        h * h > box2d.b2_maxRotationSquared && (h = box2d.b2_maxRotation / box2d.b2Abs(h),
            g *= h);
        b.SelfMulAdd(a, f);
        c += a * g;
...
box2d.b2AreaJoint.prototype.InitVelocityConstraints = function (a) {
    for (var b = 0, c = this.m_bodies.length; b < c; ++b) {
        ...
        box2d.b2Sub_V2_V2(a.positions[this.m_bodies[(b + 1) % c].m_islandIndex].c, a.positions[this.m_bodies[(b + c - 1) % c].m_islandIndex].c, d)
    }
    if (a.step.warmStarting)
        for (this.m_impulse *= a.step.dtRatio,
            b = 0,
            c = this.m_bodies.length; b < c; ++b) {
            var e = this.m_bodies[b]
                , f = a.velocities[e.m_islandIndex].v
                , d = this.m_deltas[b];
            f.x += e.m_invMass * d.y * .5 * this.m_impulse;
            f.y += e.m_invMass * -d.x * .5 * this.m_impulse
        }
    else
        this.m_impulse = 0
}
...
box2d.b2AreaJoint.prototype.SolveVelocityConstraints = function (a) {
    ...
    for (e = this.m_bodies.length; d < e; ++d)
        f = this.m_bodies[d],
            g = a.velocities[f.m_islandIndex].v,
            h = this.m_deltas[d],
            g.x += f.m_invMass * h.y * .5 * b,
            g.y += f.m_invMass * -h.x * .5 * b
}
    ;
...
box2d.b2AreaJoint.prototype.SolvePositionConstraints = function (a) {
    ...
    b = .5 * (this.m_targetArea - .5 * c) / b;
    c = !0;
    d = 0;
    for (e = this.m_bodies.length; d < e; ++d)
        f = this.m_bodies[d],
            f = a.positions[f.m_islandIndex].c,
            h = box2d.b2Add_V2_V2(this.m_normals[d], this.m_normals[(d + 1) % e], this.m_delta),
            h.SelfMul(b),
            g = h.LengthSquared(),
            g > box2d.b2Sq(box2d.b2_maxLinearCorrection) && h.SelfMul(box2d.b2_maxLinearCorrection / box2d.b2Sqrt(g)),
...
box2d.b2DistanceJoint.prototype.GetReactionForce = function (a, b) {
    return b.Set(a * this.m_impulse * this.m_u.x, a * this.m_impulse * this.m_u.y)
}
    ;
...
box2d.b2DistanceJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    b = this.m_invMassA + this.m_invIA * b * b + this.m_invMassB + this.m_invIB * k * k;
    ...
    a.step.warmStarting ? (this.m_impulse *= a.step.dtRatio,
        b = box2d.b2Mul_S_V2(this.m_impulse, this.m_u, box2d.b2DistanceJoint.prototype.InitVelocityConstraints.s_P),
        c.SelfMulSub(this.m_invMassA, b),
        d -= this.m_invIA * box2d.b2Cross_V2_V2(this.m_rA, b),
        g.SelfMulAdd(this.m_invMassB, b),
        h += this.m_invIB * box2d.b2Cross_V2_V2(this.m_rB, b)) : this.m_impulse = 0;
...
box2d.b2DistanceJoint.prototype.SolveVelocityConstraints = function (a) {
    var b = a.velocities[this.m_indexA].v
        ...
        , f = box2d.b2AddCross_V2_S_V2(b, c, this.m_rA, box2d.b2DistanceJoint.prototype.SolveVelocityConstraints.s_vpA)
        , g = box2d.b2AddCross_V2_S_V2(d, e, this.m_rB, box2d.b2DistanceJoint.prototype.SolveVelocityConstraints.s_vpB)
    ...
    this.m_impulse += f;
    f = box2d.b2Mul_S_V2(f, this.m_u, box2d.b2DistanceJoint.prototype.SolveVelocityConstraints.s_P);
...
box2d.b2DistanceJoint.prototype.SolvePositionConstraints = function (a) {
    ...
    var k = this.m_u.Normalize() - this.m_length
        , k = box2d.b2Clamp(k, -box2d.b2_maxLinearCorrection, box2d.b2_maxLinearCorrection)
        , h = box2d.b2Mul_S_V2(-this.m_mass * k, h, box2d.b2DistanceJoint.prototype.SolvePositionConstraints.s_P);
...
box2d.b2FrictionJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    a.step.warmStarting ? (this.m_linearImpulse.SelfMul(a.step.dtRatio),
        this.m_angularImpulse *= a.step.dtRatio,
        g = this.m_linearImpulse,
        b.SelfMulSub(d, g),
        c -= l * (box2d.b2Cross_V2_V2(this.m_rA, g) + this.m_angularImpulse),
        e.SelfMulAdd(k, g),
        f += m * (box2d.b2Cross_V2_V2(this.m_rB, g) + this.m_angularImpulse)) : (this.m_linearImpulse.SetZero(),
...
box2d.b2FrictionJoint.prototype.SolveVelocityConstraints = function (a) {
    var b = a.velocities[this.m_indexA].v, c = a.velocities[this.m_indexA].w, d = a.velocities[this.m_indexB].v, e = a.velocities[this.m_indexB].w, f = this.m_invMassA, g = this.m_invMassB, h = this.m_invIA, k = this.m_invIB, l = a.step.dt, m, n = -this.m_angularMass * (e - c), p = this.m_angularImpulse;
    m = l * this.m_maxTorque;
    this.m_angularImpulse = box2d.b2Clamp(this.m_angularImpulse + n, -m, m);
    n = this.m_angularImpulse - p;
    c -= h * n;
    e += k * n;
    m = box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(d, e, this.m_rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(b, c, this.m_rA, box2d.b2Vec2.s_t1), box2d.b2FrictionJoint.prototype.SolveVelocityConstraints.s_Cdot);
    n = box2d.b2Mul_M22_V2(this.m_linearMass, m, box2d.b2FrictionJoint.prototype.SolveVelocityConstraints.s_impulseV).SelfNeg();
    ...
    m = l * this.m_maxForce;
    this.m_linearImpulse.LengthSquared() > m * m && (this.m_linearImpulse.Normalize(),
...
goog.exportProperty(box2d.b2World.prototype, "m_flag_locked", box2d.b2World.prototype.m_flag_locked);
box2d.b2World.prototype.m_flag_clearForces = !1;
goog.exportProperty(box2d.b2World.prototype, "m_flag_clearForces", box2d.b2World.prototype.m_flag_clearForces);
...
goog.exportProperty(box2d.b2World.prototype, "m_particleSystemList", box2d.b2World.prototype.m_particleSystemList);
...
box2d.b2World.prototype.SetAllowSleeping = function (a) {
    if (a !== this.m_allowSleep && (this.m_allowSleep = a,
        !this.m_allowSleep))
...
box2d.b2World.prototype.CreateJoint = function (a) {
    ...
    if (!a.collideConnected)
        for (a = d.GetContactList(); a;)
            a.other === c && a.contact.FlagForFiltering(),
                a = a.next;
    return b
}
    ;
...
box2d.b2World.prototype.DestroyParticleSystem = function (a) {
    box2d.ENABLE_ASSERTS && box2d.b2Assert(!this.IsLocked());
    this.IsLocked() || (a.m_prev && (a.m_prev.m_next = a.m_next),
        a.m_next && (a.m_next.m_prev = a.m_prev),
...
box2d.b2World.prototype.Solve = function (a) {
    ...
    for (d = this.m_jointList; d; d = d.m_next)
        d.m_islandFlag = !1;
    for (var d = this.m_bodyCount, e = this.s_stack, f = this.m_bodyList; f; f = f.m_next)
        if (!f.m_flag_islandFlag && f.IsAwake() && f.IsActive() && f.GetType() !== box2d.b2BodyType.b2_staticBody) {
            c.Clear();
            var g = 0;
            e[g++] = f;
                ...
                if (b = e[--g],
                    ...
                    for (var h = b.m_contactList; h; h = h.next) {
                        ...
                        if (!k.m_flag_islandFlag && k.IsEnabled() && k.IsTouching()) {
                            ...
                            k.m_fixtureA.m_isSensor || l || (c.AddContact(k),
                                k.m_flag_islandFlag = !0,
                                k = h.other,
                                k.m_flag_islandFlag || (box2d.ENABLE_ASSERTS && box2d.b2Assert(g < d),
                                    e[g++] = k,
                                    k.m_flag_islandFlag = !0))
                        }
                    }
                    for (b = b.m_jointList; b; b = b.next)
                        b.joint.m_islandFlag || (k = b.other,
                            k.IsActive() && (c.AddJoint(b.joint),
            ...
            for (g = 0; g < c.m_bodyCount; ++g)
                b = c.m_bodies[g],
                    b.GetType() === box2d.b2BodyType.b2_staticBody && (b.m_flag_islandFlag = !1)
        }
    for (g = 0; g < e.length && e[g]; ++g)
        e[g] = null;
    a = new box2d.b2Timer;
    for (b = this.m_bodyList; b; b = b.m_next)
        b.m_flag_islandFlag && b.GetType() !== box2d.b2BodyType.b2_staticBody && b.SynchronizeFixtures();
...
box2d.b2World.prototype.SolveTOI = function (a) {
    ...
    for (; ;) {
        for (var e = null, c = 1, d = this.m_contactManager.m_contactList; d; d = d.m_next)
            if (d.IsEnabled() && !(d.m_toiCount > box2d.b2_maxSubSteps)) {
                ...
                if (d.m_flag_toiFlag)
                    ...
                    var f = g.GetBody()
                        ...
                        , l = f.m_type
                        , m = k.m_type;
                    box2d.ENABLE_ASSERTS && box2d.b2Assert(l !== box2d.b2BodyType.b2_staticBody || m !== box2d.b2BodyType.b2_staticBody);
                    ...
                    if (!l && !m)
                        continue;
                    m = f.m_sweep.alpha0;
                    f.m_sweep.alpha0 < k.m_sweep.alpha0 ? (m = k.m_sweep.alpha0,
                        f.m_sweep.Advance(m)) : k.m_sweep.alpha0 < f.m_sweep.alpha0 && (m = f.m_sweep.alpha0,
                            k.m_sweep.Advance(m));
                    ...
                    k = f.t;
                    f = f.state === box2d.b2TOIOutputState.e_touching ? box2d.b2Min(m + (1 - m) * k, 1) : 1;
                    d.m_toi = f;
                    d.m_flag_toiFlag = !0
                }
                f < c && (e = d,
        ...
        if (e.IsEnabled() && e.IsTouching()) {
            ...
            for (e = 0; 2 > e; ++e)
                if (d = 0 === e ? f : k,
                    ...
                    for (g = d.m_contactList; g && b.m_bodyCount !== b.m_bodyCapacity && b.m_contactCount !== b.m_contactCapacity; g = g.next)
                        h = g.contact,
                            !h.m_flag_islandFlag && (m = g.other,
                                m.m_type !== box2d.b2BodyType.b2_dynamicBody || d.IsBullet() || m.IsBullet()) && (l = h.m_fixtureB.m_isSensor,
                                    h.m_fixtureA.m_isSensor || l || (l = box2d.b2World.prototype.SolveTOI.s_backup.Copy(m.m_sweep),
                                        m.m_flag_islandFlag || m.Advance(c),
                                        h.Update(this.m_contactManager.m_contactListener),
                                        h.IsEnabled() ? h.IsTouching() ? (h.m_flag_islandFlag = !0,
                                            b.AddContact(h),
                                            m.m_flag_islandFlag || (m.m_flag_islandFlag = !0,
                                                m.m_type !== box2d.b2BodyType.b2_staticBody && m.SetAwake(!0),
                                                b.AddBody(m))) : (m.m_sweep.Copy(l),
                                                    m.SynchronizeTransform()) : (m.m_sweep.Copy(l),
            ...
            for (e = 0; e < b.m_bodyCount; ++e)
                if (d = b.m_bodies[e],
                    d.m_flag_islandFlag = !1,
                    d.m_type === box2d.b2BodyType.b2_dynamicBody)
                    for (d.SynchronizeFixtures(),
                        g = d.m_contactList; g; g = g.next)
...
box2d.b2World.prototype.Step = function (a, b, c, d) {
    ...
    this.m_flag_newFixture && (this.m_contactManager.FindNewContacts(),
        this.m_flag_newFixture = !1);
    ...
    if (this.m_stepComplete && 0 < f.dt) {
        a = new box2d.b2Timer;
        for (b = this.m_particleSystemList; b; b = b.m_next)
            b.Solve(f);
        this.Solve(f);
        this.m_profile.solve = a.GetMilliseconds()
    }
    this.m_continuousPhysics && 0 < f.dt && (a = new box2d.b2Timer,
        this.SolveTOI(f),
...
box2d.b2World.prototype.QueryShape = function (a, b, c, d) {
    ...
    e.Query(function (d) {
        ...
        d = d.fixture;
        return box2d.b2TestOverlap_Shape(b, 0, d.GetShape(), 0, c, d.GetBody().GetTransform()) ? a instanceof box2d.b2QueryCallback ? a.ReportFixture(d) : a(d) : !0
    }, f);
    if (a instanceof box2d.b2QueryCallback)
...
box2d.b2World.prototype.QueryPoint = function (a, b, c) {
    ...
    d.Query(function (c) {
        ...
        c = c.fixture;
        return c.TestPoint(b) ? a instanceof box2d.b2QueryCallback ? a.ReportFixture(c) : a(c) : !0
    }, e);
    if (a instanceof box2d.b2QueryCallback)
...
box2d.b2World.prototype.RayCast = function (a, b, c) {
    ...
    d.RayCast(function (e, g) {
        ...
        if (k.RayCast(l, e, h.childIndex)) {
            ...
            return a instanceof box2d.b2RayCastCallback ? a.ReportFixture(k, m, l.normal, h) : a(k, m, l.normal, h)
        }
    ...
    switch (c.m_type) {
        ...
        case box2d.b2ShapeType.e_chainShape:
            var c = c instanceof box2d.b2ChainShape ? c : null
                ...
                , f = c.m_vertices
                , c = f[0];
            this.m_debugDraw.DrawCircle(c, .05, b);
            for (var g = 1; g < d; ++g)
                e = f[g],
                    this.m_debugDraw.DrawSegment(c, e, b),
                    this.m_debugDraw.DrawCircle(e, .05, b),
                    c = e;
            break;
...
box2d.b2World.prototype.DrawJoint = function (a) {
    var b = a.GetBodyA()
        ...
        , f = box2d.b2World.prototype.DrawJoint.s_color.SetRGB(.5, .8, .8);
    switch (a.m_type) {
        case box2d.b2JointType.e_distanceJoint:
...
box2d.b2World.prototype.DrawParticleSystem = function (a) {
    ...
    if (b) {
        ...
        a.m_colorBuffer.data ? (a = a.GetColorBuffer(),
            this.m_debugDraw.DrawParticles(d, c, a, b)) : this.m_debugDraw.DrawParticles(d, c, null, b)
    }
}
    ;
...
box2d.b2World.prototype.DrawDebugData = function () {
    if (null !== this.m_debugDraw) {
        ...
        if (a & box2d.b2DrawFlags.e_shapeBit)
            for (var c = this.m_bodyList; c; c = c.m_next) {
                ...
                for (var e = c.GetFixtureList(); e; e = e.m_next)
                    c.IsActive() ? c.GetType() === box2d.b2BodyType.b2_staticBody ? b.SetRGB(.5, .9, .5) : c.GetType() === box2d.b2BodyType.b2_kinematicBody ? b.SetRGB(.5, .5, .9) : c.IsAwake() ? b.SetRGB(.9, .7, .7) : b.SetRGB(.6, .6, .6) : b.SetRGB(.5, .5, .3),
                        this.DrawShape(e, b);
        ...
        if (a & box2d.b2DrawFlags.e_aabbBit) {
            b.SetRGB(.9, .3, .9);
            for (var d = this.m_contactManager.m_broadPhase, f = box2d.b2World.prototype.DrawDebugData.s_vs, c = this.m_bodyList; c; c = c.m_next)
                if (c.IsActive())
...
box2d.b2World.prototype.CalculateReasonableParticleIterations = function (a) {
    return null === this.m_particleSystemList ? 1 : box2d.b2CalculateParticleIterations(this.m_gravity.Length(), function (a) {
        var c = box2d.b2_maxFloat;
...
box2d.b2World.prototype.ShiftOrigin = function (a) {
    ...
    if (!this.IsLocked()) {
        for (var b = this.m_bodyList; b; b = b.m_next)
            b.m_xf.p.SelfSub(a),
                b.m_sweep.c0.SelfSub(a),
                b.m_sweep.c.SelfSub(a);
    ...
    if (box2d.DEBUG && !this.m_flag_locked) {
        ...
        for (b = this.m_jointList; b; b = b.m_next)
            b.m_index = a,
                ++a;
        for (b = this.m_jointList; b; b = b.m_next)
            b.m_type !== box2d.b2JointType.e_gearJoint && (box2d.b2Log("{\n"),
                b.Dump(),
                box2d.b2Log("}\n"));
        for (b = this.m_jointList; b; b = b.m_next)
            b.m_type === box2d.b2JointType.e_gearJoint && (box2d.b2Log("{\n"),
...
box2d.b2MotorJoint.prototype.SetAngularOffset = function (a) {
    a !== this.m_angularOffset && (this.m_bodyA.SetAwake(!0),
        this.m_bodyB.SetAwake(!0),
...
box2d.b2MotorJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    var b = a.positions[this.m_indexA].c
        ...
        , n = box2d.b2Mul_R_V2(l, box2d.b2Vec2.s_t0.Copy(this.m_localCenterA).SelfNeg(), this.m_rA)
        , m = box2d.b2Mul_R_V2(m, box2d.b2Vec2.s_t0.Copy(this.m_localCenterB).SelfNeg(), this.m_rB)
        , p = this.m_invMassA
        , q = this.m_invMassB
        , r = this.m_invIA
        , u = this.m_invIB
    ...
    0 < this.m_angularMass && (this.m_angularMass = 1 / this.m_angularMass);
    box2d.b2Sub_V2_V2(box2d.b2Sub_V2_V2(box2d.b2Add_V2_V2(f, m, box2d.b2Vec2.s_t0), box2d.b2Add_V2_V2(b, n, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t2), box2d.b2Mul_R_V2(l, this.m_linearOffset, box2d.b2Vec2.s_t3), this.m_linearError);
    ...
    a.step.warmStarting ? (this.m_linearImpulse.SelfMul(a.step.dtRatio),
        ...
        h.SelfMulAdd(q, b),
        k += u * (box2d.b2Cross_V2_V2(m, b) + this.m_angularImpulse)) : (this.m_linearImpulse.SetZero(),
            this.m_angularImpulse = 0);
...
box2d.b2MouseJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    d *= .98;
    a.step.warmStarting ? (this.m_impulse.SelfMul(a.step.dtRatio),
        c.x += this.m_invMassB * this.m_impulse.x,
        c.y += this.m_invMassB * this.m_impulse.y,
        d += this.m_invIB * box2d.b2Cross_V2_V2(this.m_rB, this.m_impulse)) : this.m_impulse.SetZero();
...
box2d.b2MouseJoint.prototype.SolveVelocityConstraints = function (a) {
    var b = a.velocities[this.m_indexB].v
        ...
        , d = box2d.b2AddCross_V2_S_V2(b, c, this.m_rB, box2d.b2MouseJoint.prototype.SolveVelocityConstraints.s_Cdot)
        , d = box2d.b2Mul_M22_V2(this.m_mass, box2d.b2Add_V2_V2(d, box2d.b2Add_V2_V2(this.m_C, box2d.b2Mul_S_V2(this.m_gamma, this.m_impulse, box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0).SelfNeg(), box2d.b2MouseJoint.prototype.SolveVelocityConstraints.s_impulse)
        , e = box2d.b2MouseJoint.prototype.SolveVelocityConstraints.s_oldImpulse.Copy(this.m_impulse);
    this.m_impulse.SelfAdd(d);
    var f = a.step.dt * this.m_maxForce;
    this.m_impulse.LengthSquared() > f * f && this.m_impulse.SelfMul(f / this.m_impulse.Length());
...
box2d.b2PrismaticJoint = function (a) {
    ...
    this.m_localYAxisA = box2d.b2Cross_S_V2(1, this.m_localXAxisA, new box2d.b2Vec2);
...
box2d.b2PrismaticJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    var m = box2d.b2Mul_R_V2(f, this.m_lalcB, this.m_rB)
        , n = box2d.b2Add_V2_V2(box2d.b2Sub_V2_V2(e, b, box2d.b2Vec2.s_t0), box2d.b2Sub_V2_V2(m, l, box2d.b2Vec2.s_t1), box2d.b2PrismaticJoint.prototype.InitVelocityConstraints.s_d)
        , b = this.m_invMassA
        , e = this.m_invMassB
        , f = this.m_invIA
        , p = this.m_invIB;
    box2d.b2Mul_R_V2(k, this.m_localXAxisA, this.m_axis);
    this.m_a1 = box2d.b2Cross_V2_V2(box2d.b2Add_V2_V2(n, l, box2d.b2Vec2.s_t0), this.m_axis);
    this.m_a2 = box2d.b2Cross_V2_V2(m, this.m_axis);
    this.m_motorMass = b + e + f * this.m_a1 * this.m_a1 + p * this.m_a2 * this.m_a2;
    0 < this.m_motorMass && (this.m_motorMass = 1 / this.m_motorMass);
    box2d.b2Mul_R_V2(k, this.m_localYAxisA, this.m_perp);
    this.m_s1 = box2d.b2Cross_V2_V2(box2d.b2Add_V2_V2(n, l, box2d.b2Vec2.s_t0), this.m_perp);
    ...
    this.m_enableLimit ? (k = box2d.b2Dot_V2_V2(this.m_axis, n),
        box2d.b2Abs(this.m_upperTranslation - this.m_lowerTranslation) < 2 * box2d.b2_linearSlop ? this.m_limitState = box2d.b2LimitState.e_equalLimits : k <= this.m_lowerTranslation ? this.m_limitState !== box2d.b2LimitState.e_atLowerLimit && (this.m_limitState = box2d.b2LimitState.e_atLowerLimit,
            this.m_impulse.z = 0) : k >= this.m_upperTranslation ? this.m_limitState !== box2d.b2LimitState.e_atUpperLimit && (this.m_limitState = box2d.b2LimitState.e_atUpperLimit,
                this.m_impulse.z = 0) : (this.m_limitState = box2d.b2LimitState.e_inactiveLimit,
                    this.m_impulse.z = 0)) : (this.m_limitState = box2d.b2LimitState.e_inactiveLimit,
                        this.m_impulse.z = 0);
    this.m_enableMotor || (this.m_motorImpulse = 0);
    a.step.warmStarting ? (this.m_impulse.SelfMulScalar(a.step.dtRatio),
        this.m_motorImpulse *= a.step.dtRatio,
        k = box2d.b2Add_V2_V2(box2d.b2Mul_S_V2(this.m_impulse.x, this.m_perp, box2d.b2Vec2.s_t0), box2d.b2Mul_S_V2(this.m_motorImpulse + this.m_impulse.z, this.m_axis, box2d.b2Vec2.s_t1), box2d.b2PrismaticJoint.prototype.InitVelocityConstraints.s_P),
...
box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints = function (a) {
    ...
    if (this.m_enableMotor && this.m_limitState !== box2d.b2LimitState.e_equalLimits) {
        var l = box2d.b2Dot_V2_V2(this.m_axis, box2d.b2Sub_V2_V2(d, b, box2d.b2Vec2.s_t0)) + this.m_a2 * e - this.m_a1 * c
        ...
        m = box2d.b2Mul_S_V2(l, this.m_axis, box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_P);
        n = l * this.m_a1;
        l *= this.m_a2;
        b.SelfMulSub(f, m);
        c -= h * n;
    ...
    var n = box2d.b2Dot_V2_V2(this.m_perp, box2d.b2Sub_V2_V2(d, b, box2d.b2Vec2.s_t0)) + this.m_s2 * e - this.m_s1 * c
        , p = e - c;
    this.m_enableLimit && this.m_limitState !== box2d.b2LimitState.e_inactiveLimit ? (l = box2d.b2Dot_V2_V2(this.m_axis, box2d.b2Sub_V2_V2(d, b, box2d.b2Vec2.s_t0)) + this.m_a2 * e - this.m_a1 * c,
        m = box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_f1.Copy(this.m_impulse),
        l = this.m_K.Solve33(-n, -p, -l, box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_df3),
        ...
        n = this.m_K.Solve22(-n - (this.m_impulse.z - m.z) * this.m_K.ez.x, -p - (this.m_impulse.z - m.z) * this.m_K.ez.y, box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_f2r),
        n.x += m.x,
        n.y += m.y,
        ...
        m = box2d.b2Add_V2_V2(box2d.b2Mul_S_V2(l.x, this.m_perp, box2d.b2Vec2.s_t0), box2d.b2Mul_S_V2(l.z, this.m_axis, box2d.b2Vec2.s_t1), box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_P),
        n = l.x * this.m_s1 + l.y + l.z * this.m_a1,
        l = l.x * this.m_s2 + l.y + l.z * this.m_a2) : (l = this.m_K.Solve22(-n, -p, box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_df2),
            this.m_impulse.x += l.x,
            this.m_impulse.y += l.y,
            m = box2d.b2Mul_S_V2(l.x, this.m_perp, box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_P),
            n = l.x * this.m_s1 + l.y,
            l = l.x * this.m_s2 + l.y);
    b.SelfMulSub(f, m);
    c -= h * n;
...
box2d.b2PrismaticJoint.prototype.SolvePositionConstraints = function (a) {
    var b = a.positions[this.m_indexA].c
        ...
        , q = box2d.b2Sub_V2_V2(box2d.b2Add_V2_V2(d, p, box2d.b2Vec2.s_t0), box2d.b2Add_V2_V2(b, n, box2d.b2Vec2.s_t1), box2d.b2PrismaticJoint.prototype.SolvePositionConstraints.s_d)
        ...
        , z = !1
        , B = 0;
    this.m_enableLimit && (q = box2d.b2Dot_V2_V2(r, q),
        box2d.b2Abs(this.m_upperTranslation - this.m_lowerTranslation) < 2 * box2d.b2_linearSlop ? (B = box2d.b2Clamp(q, -box2d.b2_maxLinearCorrection, box2d.b2_maxLinearCorrection),
            n = box2d.b2Max(n, box2d.b2Abs(q)),
            z = !0) : q <= this.m_lowerTranslation ? (B = box2d.b2Clamp(q - this.m_lowerTranslation + box2d.b2_linearSlop, -box2d.b2_maxLinearCorrection, 0),
                n = box2d.b2Max(n, this.m_lowerTranslation - q),
                z = !0) : q >= this.m_upperTranslation && (B = box2d.b2Clamp(q - this.m_upperTranslation - box2d.b2_linearSlop, 0, box2d.b2_maxLinearCorrection),
    ...
    if (z) {
        ...
        q = l * t + m * w,
            ...
            B.ey.Set(q, z),
            v = B.Solve(-v, -y, box2d.b2PrismaticJoint.prototype.SolvePositionConstraints.s_impulse1),
            x.x = v.x,
            x.y = v.y,
            x.z = 0;
    r = box2d.b2Add_V2_V2(box2d.b2Mul_S_V2(x.x, f, box2d.b2Vec2.s_t0), box2d.b2Mul_S_V2(x.z, r, box2d.b2Vec2.s_t1), box2d.b2PrismaticJoint.prototype.SolvePositionConstraints.s_P);
    u = x.x * t + x.y + x.z * u;
    g = x.x * w + x.y + x.z * g;
    b.SelfMulSub(h, r);
    c -= l * u;
...
box2d.b2PrismaticJoint.prototype.GetReactionForce = function (a, b) {
    return b.Set(a * (this.m_impulse.x * this.m_perp.x + (this.m_motorImpulse + this.m_impulse.z) * this.m_axis.x), a * (this.m_impulse.x * this.m_perp.y + (this.m_motorImpulse + this.m_impulse.z) * this.m_axis.y))
}
    ;
...
box2d.b2PrismaticJoint.prototype.GetJointTranslation = function () {
    var a = this.m_bodyA.GetWorldPoint(this.m_localAnchorA, box2d.b2PrismaticJoint.prototype.GetJointTranslation.s_pA)
        ...
        , a = box2d.b2Sub_V2_V2(b, a, box2d.b2PrismaticJoint.prototype.GetJointTranslation.s_d)
...
box2d.b2PrismaticJoint.prototype.GetJointSpeed = function () {
    ...
    return box2d.b2Dot_V2_V2(e, box2d.b2Cross_S_V2(a, f, box2d.b2Vec2.s_t0)) + box2d.b2Dot_V2_V2(f, box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(h, b, d, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(g, a, c, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t0))
}
    ;
...
box2d.b2PulleyJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    this.m_mass = this.m_invMassA + this.m_invIA * b * b + this.m_ratio * this.m_ratio * (this.m_invMassB + this.m_invIB * e * e);
    0 < this.m_mass && (this.m_mass = 1 / this.m_mass);
    a.step.warmStarting ? (this.m_impulse *= a.step.dtRatio,
        b = box2d.b2Mul_S_V2(-this.m_impulse, this.m_uA, box2d.b2PulleyJoint.prototype.InitVelocityConstraints.s_PA),
        e = box2d.b2Mul_S_V2(-this.m_ratio * this.m_impulse, this.m_uB, box2d.b2PulleyJoint.prototype.InitVelocityConstraints.s_PB),
        c.SelfMulAdd(this.m_invMassA, b),
        d += this.m_invIA * box2d.b2Cross_V2_V2(this.m_rA, b),
        g.SelfMulAdd(this.m_invMassB, e),
        h += this.m_invIB * box2d.b2Cross_V2_V2(this.m_rB, e)) : this.m_impulse = 0;
    a.velocities[this.m_indexA].w = d;
    a.velocities[this.m_indexB].w = h
}
    ;
...
box2d.b2PulleyJoint.prototype.SolveVelocityConstraints = function (a) {
    var b = a.velocities[this.m_indexA].v
        ...
        , d = a.velocities[this.m_indexB].v
        , e = a.velocities[this.m_indexB].w
        , f = box2d.b2AddCross_V2_S_V2(b, c, this.m_rA, box2d.b2PulleyJoint.prototype.SolveVelocityConstraints.s_vpA)
        , g = box2d.b2AddCross_V2_S_V2(d, e, this.m_rB, box2d.b2PulleyJoint.prototype.SolveVelocityConstraints.s_vpB)
        , f = -box2d.b2Dot_V2_V2(this.m_uA, f) - this.m_ratio * box2d.b2Dot_V2_V2(this.m_uB, g)
        , g = -this.m_mass * f;
    this.m_impulse += g;
    f = box2d.b2Mul_S_V2(-g, this.m_uA, box2d.b2PulleyJoint.prototype.SolveVelocityConstraints.s_PA);
    g = box2d.b2Mul_S_V2(-this.m_ratio * g, this.m_uB, box2d.b2PulleyJoint.prototype.SolveVelocityConstraints.s_PB);
...
box2d.b2PulleyJoint.prototype.SolvePositionConstraints = function (a) {
    ...
    l = box2d.b2Abs(m);
    m *= -n;
    h = box2d.b2Mul_S_V2(-m, h, box2d.b2PulleyJoint.prototype.SolvePositionConstraints.s_PA);
    k = box2d.b2Mul_S_V2(-this.m_ratio * m, k, box2d.b2PulleyJoint.prototype.SolvePositionConstraints.s_PB);
...
box2d.b2PulleyJoint.prototype.GetReactionForce = function (a, b) {
    return b.Set(a * this.m_impulse * this.m_uB.x, a * this.m_impulse * this.m_uB.y)
}
    ;
...
box2d.b2RevoluteJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    var h = this.m_invMassA
        ...
        , m = this.m_invIB
        , n = 0 === l + m;
    this.m_mass.ex.x = h + k + this.m_rA.y * this.m_rA.y * l + this.m_rB.y * this.m_rB.y * m;
    this.m_mass.ey.x = -this.m_rA.y * this.m_rA.x * l - this.m_rB.y * this.m_rB.x * m;
    this.m_mass.ez.x = -this.m_rA.y * l - this.m_rB.y * m;
    this.m_mass.ex.y = this.m_mass.ey.x;
    this.m_mass.ey.y = h + k + this.m_rA.x * this.m_rA.x * l + this.m_rB.x * this.m_rB.x * m;
    ...
    0 < this.m_motorMass && (this.m_motorMass = 1 / this.m_motorMass);
    if (!this.m_enableMotor || n)
        this.m_motorImpulse = 0;
    this.m_enableLimit && !n ? (b = e - b - this.m_referenceAngle,
        box2d.b2Abs(this.m_upperAngle - this.m_lowerAngle) < 2 * box2d.b2_angularSlop ? this.m_limitState = box2d.b2LimitState.e_equalLimits : b <= this.m_lowerAngle ? (this.m_limitState !== box2d.b2LimitState.e_atLowerLimit && (this.m_impulse.z = 0),
            this.m_limitState = box2d.b2LimitState.e_atLowerLimit) : b >= this.m_upperAngle ? (this.m_limitState !== box2d.b2LimitState.e_atUpperLimit && (this.m_impulse.z = 0),
                this.m_limitState = box2d.b2LimitState.e_atUpperLimit) : (this.m_limitState = box2d.b2LimitState.e_inactiveLimit,
                    this.m_impulse.z = 0)) : this.m_limitState = box2d.b2LimitState.e_inactiveLimit;
    a.step.warmStarting ? (this.m_impulse.SelfMulScalar(a.step.dtRatio),
        this.m_motorImpulse *= a.step.dtRatio,
        b = box2d.b2RevoluteJoint.prototype.InitVelocityConstraints.s_P.Set(this.m_impulse.x, this.m_impulse.y),
        c.SelfMulSub(h, b),
        d -= l * (box2d.b2Cross_V2_V2(this.m_rA, b) + this.m_motorImpulse + this.m_impulse.z),
        f.SelfMulAdd(k, b),
        g += m * (box2d.b2Cross_V2_V2(this.m_rB, b) + this.m_motorImpulse + this.m_impulse.z)) : (this.m_impulse.SetZero(),
            this.m_motorImpulse = 0);
    a.velocities[this.m_indexA].w = d;
...
box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints = function (a) {
    var b = a.velocities[this.m_indexA].v
        ...
        , k = this.m_invIB
        , l = 0 === h + k;
    if (this.m_enableMotor && this.m_limitState !== box2d.b2LimitState.e_equalLimits && !l) {
    ...
    this.m_enableLimit && this.m_limitState !== box2d.b2LimitState.e_inactiveLimit && !l ? (l = box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(d, e, this.m_rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(b, c, this.m_rA, box2d.b2Vec2.s_t1), box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_Cdot1),
        m = this.m_mass.Solve33(l.x, l.y, e - c, box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_impulse3).SelfNeg(),
        this.m_limitState === box2d.b2LimitState.e_equalLimits ? this.m_impulse.SelfAdd(m) : this.m_limitState === box2d.b2LimitState.e_atLowerLimit ? (n = this.m_impulse.z + m.z,
            0 > n ? (n = -l.x + this.m_impulse.z * this.m_mass.ez.x,
                l = -l.y + this.m_impulse.z * this.m_mass.ez.y,
                l = this.m_mass.Solve22(n, l, box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_reduced),
                m.x = l.x,
                m.y = l.y,
                m.z = -this.m_impulse.z,
                this.m_impulse.x += l.x,
                this.m_impulse.y += l.y,
                this.m_impulse.z = 0) : this.m_impulse.SelfAdd(m)) : this.m_limitState === box2d.b2LimitState.e_atUpperLimit && (n = this.m_impulse.z + m.z,
                    0 < n ? (n = -l.x + this.m_impulse.z * this.m_mass.ez.x,
                        l = -l.y + this.m_impulse.z * this.m_mass.ez.y,
                        l = this.m_mass.Solve22(n, l, box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_reduced),
                        m.x = l.x,
                        ...
                        this.m_impulse.x += l.x,
                        this.m_impulse.y += l.y,
                        this.m_impulse.z = 0) : this.m_impulse.SelfAdd(m)),
        l = box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_P.Set(m.x, m.y),
        b.SelfMulSub(f, l),
        c -= h * (box2d.b2Cross_V2_V2(this.m_rA, l) + m.z),
        d.SelfMulAdd(g, l),
        e += k * (box2d.b2Cross_V2_V2(this.m_rB, l) + m.z)) : (m = box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(d, e, this.m_rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(b, c, this.m_rA, box2d.b2Vec2.s_t1), box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_Cdot),
            m = this.m_mass.Solve22(-m.x, -m.y, box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_impulse2),
...
box2d.b2RevoluteJoint.prototype.SolvePositionConstraints = function (a) {
    ...
    if (this.m_enableLimit && this.m_limitState !== box2d.b2LimitState.e_inactiveLimit && !k) {
        var l = e - c - this.m_referenceAngle
            , k = 0;
        this.m_limitState === box2d.b2LimitState.e_equalLimits ? (l = box2d.b2Clamp(l - this.m_lowerAngle, -box2d.b2_maxAngularCorrection, box2d.b2_maxAngularCorrection),
            k = -this.m_motorMass * l,
            h = box2d.b2Abs(l)) : this.m_limitState === box2d.b2LimitState.e_atLowerLimit ? (l -= this.m_lowerAngle,
                h = -l,
                l = box2d.b2Clamp(l + box2d.b2_angularSlop, -box2d.b2_maxAngularCorrection, 0),
                k = -this.m_motorMass * l) : this.m_limitState === box2d.b2LimitState.e_atUpperLimit && (h = l -= this.m_upperAngle,
                    l = box2d.b2Clamp(l - box2d.b2_angularSlop, 0, box2d.b2_maxAngularCorrection),
                    k = -this.m_motorMass * l);
        c -= this.m_invIA * k;
        e += this.m_invIB * k
    }
    ...
    box2d.b2Sub_V2_V2(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
    var g = box2d.b2Mul_R_V2(g, this.m_lalcB, this.m_rB)
        , l = box2d.b2Sub_V2_V2(box2d.b2Add_V2_V2(d, g, box2d.b2Vec2.s_t0), box2d.b2Add_V2_V2(b, f, box2d.b2Vec2.s_t1), box2d.b2RevoluteJoint.prototype.SolvePositionConstraints.s_C)
        , k = l.Length()
        , m = this.m_invMassA
        , n = this.m_invMassB
        , p = this.m_invIA
    ...
    l = r.Solve(l.x, l.y, box2d.b2RevoluteJoint.prototype.SolvePositionConstraints.s_impulse).SelfNeg();
    b.SelfMulSub(m, l);
...
box2d.b2RevoluteJoint.prototype.EnableMotor = function (a) {
    this.m_enableMotor !== a && (this.m_bodyA.SetAwake(!0),
        this.m_bodyB.SetAwake(!0),
        this.m_enableMotor = a)
}
    ;
...
box2d.b2RevoluteJoint.prototype.SetMotorSpeed = function (a) {
    this.m_motorSpeed !== a && (this.m_bodyA.SetAwake(!0),
        this.m_bodyB.SetAwake(!0),
        this.m_motorSpeed = a)
}
    ;
...
box2d.b2GearJoint = function (a) {
    ...
    this.m_typeA === box2d.b2JointType.e_revoluteJoint ? (c = a.joint1,
        ...
        b = d - e - this.m_referenceAngleA) : (e = a.joint1,
            ...
            b = box2d.b2MulT_R_V2(c.q, box2d.b2Add_V2_V2(box2d.b2Mul_R_V2(b.q, this.m_localAnchorA, box2d.b2Vec2.s_t0), box2d.b2Sub_V2_V2(b.p, c.p, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0),
            b = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(b, d, box2d.b2Vec2.s_t0), this.m_localAxisC));
    ...
    this.m_typeB === box2d.b2JointType.e_revoluteJoint ? (c = a.joint2,
        ...
        c = e - f - this.m_referenceAngleB) : (e = a.joint2,
            ...
            c = box2d.b2MulT_R_V2(d.q, box2d.b2Add_V2_V2(box2d.b2Mul_R_V2(c.q, this.m_localAnchorB, box2d.b2Vec2.s_t0), box2d.b2Sub_V2_V2(c.p, d.p, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0),
            c = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(c, e, box2d.b2Vec2.s_t0), this.m_localAxisD));
    this.m_ratio = a.ratio;
...
box2d.b2GearJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    this.m_mass = 0;
    this.m_typeA === box2d.b2JointType.e_revoluteJoint ? (this.m_JvAC.SetZero(),
        this.m_JwC = this.m_JwA = 1,
        this.m_mass += this.m_iA + this.m_iC) : (l = box2d.b2Mul_R_V2(q, this.m_localAxisC, box2d.b2GearJoint.prototype.InitVelocityConstraints.s_u),
            box2d.b2Sub_V2_V2(this.m_localAnchorC, this.m_lcC, this.m_lalcC),
            q = box2d.b2Mul_R_V2(q, this.m_lalcC, box2d.b2GearJoint.prototype.InitVelocityConstraints.s_rC),
            box2d.b2Sub_V2_V2(this.m_localAnchorA, this.m_lcA, this.m_lalcA),
            p = box2d.b2Mul_R_V2(p, this.m_lalcA, box2d.b2GearJoint.prototype.InitVelocityConstraints.s_rA),
            this.m_JvAC.Copy(l),
            this.m_JwC = box2d.b2Cross_V2_V2(q, l),
            this.m_JwA = box2d.b2Cross_V2_V2(p, l),
            this.m_mass += this.m_mC + this.m_mA + this.m_iC * this.m_JwC * this.m_JwC + this.m_iA * this.m_JwA * this.m_JwA);
    this.m_typeB === box2d.b2JointType.e_revoluteJoint ? (this.m_JvBD.SetZero(),
        this.m_JwD = this.m_JwB = this.m_ratio,
        this.m_mass += this.m_ratio * this.m_ratio * (this.m_iB + this.m_iD)) : (l = box2d.b2Mul_R_V2(g, this.m_localAxisD, box2d.b2GearJoint.prototype.InitVelocityConstraints.s_u),
            box2d.b2Sub_V2_V2(this.m_localAnchorD, this.m_lcD, this.m_lalcD),
            p = box2d.b2Mul_R_V2(g, this.m_lalcD, box2d.b2GearJoint.prototype.InitVelocityConstraints.s_rD),
            box2d.b2Sub_V2_V2(this.m_localAnchorB, this.m_lcB, this.m_lalcB),
            d = box2d.b2Mul_R_V2(d, this.m_lalcB, box2d.b2GearJoint.prototype.InitVelocityConstraints.s_rB),
    ...
    a.step.warmStarting ? (b.SelfMulAdd(this.m_mA * this.m_impulse, this.m_JvAC),
...
box2d.b2GearJoint.prototype.SolveVelocityConstraints = function (a) {
    var b = a.velocities[this.m_indexA].v
        ...
        , l = box2d.b2Dot_V2_V2(this.m_JvAC, box2d.b2Sub_V2_V2(b, f, box2d.b2Vec2.s_t0)) + box2d.b2Dot_V2_V2(this.m_JvBD, box2d.b2Sub_V2_V2(d, h, box2d.b2Vec2.s_t0))
        , l = l + (this.m_JwA * c - this.m_JwC * g + (this.m_JwB * e - this.m_JwD * k))
        , l = -this.m_mass * l;
    this.m_impulse += l;
...
box2d.b2GearJoint.prototype.SolvePositionConstraints = function (a) {
    ...
    if (this.m_typeA === box2d.b2JointType.e_revoluteJoint)
        ...
        t = box2d.b2Mul_R_V2(n, this.m_localAxisC, box2d.b2GearJoint.prototype.SolvePositionConstraints.s_u);
        u = box2d.b2Mul_R_V2(n, this.m_lalcC, box2d.b2GearJoint.prototype.SolvePositionConstraints.s_rC);
        var x = box2d.b2Mul_R_V2(l, this.m_lalcA, box2d.b2GearJoint.prototype.SolvePositionConstraints.s_rA);
        q.Copy(t);
        l = box2d.b2Cross_V2_V2(u, t);
        u = box2d.b2Cross_V2_V2(x, t);
        w += this.m_mC + this.m_mA + this.m_iC * l * l + this.m_iA * u * u;
        t = this.m_lalcC;
        n = box2d.b2MulT_R_V2(n, box2d.b2Add_V2_V2(x, box2d.b2Sub_V2_V2(b, f, box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0);
        n = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(n, t, box2d.b2Vec2.s_t0), this.m_localAxisC)
    }
    if (this.m_typeB === box2d.b2JointType.e_revoluteJoint)
        ...
        t = box2d.b2Mul_R_V2(p, this.m_localAxisD, box2d.b2GearJoint.prototype.SolvePositionConstraints.s_u);
        var v = box2d.b2Mul_R_V2(p, this.m_lalcD, box2d.b2GearJoint.prototype.SolvePositionConstraints.s_rD)
            , x = box2d.b2Mul_R_V2(m, this.m_lalcB, box2d.b2GearJoint.prototype.SolvePositionConstraints.s_rB);
        box2d.b2Mul_S_V2(this.m_ratio, t, r);
        m = this.m_ratio * box2d.b2Cross_V2_V2(v, t);
        t = this.m_ratio * box2d.b2Cross_V2_V2(x, t);
        w += this.m_ratio * this.m_ratio * (this.m_mD + this.m_mB) + this.m_iD * m * m + this.m_iB * t * t;
        v = this.m_lalcD;
        p = box2d.b2MulT_R_V2(p, box2d.b2Add_V2_V2(x, box2d.b2Sub_V2_V2(d, h, box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0);
        p = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(p, v, box2d.b2Vec2.s_t0), this.m_localAxisD)
    }
...
box2d.b2RopeJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    this.m_length > box2d.b2_linearSlop ? (this.m_u.SelfMul(1 / this.m_length),
        b = box2d.b2Cross_V2_V2(this.m_rA, this.m_u),
        e = box2d.b2Cross_V2_V2(this.m_rB, this.m_u),
        b = this.m_invMassA + this.m_invIA * b * b + this.m_invMassB + this.m_invIB * e * e,
        this.m_mass = 0 !== b ? 1 / b : 0,
        a.step.warmStarting ? (this.m_impulse *= a.step.dtRatio,
            b = box2d.b2Mul_S_V2(this.m_impulse, this.m_u, box2d.b2RopeJoint.prototype.InitVelocityConstraints.s_P),
            c.SelfMulSub(this.m_invMassA, b),
            d -= this.m_invIA * box2d.b2Cross_V2_V2(this.m_rA, b),
            g.SelfMulAdd(this.m_invMassB, b),
            h += this.m_invIB * box2d.b2Cross_V2_V2(this.m_rB, b)) : this.m_impulse = 0,
        a.velocities[this.m_indexA].w = d,
        a.velocities[this.m_indexB].w = h) : (this.m_u.SetZero(),
...
box2d.b2RopeJoint.prototype.SolveVelocityConstraints = function (a) {
    var b = a.velocities[this.m_indexA].v
        ...
        , d = a.velocities[this.m_indexB].v
        , e = a.velocities[this.m_indexB].w
        , f = box2d.b2AddCross_V2_S_V2(b, c, this.m_rA, box2d.b2RopeJoint.prototype.SolveVelocityConstraints.s_vpA)
        , g = box2d.b2AddCross_V2_S_V2(d, e, this.m_rB, box2d.b2RopeJoint.prototype.SolveVelocityConstraints.s_vpB)
    ...
    h = this.m_impulse - f;
    h = box2d.b2Mul_S_V2(h, this.m_u, box2d.b2RopeJoint.prototype.SolveVelocityConstraints.s_P);
    b.SelfMulSub(this.m_invMassA, h);
...
box2d.b2RopeJoint.prototype.SolvePositionConstraints = function (a) {
    ...
    var g = box2d.b2Mul_R_V2(g, this.m_lalcB, this.m_rB)
        ...
        , h = box2d.b2Mul_S_V2(-this.m_mass * l, h, box2d.b2RopeJoint.prototype.SolvePositionConstraints.s_P);
    b.SelfMulSub(this.m_invMassA, h);
    c -= this.m_invIA * box2d.b2Cross_V2_V2(f, h);
    d.SelfMulAdd(this.m_invMassB, h);
    e += this.m_invIB * box2d.b2Cross_V2_V2(g, h);
...
box2d.b2WeldJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    var h = this.m_invMassA
        ...
        , m = this.m_invIB
        , n = this.m_K;
    n.ex.x = h + k + this.m_rA.y * this.m_rA.y * l + this.m_rB.y * this.m_rB.y * m;
    n.ey.x = -this.m_rA.y * this.m_rA.x * l - this.m_rB.y * this.m_rB.x * m;
    n.ez.x = -this.m_rA.y * l - this.m_rB.y * m;
    n.ex.y = n.ey.x;
    n.ey.y = h + k + this.m_rA.x * this.m_rA.x * l + this.m_rB.x * this.m_rB.x * m;
    ...
    if (0 < this.m_frequencyHz) {
        ...
        0 === n.ez.z ? n.GetInverse22(this.m_mass) : n.GetSymInverse33(this.m_mass),
            this.m_bias = this.m_gamma = 0;
    a.step.warmStarting ? (this.m_impulse.SelfMulScalar(a.step.dtRatio),
        n = box2d.b2WeldJoint.prototype.InitVelocityConstraints.s_P.Set(this.m_impulse.x, this.m_impulse.y),
        c.SelfMulSub(h, n),
        d -= l * (box2d.b2Cross_V2_V2(this.m_rA, n) + this.m_impulse.z),
        f.SelfMulAdd(k, n),
        g += m * (box2d.b2Cross_V2_V2(this.m_rB, n) + this.m_impulse.z)) : this.m_impulse.SetZero();
    a.velocities[this.m_indexA].w = d;
    a.velocities[this.m_indexB].w = g
}
    ;
...
box2d.b2WeldJoint.prototype.SolveVelocityConstraints = function (a) {
    var b = a.velocities[this.m_indexA].v
        ...
        , k = this.m_invIB;
    if (0 < this.m_frequencyHz) {
        var l = -this.m_mass.ez.z * (e - c + this.m_bias + this.m_gamma * this.m_impulse.z);
        this.m_impulse.z += l;
        c -= h * l;
        e += k * l;
        l = box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(d, e, this.m_rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(b, c, this.m_rA, box2d.b2Vec2.s_t1), box2d.b2WeldJoint.prototype.SolveVelocityConstraints.s_Cdot1);
        l = box2d.b2Mul_M33_X_Y(this.m_mass, l.x, l.y, box2d.b2WeldJoint.prototype.SolveVelocityConstraints.s_impulse1).SelfNeg();
        this.m_impulse.x += l.x;
        this.m_impulse.y += l.y;
        b.SelfMulSub(f, l);
        ...
        var l = box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(d, e, this.m_rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(b, c, this.m_rA, box2d.b2Vec2.s_t1), box2d.b2WeldJoint.prototype.SolveVelocityConstraints.s_Cdot1)
            , m = box2d.b2Mul_M33_X_Y_Z(this.m_mass, l.x, l.y, e - c, box2d.b2WeldJoint.prototype.SolveVelocityConstraints.s_impulse).SelfNeg();
...
box2d.b2WeldJoint.prototype.SolvePositionConstraints = function (a) {
    ...
    q.ez.z = l + m;
    if (0 < this.m_frequencyHz) {
        var r = box2d.b2Sub_V2_V2(box2d.b2Add_V2_V2(d, p, box2d.b2Vec2.s_t0), box2d.b2Add_V2_V2(b, n, box2d.b2Vec2.s_t1), box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_C1)
            , g = r.Length()
            , f = 0
        ...
        r = box2d.b2Sub_V2_V2(box2d.b2Add_V2_V2(d, p, box2d.b2Vec2.s_t0), box2d.b2Add_V2_V2(b, n, box2d.b2Vec2.s_t1), box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_C1),
            p = e - c - this.m_referenceAngle,
            g = r.Length(),
            f = box2d.b2Abs(p),
            n = box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_impulse,
            0 < q.ez.z ? q.Solve33(r.x, r.y, p, n).SelfNeg() : (q = q.Solve22(r.x, r.y, box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_impulse2).SelfNeg(),
                n.x = q.x,
                n.y = q.y,
                n.z = 0),
            q = box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_P.Set(n.x, n.y),
            b.SelfMulSub(h, q),
...
box2d.b2WheelJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    f = box2d.b2Sub_V2_V2(box2d.b2Add_V2_V2(k, q, box2d.b2Vec2.s_t0), box2d.b2Add_V2_V2(f, l, box2d.b2Vec2.s_t1), box2d.b2WheelJoint.prototype.InitVelocityConstraints.s_d);
    box2d.b2Mul_R_V2(p, this.m_localYAxisA, this.m_ay);
    this.m_sAy = box2d.b2Cross_V2_V2(box2d.b2Add_V2_V2(f, l, box2d.b2Vec2.s_t0), this.m_ay);
    ...
    0 < this.m_frequencyHz ? (box2d.b2Mul_R_V2(p, this.m_localXAxisA, this.m_ax),
        this.m_sAx = box2d.b2Cross_V2_V2(box2d.b2Add_V2_V2(f, l, box2d.b2Vec2.s_t0), this.m_ax),
        this.m_sBx = box2d.b2Cross_V2_V2(q, this.m_ax),
        b = b + c + d * this.m_sAx * this.m_sAx + e * this.m_sBx * this.m_sBx,
        0 < b && (this.m_springMass = 1 / b,
            c = box2d.b2Dot_V2_V2(f, this.m_ax),
            p = 2 * box2d.b2_pi * this.m_frequencyHz,
            f = this.m_springMass * p * p,
            k = a.step.dt,
            this.m_gamma = k * (2 * this.m_springMass * this.m_dampingRatio * p + k * f),
            0 < this.m_gamma && (this.m_gamma = 1 / this.m_gamma),
            this.m_bias = c * k * f * this.m_gamma,
            this.m_springMass = b + this.m_gamma,
            0 < this.m_springMass && (this.m_springMass = 1 / this.m_springMass))) : this.m_springImpulse = 0;
    this.m_enableMotor ? (this.m_motorMass = d + e,
        0 < this.m_motorMass && (this.m_motorMass = 1 / this.m_motorMass)) : this.m_motorImpulse = this.m_motorMass = 0;
    a.step.warmStarting ? (this.m_impulse *= a.step.dtRatio,
        this.m_springImpulse *= a.step.dtRatio,
        this.m_motorImpulse *= a.step.dtRatio,
        d = box2d.b2Add_V2_V2(box2d.b2Mul_S_V2(this.m_impulse, this.m_ay, box2d.b2Vec2.s_t0), box2d.b2Mul_S_V2(this.m_springImpulse, this.m_ax, box2d.b2Vec2.s_t1), box2d.b2WheelJoint.prototype.InitVelocityConstraints.s_P),
        ...
        n += this.m_invIB * b) : this.m_motorImpulse = this.m_springImpulse = this.m_impulse = 0;
...
box2d.b2WheelJoint.prototype.SolveVelocityConstraints = function (a) {
    var b = this.m_invMassA
        ...
        , h = a.velocities[this.m_indexB].v
        , k = a.velocities[this.m_indexB].w
        , l = box2d.b2Dot_V2_V2(this.m_ax, box2d.b2Sub_V2_V2(h, f, box2d.b2Vec2.s_t0)) + this.m_sBx * k - this.m_sAx * g
        , l = -this.m_springMass * (l + this.m_bias + this.m_gamma * this.m_springImpulse);
    this.m_springImpulse += l;
    var m = box2d.b2Mul_S_V2(l, this.m_ax, box2d.b2WheelJoint.prototype.SolveVelocityConstraints.s_P)
        , n = l * this.m_sAx
        , l = l * this.m_sBx;
    f.SelfMulSub(b, m);
    g -= d * n;
    ...
    g -= d * l;
    k += e * l;
    l = box2d.b2Dot_V2_V2(this.m_ay, box2d.b2Sub_V2_V2(h, f, box2d.b2Vec2.s_t0)) + this.m_sBy * k - this.m_sAy * g;
    l *= -this.m_mass;
    this.m_impulse += l;
    m = box2d.b2Mul_S_V2(l, this.m_ay, box2d.b2WheelJoint.prototype.SolveVelocityConstraints.s_P);
    n = l * this.m_sAy;
    l *= this.m_sBy;
    f.SelfMulSub(b, m);
    g -= d * n;
...
box2d.b2WheelJoint.prototype.SolvePositionConstraints = function (a) {
    ...
    box2d.b2Sub_V2_V2(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
    var g = box2d.b2Mul_R_V2(g, this.m_lalcB, this.m_rB)
        , k = box2d.b2Add_V2_V2(box2d.b2Sub_V2_V2(d, b, box2d.b2Vec2.s_t0), box2d.b2Sub_V2_V2(g, h, box2d.b2Vec2.s_t1), box2d.b2WheelJoint.prototype.SolvePositionConstraints.s_d)
        ...
        , l = this.m_invMassA + this.m_invMassB + this.m_invIA * this.m_sAy * this.m_sAy + this.m_invIB * this.m_sBy * this.m_sBy
        , l = 0 !== l ? -k / l : 0
        , f = box2d.b2Mul_S_V2(l, f, box2d.b2WheelJoint.prototype.SolvePositionConstraints.s_P)
        , h = l * h
        , g = l * g;
    b.SelfMulSub(this.m_invMassA, f);
    c -= this.m_invIA * h;
...
goog.exportProperty(box2d.b2ParticleColor.prototype, "g", box2d.b2ParticleColor.prototype.g);
box2d.b2ParticleColor.prototype.b = 0;
goog.exportProperty(box2d.b2ParticleColor.prototype, "b", box2d.b2ParticleColor.prototype.b);
box2d.b2ParticleColor.prototype.a = 0;
goog.exportProperty(box2d.b2ParticleColor.prototype, "a", box2d.b2ParticleColor.prototype.a);
...
goog.exportProperty(box2d.b2ParticleColor, "k_maxValue", box2d.b2ParticleColor.k_maxValue);
...
goog.exportProperty(box2d.b2ParticleDef.prototype, "position", box2d.b2ParticleDef.prototype.position);
box2d.b2ParticleDef.prototype.velocity = null;
goog.exportProperty(box2d.b2ParticleDef.prototype, "velocity", box2d.b2ParticleDef.prototype.velocity);
box2d.b2ParticleDef.prototype.color = null;
goog.exportProperty(box2d.b2ParticleDef.prototype, "color", box2d.b2ParticleDef.prototype.color);
box2d.b2ParticleDef.prototype.lifetime = 0;
goog.exportProperty(box2d.b2ParticleDef.prototype, "lifetime", box2d.b2ParticleDef.prototype.lifetime);
box2d.b2ParticleDef.prototype.userData = null;
goog.exportProperty(box2d.b2ParticleDef.prototype, "userData", box2d.b2ParticleDef.prototype.userData);
box2d.b2ParticleDef.prototype.group = null;
goog.exportProperty(box2d.b2ParticleDef.prototype, "group", box2d.b2ParticleDef.prototype.group);
box2d.b2CalculateParticleIterations = function (a, b, c) {
    return box2d.b2Clamp(Math.ceil(Math.sqrt(a / (.01 * b)) * c), 1, 8)
}
    ;
...
goog.exportProperty(box2d.b2ParticleGroupDef.prototype, "groupFlags", box2d.b2ParticleGroupDef.prototype.groupFlags);
box2d.b2ParticleGroupDef.prototype.position = null;
goog.exportProperty(box2d.b2ParticleGroupDef.prototype, "position", box2d.b2ParticleGroupDef.prototype.position);
box2d.b2ParticleGroupDef.prototype.angle = 0;
goog.exportProperty(box2d.b2ParticleGroupDef.prototype, "angle", box2d.b2ParticleGroupDef.prototype.angle);
box2d.b2ParticleGroupDef.prototype.linearVelocity = null;
goog.exportProperty(box2d.b2ParticleGroupDef.prototype, "linearVelocity", box2d.b2ParticleGroupDef.prototype.linearVelocity);
box2d.b2ParticleGroupDef.prototype.angularVelocity = 0;
goog.exportProperty(box2d.b2ParticleGroupDef.prototype, "angularVelocity", box2d.b2ParticleGroupDef.prototype.angularVelocity);
box2d.b2ParticleGroupDef.prototype.color = null;
goog.exportProperty(box2d.b2ParticleGroupDef.prototype, "color", box2d.b2ParticleGroupDef.prototype.color);
box2d.b2ParticleGroupDef.prototype.strength = 1;
goog.exportProperty(box2d.b2ParticleGroupDef.prototype, "strength", box2d.b2ParticleGroupDef.prototype.strength);
box2d.b2ParticleGroupDef.prototype.shape = null;
goog.exportProperty(box2d.b2ParticleGroupDef.prototype, "shape", box2d.b2ParticleGroupDef.prototype.shape);
box2d.b2ParticleGroupDef.prototype.shapes = null;
goog.exportProperty(box2d.b2ParticleGroupDef.prototype, "shapes", box2d.b2ParticleGroupDef.prototype.shapes);
box2d.b2ParticleGroupDef.prototype.shapeCount = 0;
goog.exportProperty(box2d.b2ParticleGroupDef.prototype, "shapeCount", box2d.b2ParticleGroupDef.prototype.shapeCount);
box2d.b2ParticleGroupDef.prototype.stride = 0;
goog.exportProperty(box2d.b2ParticleGroupDef.prototype, "stride", box2d.b2ParticleGroupDef.prototype.stride);
box2d.b2ParticleGroupDef.prototype.particleCount = 0;
goog.exportProperty(box2d.b2ParticleGroupDef.prototype, "particleCount", box2d.b2ParticleGroupDef.prototype.particleCount);
box2d.b2ParticleGroupDef.prototype.positionData = null;
goog.exportProperty(box2d.b2ParticleGroupDef.prototype, "positionData", box2d.b2ParticleGroupDef.prototype.positionData);
box2d.b2ParticleGroupDef.prototype.lifetime = 0;
goog.exportProperty(box2d.b2ParticleGroupDef.prototype, "lifetime", box2d.b2ParticleGroupDef.prototype.lifetime);
box2d.b2ParticleGroupDef.prototype.userData = null;
goog.exportProperty(box2d.b2ParticleGroupDef.prototype, "userData", box2d.b2ParticleGroupDef.prototype.userData);
box2d.b2ParticleGroupDef.prototype.group = null;
goog.exportProperty(box2d.b2ParticleGroupDef.prototype, "group", box2d.b2ParticleGroupDef.prototype.group);
...
box2d.b2ParticleGroup.prototype.SetGroupFlags = function (a) {
    box2d.b2Assert(0 === (a & box2d.b2ParticleGroupFlag.b2_particleGroupInternalMask));
    a |= this.m_groupFlags & box2d.b2ParticleGroupFlag.b2_particleGroupInternalMask;
...
box2d.b2ParticleGroup.prototype.GetLinearVelocityFromWorldPoint = function (a, b) {
    var c = box2d.b2ParticleGroup.prototype.GetLinearVelocityFromWorldPoint.s_t0;
    this.UpdateStatistics();
    return box2d.b2AddCross_V2_S_V2(this.m_linearVelocity, this.m_angularVelocity, box2d.b2Sub_V2_V2(a, this.m_center, c), b)
}
    ;
    ...
    if (this.m_timestamp != this.m_system.m_timestamp) {
        ...
        for (var d = this.m_firstIndex; d < this.m_lastIndex; d++)
            this.m_center.SelfMulAdd(c, this.m_system.m_positionBuffer.data[d]),
                this.m_linearVelocity.SelfMulAdd(c, this.m_system.m_velocityBuffer.data[d]);
        0 < this.m_mass && (d = 1 / this.m_mass,
        ...
        for (d = this.m_firstIndex; d < this.m_lastIndex; d++)
            box2d.b2Sub_V2_V2(this.m_system.m_positionBuffer.data[d], this.m_center, a),
                box2d.b2Sub_V2_V2(this.m_system.m_velocityBuffer.data[d], this.m_linearVelocity, b),
...
box2d.std_lower_bound = function (a, b, c, d, e) {
    "function" !== typeof e && (e = function (a, b) {
        return a < b
    }
    );
    for (c -= b; 0 < c;) {
...
box2d.std_unique = function (a, b, c, d) {
    if (b === c)
        return c;
    for (var e = b; ++b !== c;)
        d(a[e], a[b]) || box2d.std_iter_swap(a, ++e, b);
    return ++e
}
    ;
...
box2d.b2GrowableBuffer.prototype.Reserve = function (a) {
    if (!(this.capacity >= a)) {
        ...
        for (var b = this.capacity; b < a; ++b)
            this.data[b] = this.allocator();
        this.capacity = a
    }
}
    ;
box2d.b2GrowableBuffer.prototype.Grow = function () {
    var a = this.capacity ? 2 * this.capacity : box2d.b2_minParticleSystemBufferCapacity;
    box2d.b2Assert(a > this.capacity);
    this.Reserve(a)
}
    ;
box2d.b2GrowableBuffer.prototype.Free = function () {
    0 !== this.data.length && (this.data = [],
...
box2d.b2GrowableBuffer.prototype.RemoveIf = function (a) {
    for (var b = 0, c = 0; c < this.count; ++c)
        a(this.data[c]) || b++;
...
box2d.b2FixtureParticleQueryCallback.prototype.ShouldQueryParticleSystem = function (a) {
    return !1
}
    ;
box2d.b2FixtureParticleQueryCallback.prototype.ReportFixture = function (a) {
    ...
    for (var b = a.GetShape().GetChildCount(), c = 0; c < b; c++)
        for (var d = a.GetAABB(c), d = this.m_system.GetInsideBoundsEnumerator(d), e; 0 <= (e = d.GetNext());)
...
box2d.b2FixtureParticleQueryCallback.prototype.ReportParticle = function (a, b) {
    return !1
}
    ;
...
box2d.b2FixtureParticleQueryCallback.prototype.ReportFixtureAndParticle = function (a, b, c) {
    box2d.b2Assert(!1)
}
    ;
...
goog.exportProperty(box2d.b2ParticleContact.prototype, "indexB", box2d.b2ParticleContact.prototype.indexB);
box2d.b2ParticleContact.prototype.weight = 0;
goog.exportProperty(box2d.b2ParticleContact.prototype, "weight", box2d.b2ParticleContact.prototype.weight);
box2d.b2ParticleContact.prototype.normal = null;
goog.exportProperty(box2d.b2ParticleContact.prototype, "normal", box2d.b2ParticleContact.prototype.normal);
box2d.b2ParticleContact.prototype.flags = 0;
goog.exportProperty(box2d.b2ParticleContact.prototype, "flags", box2d.b2ParticleContact.prototype.flags);
...
box2d.b2ParticleContact.prototype.ApproximatelyEqual = function (a) {
    return this.indexA === a.indexA && this.indexB === a.indexB && this.flags === a.flags && .01 > box2d.b2Abs(this.weight - a.weight) && 1E-4 > box2d.b2DistanceSquared(this.normal, a.normal)
}
    ;
...
goog.exportProperty(box2d.b2ParticleBodyContact.prototype, "index", box2d.b2ParticleBodyContact.prototype.index);
box2d.b2ParticleBodyContact.prototype.body = null;
goog.exportProperty(box2d.b2ParticleBodyContact.prototype, "body", box2d.b2ParticleBodyContact.prototype.body);
box2d.b2ParticleBodyContact.prototype.fixture = null;
goog.exportProperty(box2d.b2ParticleBodyContact.prototype, "fixture", box2d.b2ParticleBodyContact.prototype.fixture);
box2d.b2ParticleBodyContact.prototype.weight = 0;
goog.exportProperty(box2d.b2ParticleBodyContact.prototype, "weight", box2d.b2ParticleBodyContact.prototype.weight);
box2d.b2ParticleBodyContact.prototype.normal = null;
goog.exportProperty(box2d.b2ParticleBodyContact.prototype, "normal", box2d.b2ParticleBodyContact.prototype.normal);
box2d.b2ParticleBodyContact.prototype.mass = 0;
goog.exportProperty(box2d.b2ParticleBodyContact.prototype, "mass", box2d.b2ParticleBodyContact.prototype.mass);
...
goog.exportProperty(box2d.b2ParticlePair.prototype, "indexA", box2d.b2ParticlePair.prototype.indexA);
box2d.b2ParticlePair.prototype.indexB = 0;
goog.exportProperty(box2d.b2ParticlePair.prototype, "indexB", box2d.b2ParticlePair.prototype.indexB);
box2d.b2ParticlePair.prototype.flags = 0;
goog.exportProperty(box2d.b2ParticlePair.prototype, "flags", box2d.b2ParticlePair.prototype.flags);
box2d.b2ParticlePair.prototype.strength = 0;
goog.exportProperty(box2d.b2ParticlePair.prototype, "strength", box2d.b2ParticlePair.prototype.strength);
box2d.b2ParticlePair.prototype.distance = 0;
goog.exportProperty(box2d.b2ParticlePair.prototype, "distance", box2d.b2ParticlePair.prototype.distance);
...
goog.exportProperty(box2d.b2ParticleTriad.prototype, "indexB", box2d.b2ParticleTriad.prototype.indexB);
box2d.b2ParticleTriad.prototype.indexC = 0;
goog.exportProperty(box2d.b2ParticleTriad.prototype, "indexC", box2d.b2ParticleTriad.prototype.indexC);
box2d.b2ParticleTriad.prototype.flags = 0;
goog.exportProperty(box2d.b2ParticleTriad.prototype, "flags", box2d.b2ParticleTriad.prototype.flags);
box2d.b2ParticleTriad.prototype.strength = 0;
goog.exportProperty(box2d.b2ParticleTriad.prototype, "strength", box2d.b2ParticleTriad.prototype.strength);
box2d.b2ParticleTriad.prototype.pa = null;
goog.exportProperty(box2d.b2ParticleTriad.prototype, "pa", box2d.b2ParticleTriad.prototype.pa);
box2d.b2ParticleTriad.prototype.pb = null;
goog.exportProperty(box2d.b2ParticleTriad.prototype, "pb", box2d.b2ParticleTriad.prototype.pb);
box2d.b2ParticleTriad.prototype.pc = null;
goog.exportProperty(box2d.b2ParticleTriad.prototype, "pc", box2d.b2ParticleTriad.prototype.pc);
box2d.b2ParticleTriad.prototype.ka = 0;
goog.exportProperty(box2d.b2ParticleTriad.prototype, "ka", box2d.b2ParticleTriad.prototype.ka);
box2d.b2ParticleTriad.prototype.kb = 0;
goog.exportProperty(box2d.b2ParticleTriad.prototype, "kb", box2d.b2ParticleTriad.prototype.kb);
box2d.b2ParticleTriad.prototype.kc = 0;
goog.exportProperty(box2d.b2ParticleTriad.prototype, "kc", box2d.b2ParticleTriad.prototype.kc);
box2d.b2ParticleTriad.prototype.s = 0;
goog.exportProperty(box2d.b2ParticleTriad.prototype, "s", box2d.b2ParticleTriad.prototype.s);
...
goog.exportProperty(box2d.b2ParticleSystemDef.prototype, "strictContactCheck", box2d.b2ParticleSystemDef.prototype.strictContactCheck);
box2d.b2ParticleSystemDef.prototype.density = 1;
goog.exportProperty(box2d.b2ParticleSystemDef.prototype, "density", box2d.b2ParticleSystemDef.prototype.density);
box2d.b2ParticleSystemDef.prototype.gravityScale = 1;
goog.exportProperty(box2d.b2ParticleSystemDef.prototype, "gravityScale", box2d.b2ParticleSystemDef.prototype.gravityScale);
box2d.b2ParticleSystemDef.prototype.radius = 1;
goog.exportProperty(box2d.b2ParticleSystemDef.prototype, "radius", box2d.b2ParticleSystemDef.prototype.radius);
box2d.b2ParticleSystemDef.prototype.maxCount = 0;
goog.exportProperty(box2d.b2ParticleSystemDef.prototype, "maxCount", box2d.b2ParticleSystemDef.prototype.maxCount);
box2d.b2ParticleSystemDef.prototype.pressureStrength = .005;
goog.exportProperty(box2d.b2ParticleSystemDef.prototype, "pressureStrength", box2d.b2ParticleSystemDef.prototype.pressureStrength);
box2d.b2ParticleSystemDef.prototype.dampingStrength = 1;
goog.exportProperty(box2d.b2ParticleSystemDef.prototype, "dampingStrength", box2d.b2ParticleSystemDef.prototype.dampingStrength);
box2d.b2ParticleSystemDef.prototype.elasticStrength = .25;
goog.exportProperty(box2d.b2ParticleSystemDef.prototype, "elasticStrength", box2d.b2ParticleSystemDef.prototype.elasticStrength);
box2d.b2ParticleSystemDef.prototype.springStrength = .25;
goog.exportProperty(box2d.b2ParticleSystemDef.prototype, "springStrength", box2d.b2ParticleSystemDef.prototype.springStrength);
box2d.b2ParticleSystemDef.prototype.viscousStrength = .25;
goog.exportProperty(box2d.b2ParticleSystemDef.prototype, "viscousStrength", box2d.b2ParticleSystemDef.prototype.viscousStrength);
box2d.b2ParticleSystemDef.prototype.surfaceTensionPressureStrength = .2;
goog.exportProperty(box2d.b2ParticleSystemDef.prototype, "surfaceTensionPressureStrength", box2d.b2ParticleSystemDef.prototype.surfaceTensionPressureStrength);
box2d.b2ParticleSystemDef.prototype.surfaceTensionNormalStrength = .2;
goog.exportProperty(box2d.b2ParticleSystemDef.prototype, "surfaceTensionNormalStrength", box2d.b2ParticleSystemDef.prototype.surfaceTensionNormalStrength);
box2d.b2ParticleSystemDef.prototype.repulsiveStrength = 1;
goog.exportProperty(box2d.b2ParticleSystemDef.prototype, "repulsiveStrength", box2d.b2ParticleSystemDef.prototype.repulsiveStrength);
box2d.b2ParticleSystemDef.prototype.powderStrength = .5;
goog.exportProperty(box2d.b2ParticleSystemDef.prototype, "powderStrength", box2d.b2ParticleSystemDef.prototype.powderStrength);
box2d.b2ParticleSystemDef.prototype.ejectionStrength = .5;
goog.exportProperty(box2d.b2ParticleSystemDef.prototype, "ejectionStrength", box2d.b2ParticleSystemDef.prototype.ejectionStrength);
box2d.b2ParticleSystemDef.prototype.staticPressureStrength = .2;
goog.exportProperty(box2d.b2ParticleSystemDef.prototype, "staticPressureStrength", box2d.b2ParticleSystemDef.prototype.staticPressureStrength);
box2d.b2ParticleSystemDef.prototype.staticPressureRelaxation = .2;
goog.exportProperty(box2d.b2ParticleSystemDef.prototype, "staticPressureRelaxation", box2d.b2ParticleSystemDef.prototype.staticPressureRelaxation);
box2d.b2ParticleSystemDef.prototype.staticPressureIterations = 8;
goog.exportProperty(box2d.b2ParticleSystemDef.prototype, "staticPressureIterations", box2d.b2ParticleSystemDef.prototype.staticPressureIterations);
box2d.b2ParticleSystemDef.prototype.colorMixingStrength = .5;
goog.exportProperty(box2d.b2ParticleSystemDef.prototype, "colorMixingStrength", box2d.b2ParticleSystemDef.prototype.colorMixingStrength);
box2d.b2ParticleSystemDef.prototype.destroyByAge = !0;
goog.exportProperty(box2d.b2ParticleSystemDef.prototype, "destroyByAge", box2d.b2ParticleSystemDef.prototype.destroyByAge);
box2d.b2ParticleSystemDef.prototype.lifetimeGranularity = 1 / 60;
goog.exportProperty(box2d.b2ParticleSystemDef.prototype, "lifetimeGranularity", box2d.b2ParticleSystemDef.prototype.lifetimeGranularity);
...
box2d.b2ParticleSystem.computeTag = function (a, b) {
    return (b + box2d.b2ParticleSystem.yOffset >>> 0 << box2d.b2ParticleSystem.yShift) + (box2d.b2ParticleSystem.xScale * a + box2d.b2ParticleSystem.xOffset >>> 0) >>> 0
}
    ;
box2d.b2ParticleSystem.computeRelativeTag = function (a, b, c) {
    return a + (c << box2d.b2ParticleSystem.yShift) + (b << box2d.b2ParticleSystem.xShift) >>> 0
}
    ;
...
box2d.b2ParticleSystem.FixtureParticleSet.prototype.Initialize = function (a, b) { }
    ;
...
box2d.b2ParticleSystem.b2ParticlePairSet.prototype.Initialize = function (a, b) { }
    ;
...
box2d.b2ParticleSystem.prototype.CreateParticle = function (a) {
    ...
    this.m_positionBuffer.data[b] = (this.m_positionBuffer.data[b] || new box2d.b2Vec2).Copy(a.position);
    this.m_velocityBuffer.data[b] = (this.m_velocityBuffer.data[b] || new box2d.b2Vec2).Copy(a.velocity);
    this.m_weightBuffer[b] = 0;
    this.m_forceBuffer[b] = (this.m_forceBuffer[b] || new box2d.b2Vec2).SetZero();
    ...
    if (this.m_colorBuffer.data || !a.color.IsZero())
        this.m_colorBuffer.data = this.RequestBuffer(this.m_colorBuffer.data),
            this.m_colorBuffer.data[b] = (this.m_colorBuffer.data[b] || new box2d.b2ParticleColor).Copy(a.color);
    ...
    if (this.m_expirationTimeBuffer.data || d)
        this.SetParticleLifetime(b, d ? a.lifetime : this.ExpirationTimeToLifetime(-this.GetQuantizedTimeElapsed())),
            this.m_indexByExpirationTimeBuffer.data[b] = b;
    c.index = b;
    c = a.group;
    if (this.m_groupBuffer[b] = c)
        c.m_firstIndex < c.m_lastIndex ? (this.RotateBuffer(c.m_firstIndex, c.m_lastIndex, b),
            box2d.b2Assert(c.m_lastIndex === b)) : c.m_firstIndex = b,
            c.m_lastIndex = b + 1;
...
box2d.b2ParticleSystem.prototype.GetParticleHandleFromIndex = function (a) {
    box2d.b2Assert(0 <= a && a < this.GetParticleCount() && a !== box2d.b2_invalidParticleIndex);
...
box2d.b2ParticleSystem.DestroyParticlesInShapeCallback.prototype.ReportFixture = function (a) {
    return !1
}
    ;
box2d.b2ParticleSystem.DestroyParticlesInShapeCallback.prototype.ReportParticle = function (a, b) {
    if (a !== this.m_system)
        return !1;
    box2d.b2Assert(0 <= b && b < this.m_system.m_count);
    this.m_shape.TestPoint(this.m_xf, this.m_system.m_positionBuffer.data[b]) && (this.m_system.DestroyParticle(b, this.m_callDestructionListener),
        this.m_destroyed++);
    return !0
}
    ;
...
box2d.b2ParticleSystem.prototype.CreateParticleGroup = function (a) {
    ...
    a.shapes && this.CreateParticlesWithShapesForGroup(a.shapes, a.shapeCount, a, b);
    if (a.particleCount) {
    ...
    f.m_prev = null;
    if (f.m_next = this.m_groupList)
        this.m_groupList.m_prev = f;
    this.m_groupList = f;
    ++this.m_groupCount;
    for (d = c; d < e; d++)
        this.m_groupBuffer[d] = f;
    ...
    a.group && (this.JoinParticleGroups(a.group, f),
        f = a.group);
    return f
}
    ;
...
box2d.b2ParticleSystem.prototype.JoinParticleGroups = function (a, b) {
    ...
    if (!this.m_world.IsLocked()) {
        ...
        for (c = b.m_firstIndex; c < b.m_lastIndex; c++)
            this.m_groupBuffer[c] = a;
...
box2d.b2ParticleSystem.prototype.SetParticleFlags = function (a, b) {
    ...
    ~this.m_allParticleFlags & b && (b & box2d.b2ParticleFlag.b2_tensileParticle && (this.m_accumulation2Buffer = this.RequestBuffer(this.m_accumulation2Buffer)),
        b & box2d.b2ParticleFlag.b2_colorMixingParticle && (this.m_colorBuffer.data = this.RequestBuffer(this.m_colorBuffer.data)),
...
box2d.b2ParticleSystem.prototype.SetStuckThreshold = function (a) {
    ...
    0 < a && (this.m_lastBodyContactStepBuffer.data = this.RequestBuffer(this.m_lastBodyContactStepBuffer.data),
...
box2d.b2ParticleSystem.prototype.ComputeCollisionEnergy = function () {
    for (var a = box2d.b2ParticleSystem.prototype.ComputeCollisionEnergy.s_v, b = this.m_velocityBuffer.data, c = 0, d = 0; d < this.m_contactBuffer.count; d++) {
    ...
    return .5 * this.GetParticleMass() * c
}
    ;
...
box2d.b2ParticleSystem.prototype.SetParticleLifetime = function (a, b) {
    ...
    c !== this.m_expirationTimeBuffer.data[a] && (this.m_expirationTimeBuffer.data[a] = c,
...
box2d.b2ParticleSystem.prototype.ApplyLinearImpulse = function (a, b, c) {
    ...
    for (c = c.Clone().SelfMul(1 / e); a < b; a++)
        d[a].SelfAdd(c)
}
    ;
...
box2d.b2ParticleSystem.prototype.ParticleApplyForce = function (a, b) {
    box2d.b2ParticleSystem.IsSignificantForce(b) && this.ForceCanBeApplied(this.m_flagsBuffer.data[a]) && (this.PrepareForceBuffer(),
        this.m_forceBuffer[a].SelfAdd(b))
}
    ;
...
box2d.b2ParticleSystem.prototype.QueryAABB = function (a, b) {
    if (0 !== this.m_proxyBuffer.count)
        for (var c = this.m_proxyBuffer.count, d = box2d.std_lower_bound(this.m_proxyBuffer.data, 0, c, box2d.b2ParticleSystem.computeTag(this.m_inverseDiameter * b.lowerBound.x, this.m_inverseDiameter * b.lowerBound.y), box2d.b2ParticleSystem.Proxy.CompareProxyTag), c = box2d.std_upper_bound(this.m_proxyBuffer.data, d, c, box2d.b2ParticleSystem.computeTag(this.m_inverseDiameter * b.upperBound.x, this.m_inverseDiameter * b.upperBound.y), box2d.b2ParticleSystem.Proxy.CompareTagProxy), e = this.m_positionBuffer.data; d < c; ++d) {
            var f = this.m_proxyBuffer.data[d].index
                , g = e[f];
            if (b.lowerBound.x < g.x && g.x < b.upperBound.x && b.lowerBound.y < g.y && g.y < b.upperBound.y && !a.ReportParticle(this, f))
                break
        }
}
    ;
...
box2d.b2ParticleSystem.prototype.RayCast = function (a, b, c) {
    ...
    if (0 !== this.m_proxyBuffer.count) {
        ...
        for (var f = box2d.b2Dot_V2_V2(c, c), d = this.GetInsideBoundsEnumerator(d), m; 0 <= (m = d.GetNext());) {
            ...
            if (0 <= q) {
                ...
                if (!(q > l)) {
                    ...
                    n.Normalize();
                    m = a.ReportParticle(this, m, box2d.b2AddMul_V2_S_V2(b, q, c, h), n, q);
                    l = box2d.b2Min(l, m);
                    if (0 >= l)
                        break
                }
...
box2d.b2ParticleSystem.InsideBoundsEnumerator.prototype.GetNext = function () {
    for (; this.m_first < this.m_last;) {
        var a = (this.m_system.m_proxyBuffer.data[this.m_first].tag & box2d.b2ParticleSystem.xMask) >>> 0
            , b = (this.m_system.m_proxyBuffer.data[this.m_first].tag & box2d.b2ParticleSystem.yMask) >>> 0;
...
box2d.b2ParticleSystem.prototype.RequestBuffer = function (a) {
    a || (0 === this.m_internalAllocatedCapacity && this.ReallocateInternalAllocatedBuffers(box2d.b2_minParticleSystemBufferCapacity),
        a = [],
...
box2d.b2ParticleSystem.prototype.ReallocateHandleBuffers = function (a) {
    ...
    ;
box2d.b2ParticleSystem.prototype.ReallocateInternalAllocatedBuffers = function (a) {
    function b(a, b) {
        return b && a > b ? b : a
    }
    ...
    if (this.m_internalAllocatedCapacity < a) {
        ...
        this.m_bodyContactCountBuffer.data = this.ReallocateBuffer4(this.m_bodyContactCountBuffer, this.m_internalAllocatedCapacity, a, c);
        ...
        this.m_forceBuffer = this.ReallocateBuffer5(this.m_forceBuffer, 0, this.m_internalAllocatedCapacity, a, !1);
        ...
        this.m_depthBuffer = this.ReallocateBuffer5(this.m_depthBuffer, 0, this.m_internalAllocatedCapacity, a, !0);
        ...
        this.m_expirationTimeBuffer.data = this.ReallocateBuffer4(this.m_expirationTimeBuffer, this.m_internalAllocatedCapacity, a, !0);
...
box2d.b2ParticleSystem.prototype.CreateParticleForGroup = function (a, b, c) {
    ...
    box2d.b2Add_V2_V2(a.linearVelocity, box2d.b2Cross_S_V2(a.angularVelocity, box2d.b2Sub_V2_V2(d.position, a.position, box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0), d.velocity);
...
box2d.b2ParticleSystem.prototype.CreateParticlesStrokeShapeForGroup = function (a, b, c) {
    var d = box2d.b2ParticleSystem.prototype.CreateParticlesStrokeShapeForGroup.s_edge
    ...
    for (var h = 0, k = a.GetChildCount(), l = 0; l < k; l++) {
        var m = null;
        a.GetType() === box2d.b2ShapeType.e_edgeShape ? m = a : (box2d.b2Assert(a.GetType() === box2d.b2ShapeType.e_chainShape),
            m = d,
            a.GetChildEdge(m, l));
        for (var n = box2d.b2Sub_V2_V2(m.m_vertex2, m.m_vertex1, e), p = n.Length(); h < p;) {
...
box2d.b2ParticleSystem.prototype.CreateParticlesFillShapeForGroup = function (a, b, c) {
    var d = box2d.b2ParticleSystem.prototype.CreateParticlesFillShapeForGroup.s_aabb
    ...
    for (var h = Math.floor(d.lowerBound.y / f) * f; h < d.upperBound.y; h += f)
        for (var k = Math.floor(d.lowerBound.x / f) * f; k < d.upperBound.x; k += f) {
            var l = e.Set(k, h);
...
box2d.b2ParticleSystem.prototype.CreateParticlesWithShapeForGroup = function (a, b, c) {
    switch (a.GetType()) {
        case box2d.b2ShapeType.e_edgeShape:
        case box2d.b2ShapeType.e_chainShape:
...
box2d.b2ParticleSystem.CompositeShape.prototype.TestPoint = function (a, b) {
    for (var c = 0; c < this.m_shapeCount; c++)
        if (this.m_shapes[c].TestPoint(a, b))
            return !0;
    return !1
}
    ;
...
box2d.b2ParticleSystem.CompositeShape.prototype.ComputeDistance = function (a, b, c, d) {
    box2d.b2Assert(!1);
    return 0
}
    ;
...
box2d.b2ParticleSystem.CompositeShape.prototype.RayCast = function (a, b, c, d) {
    box2d.b2Assert(!1);
    return !1
}
    ;
...
box2d.b2ParticleSystem.CompositeShape.prototype.ComputeAABB = function (a, b, c) {
...
box2d.b2ParticleSystem.prototype.CreateParticlesWithShapesForGroup = function (a, b, c, d) {
...
box2d.b2ParticleSystem.prototype.CloneParticle = function (a, b) {
    ...
    this.m_lastBodyContactStepBuffer.data && (this.m_lastBodyContactStepBuffer.data[c] = this.m_lastBodyContactStepBuffer.data[a]);
    this.m_bodyContactCountBuffer.data && (this.m_bodyContactCountBuffer.data[c] = this.m_bodyContactCountBuffer.data[a]);
    this.m_consecutiveContactStepsBuffer.data && (this.m_consecutiveContactStepsBuffer.data[c] = this.m_consecutiveContactStepsBuffer.data[a]);
    this.m_hasForce && this.m_forceBuffer[c].Copy(this.m_forceBuffer[a]);
    this.m_staticPressureBuffer && (this.m_staticPressureBuffer[c] = this.m_staticPressureBuffer[a]);
    this.m_depthBuffer && (this.m_depthBuffer[c] = this.m_depthBuffer[a]);
    this.m_expirationTimeBuffer.data && (this.m_expirationTimeBuffer.data[c] = this.m_expirationTimeBuffer.data[a]);
    return c
}
    ;
...
box2d.b2ParticleSystem.ParticleCanBeConnected = function (a, b) {
    return 0 !== (a & (box2d.b2ParticleFlag.b2_wallParticle | box2d.b2ParticleFlag.b2_springParticle | box2d.b2ParticleFlag.b2_elasticParticle)) || null !== b && 0 !== (b.GetGroupFlags() & box2d.b2ParticleGroupFlag.b2_rigidParticleGroup)
}
    ;
box2d.b2ParticleSystem.prototype.UpdatePairsAndTriads = function (a, b, c) {
    ...
    box2d.b2Assert(a <= b);
    for (var h = 0, k = a; k < b; k++)
        h |= this.m_flagsBuffer.data[k];
    if (h & box2d.b2ParticleSystem.k_pairFlags)
        for (k = 0; k < this.m_contactBuffer.count; k++) {
            ...
            m >= a && m < b && n >= a && n < b && !((p | q) & box2d.b2ParticleFlag.b2_zombieParticle) && (p | q) & box2d.b2ParticleSystem.k_pairFlags && (c.IsNecessary(m) || c.IsNecessary(n)) && box2d.b2ParticleSystem.ParticleCanBeConnected(p, r) && box2d.b2ParticleSystem.ParticleCanBeConnected(q, u) && c.ShouldCreatePair(m, n) && (p = this.m_pairBuffer.data[this.m_pairBuffer.Append()],
                p.indexA = m,
                p.indexB = n,
                p.flags = l.flags,
    ...
    if (h & box2d.b2ParticleSystem.k_triadFlags) {
        ...
        for (k = a; k < b; k++)
            m = this.m_flagsBuffer.data[k],
                ...
                m & box2d.b2ParticleFlag.b2_zombieParticle || !box2d.b2ParticleSystem.ParticleCanBeConnected(m, n) || (c.IsNecessary(k) && ++l,
                    h.AddGenerator(g[k], k, c.IsNecessary(k)));
        if (0 === l)
            for (k = a; k < b; k++)
                c.IsNecessary(k);
        ...
        h.GetNodes(function (a, b, h) {
            ...
            if ((k | l | m) & box2d.b2ParticleSystem.k_triadFlags && c.ShouldCreateTriad(a, b, h)) {
                var n = g[a]
                    , p = g[b]
                    , q = g[h]
                ...
                if (!(box2d.b2Dot_V2_V2(r, r) > A || box2d.b2Dot_V2_V2(u, u) > A || box2d.b2Dot_V2_V2(C, C) > A)) {
                    ...
                    A.indexC = h;
                    A.flags = k | l | m;
                    A.strength = box2d.b2Min(box2d.b2Min(K ? K.m_strength : 1, J ? J.m_strength : 1), D ? D.m_strength : 1);
                    a = (n.x + p.x + q.x) / 3;
                    b = (n.y + p.y + q.y) / 3;
                    A.pa.x = n.x - a;
                    A.pa.y = n.y - b;
                    ...
                    A.s = box2d.b2Cross_V2_V2(n, p) + box2d.b2Cross_V2_V2(p, q) + box2d.b2Cross_V2_V2(q, n)
                }
            }
        });
...
box2d.b2ParticleSystem.ReactiveFilter.prototype.IsNecessary = function (a) {
    return 0 !== (this.m_flagsBuffer[a] & box2d.b2ParticleFlag.b2_reactiveParticle)
}
    ;
...
box2d.b2ParticleSystem.InitializeParticleLists = function (a, b) {
    for (var c = a.GetBufferIndex(), d = a.GetParticleCount(), e = 0; e < d; e++) {
        var f = b[e];
        f.list = f;
        f.next = null;
        f.count = 1;
...
box2d.b2ParticleSystem.prototype.MergeParticleListsInContact = function (a, b) {
    for (var c = a.GetBufferIndex(), d = 0; d < this.m_contactBuffer.count; d++) {
        var e = this.m_contactBuffer.data[d]
            , f = e.indexA
            , e = e.indexB;
        if (a.ContainsParticle(f) && a.ContainsParticle(e) && (f = b[f - c].list,
            e = b[e - c].list,
            f !== e)) {
            if (f.count < e.count)
                var g = f
...
box2d.b2ParticleSystem.FindLongestParticleList = function (a, b) {
    ...
    ;
box2d.b2ParticleSystem.prototype.MergeZombieParticleListNodes = function (a, b, c) {
    a = a.GetParticleCount();
    for (var d = 0; d < a; d++) {
        var e = b[d];
        e !== c && this.m_flagsBuffer.data[e.index] & box2d.b2ParticleFlag.b2_zombieParticle && box2d.b2ParticleSystem.MergeParticleListAndNode(c, e)
    }
}
    ;
box2d.b2ParticleSystem.MergeParticleListAndNode = function (a, b) {
    ...
    ;
box2d.b2ParticleSystem.prototype.CreateParticleGroupsFromParticleList = function (a, b, c) {
    ...
    for (a = 0; a < d; a++) {
        ...
        if (f.count && f !== c) {
            ...
            for (var g = this.CreateParticleGroup(e); f; f = f.next) {
                var h = f.index;
                box2d.b2Assert(!(this.m_flagsBuffer.data[h] & box2d.b2ParticleFlag.b2_zombieParticle));
    ...
    ;
box2d.b2ParticleSystem.prototype.UpdatePairsAndTriadsWithParticleList = function (a, b) {
...
box2d.b2ParticleSystem.prototype.ComputeDepth = function () {
    for (var a = [], b = 0, c = 0; c < this.m_contactBuffer.count; c++) {
        ...
        g && g === h && g.m_groupFlags & box2d.b2ParticleGroupFlag.b2_particleGroupNeedsUpdateDepth && (a[b++] = d)
    }
    g = [];
    h = 0;
    for (c = this.m_groupList; c; c = c.GetNext())
        if (c.m_groupFlags & box2d.b2ParticleGroupFlag.b2_particleGroupNeedsUpdateDepth)
            for (g[h++] = c,
                this.SetGroupFlags(c, c.m_groupFlags & ~box2d.b2ParticleGroupFlag.b2_particleGroupNeedsUpdateDepth),
                f = c.m_firstIndex; f < c.m_lastIndex; f++)
    ...
    for (f = 0; f < h; f++)
        for (c = g[f],
            ...
            k = this.m_accumulationBuffer[f],
                this.m_depthBuffer[f] = .8 > k ? 0 : box2d.b2_maxFloat;
    for (var k = box2d.b2Sqrt(this.m_count) >> 0, l = 0; l < k; l++) {
        for (var m = !1, c = 0; c < b; c++) {
            var d = a[c]
                ...
                , q = p + n
                , n = d + n;
            d > q && (this.m_depthBuffer[e] = q,
                m = !0);
            p > n && (this.m_depthBuffer[f] = n,
                m = !0)
        }
        if (!m)
            break
    ...
    for (f = 0; f < h; f++)
        for (c = g[f],
            f = c.m_firstIndex; f < c.m_lastIndex; f++)
            this.m_depthBuffer[f] = this.m_depthBuffer[f] < box2d.b2_maxFloat ? this.m_depthBuffer[f] * this.m_particleDiameter : 0
}
    ;
box2d.b2ParticleSystem.prototype.GetInsideBoundsEnumerator = function (a) {
    var b = box2d.b2ParticleSystem.computeTag(this.m_inverseDiameter * a.lowerBound.x - 1, this.m_inverseDiameter * a.lowerBound.y - 1);
    a = box2d.b2ParticleSystem.computeTag(this.m_inverseDiameter * a.upperBound.x + 1, this.m_inverseDiameter * a.upperBound.y + 1);
    var c = this.m_proxyBuffer.count
        , d = box2d.std_lower_bound(this.m_proxyBuffer.data, 0, c, b, box2d.b2ParticleSystem.Proxy.CompareProxyTag)
        , e = box2d.std_upper_bound(this.m_proxyBuffer.data, 0, c, a, box2d.b2ParticleSystem.Proxy.CompareTagProxy);
    box2d.b2Assert(0 <= d);
    box2d.b2Assert(d <= e);
    box2d.b2Assert(e <= c);
...
box2d.b2ParticleSystem.prototype.FindContacts_Reference = function (a) {
    ...
    for (var b = this.m_contactBuffer.count = 0, c = 0; b < a; b++) {
        for (var d = box2d.b2ParticleSystem.computeRelativeTag(this.m_proxyBuffer.data[b].tag, 1, 0), e = b + 1; e < a && !(d < this.m_proxyBuffer.data[e].tag); e++)
            this.AddContact(this.m_proxyBuffer.data[b].index, this.m_proxyBuffer.data[e].index, this.m_contactBuffer);
        for (e = box2d.b2ParticleSystem.computeRelativeTag(this.m_proxyBuffer.data[b].tag, -1, 1); c < a && !(e <= this.m_proxyBuffer.data[c].tag); c++)
            ;
        d = box2d.b2ParticleSystem.computeRelativeTag(this.m_proxyBuffer.data[b].tag, 1, 1);
...
box2d.b2ParticleSystem.prototype.UpdateProxies_Reference = function (a) {
    ...
    for (var b = this.m_inverseDiameter, c = 0; c < this.m_proxyBuffer.count; ++c) {
...
box2d.b2ParticleSystem.prototype.FilterContacts = function (a) {
    ...
    if (null !== b) {
        ...
        this.m_contactBuffer.RemoveIf(function (a) {
            return a.flags & box2d.b2ParticleFlag.b2_particleContactFilterParticle && !b.ShouldCollideParticleParticle(c, a.indexA, a.indexB)
        })
    }
}
    ;
box2d.b2ParticleSystem.prototype.NotifyContactListenerPreContact = function (a) {
    if (null !== this.GetParticleContactListener())
        throw a.Initialize(this.m_contactBuffer, this.m_flagsBuffer),
        Error();
}
    ;
box2d.b2ParticleSystem.prototype.NotifyContactListenerPostContact = function (a) {
...
box2d.b2ParticleSystem.b2ParticleContactIsZombie = function (a) {
    return (a.flags & box2d.b2ParticleFlag.b2_zombieParticle) === box2d.b2ParticleFlag.b2_zombieParticle
}
    ;
box2d.b2ParticleSystem.prototype.UpdateContacts = function (a) {
    ...
    a && this.m_contactBuffer.RemoveIf(box2d.b2ParticleSystem.b2ParticleContactIsZombie)
}
    ;
box2d.b2ParticleSystem.prototype.NotifyBodyContactListenerPreContact = function (a) {
    if (null !== this.GetFixtureContactListener())
        throw a.Initialize(this.m_bodyContactBuffer, this.m_flagsBuffer),
        Error();
}
    ;
box2d.b2ParticleSystem.prototype.NotifyBodyContactListenerPostContact = function (a) {
...
box2d.b2ParticleSystem.UpdateBodyContactsCallback.prototype.ShouldCollideFixtureParticle = function (a, b, c) {
    return this.m_contactFilter && this.m_system.GetFlagsBuffer()[c] & box2d.b2ParticleFlag.b2_fixtureContactFilterParticle ? this.m_contactFilter.ShouldCollideFixtureParticle(a, this.m_system, c) : !0
}
    ;
...
box2d.b2ParticleSystem.UpdateBodyContactsCallback.prototype.ReportFixtureAndParticle = function (a, b, c) {
    var d = box2d.b2ParticleSystem.UpdateBodyContactsCallback.prototype.ReportFixtureAndParticle.s_rp
        , e = this.m_system.m_positionBuffer.data[c]
        , f = box2d.b2ParticleSystem.UpdateBodyContactsCallback.prototype.ReportFixtureAndParticle.s_n;
    b = a.ComputeDistance(e, f, b);
    if (b < this.m_system.m_particleDiameter && this.ShouldCollideFixtureParticle(a, this.m_system, c)) {
        var g = a.GetBody()
            , h = g.GetWorldCenter()
            , k = g.GetMass()
            ...
            , k = 0 < k ? 1 / k : 0
            , l = 0 < l ? 1 / l : 0
            , m = this.m_system.m_flagsBuffer.data[c] & box2d.b2ParticleFlag.b2_wallParticle ? 0 : this.m_system.GetParticleInvMass()
            , d = box2d.b2Sub_V2_V2(e, h, d)
            , d = box2d.b2Cross_V2_V2(d, f)
            , d = m + k + l * d * d
            , e = this.m_system.m_bodyContactBuffer.data[this.m_system.m_bodyContactBuffer.Append()];
        e.index = c;
        e.body = g;
        e.fixture = a;
    ...
    if (0 < this.m_stuckThreshold)
        for (var c = this.GetParticleCount(), d = 0; d < c; d++)
            this.m_bodyContactCountBuffer.data[d] = 0,
                this.m_timestamp > this.m_lastBodyContactStepBuffer.data[d] + 1 && (this.m_consecutiveContactStepsBuffer.data[d] = 0);
    this.m_bodyContactBuffer.SetCount(0);
    this.m_stuckParticleBuffer.SetCount(0);
    this.ComputeAABB(a);
    c = new box2d.b2ParticleSystem.UpdateBodyContactsCallback(this, this.GetFixtureContactFilter());
...
box2d.b2ParticleSystem.prototype.Solve = function (a) {
    ...
    if (0 !== this.m_count && (this.m_expirationTimeBuffer.data && this.SolveLifetimes(a),
        ...
        !this.m_paused))
        for (this.m_iterationIndex = 0; this.m_iterationIndex < a.particleIterations; this.m_iterationIndex++) {
            ++this.m_timestamp;
            var c = b.Copy(a);
            ...
            this.ComputeWeight();
            this.m_allGroupFlags & box2d.b2ParticleGroupFlag.b2_particleGroupNeedsUpdateDepth && this.ComputeDepth();
            ...
            this.m_allParticleFlags & box2d.b2ParticleFlag.b2_viscousParticle && this.SolveViscous();
            this.m_allParticleFlags & box2d.b2ParticleFlag.b2_repulsiveParticle && this.SolveRepulsive(c);
            this.m_allParticleFlags & box2d.b2ParticleFlag.b2_powderParticle && this.SolvePowder(c);
            this.m_allParticleFlags & box2d.b2ParticleFlag.b2_tensileParticle && this.SolveTensile(c);
            this.m_allGroupFlags & box2d.b2ParticleGroupFlag.b2_solidParticleGroup && this.SolveSolid(c);
            this.m_allParticleFlags & box2d.b2ParticleFlag.b2_colorMixingParticle && this.SolveColorMixing();
            this.SolveGravity(c);
            this.m_allParticleFlags & box2d.b2ParticleFlag.b2_staticPressureParticle && this.SolveStaticPressure(c);
            this.SolvePressure(c);
            this.SolveDamping(c);
            this.m_allParticleFlags & box2d.b2ParticleSystem.k_extraDampingFlags && this.SolveExtraDamping();
            this.m_allParticleFlags & box2d.b2ParticleFlag.b2_elasticParticle && this.SolveElastic(c);
            this.m_allParticleFlags & box2d.b2ParticleFlag.b2_springParticle && this.SolveSpring(c);
            this.LimitVelocity(c);
            this.m_allGroupFlags & box2d.b2ParticleGroupFlag.b2_rigidParticleGroup && this.SolveRigidDamping();
            this.m_allParticleFlags & box2d.b2ParticleFlag.b2_barrierParticle && this.SolveBarrier(c);
            this.SolveCollision(c);
            this.m_allGroupFlags & box2d.b2ParticleGroupFlag.b2_rigidParticleGroup && this.SolveRigid(c);
            this.m_allParticleFlags & box2d.b2ParticleFlag.b2_wallParticle && this.SolveWall();
            for (var d = 0; d < this.m_count; d++)
                this.m_positionBuffer.data[d].SelfMulAdd(c.dt, this.m_velocityBuffer.data[d])
        }
}
    ;
...
box2d.b2ParticleSystem.SolveCollisionCallback.prototype.ReportFixtureAndParticle = function (a, b, c) {
    var d = box2d.b2ParticleSystem.SolveCollisionCallback.prototype.ReportFixtureAndParticle.s_p1
        , e = box2d.b2ParticleSystem.SolveCollisionCallback.prototype.ReportFixtureAndParticle.s_output
        , f = box2d.b2ParticleSystem.SolveCollisionCallback.prototype.ReportFixtureAndParticle.s_input
        , g = box2d.b2ParticleSystem.SolveCollisionCallback.prototype.ReportFixtureAndParticle.s_p
        , h = box2d.b2ParticleSystem.SolveCollisionCallback.prototype.ReportFixtureAndParticle.s_v
        , k = box2d.b2ParticleSystem.SolveCollisionCallback.prototype.ReportFixtureAndParticle.s_f
        , l = a.GetBody()
        , m = this.m_system.m_positionBuffer.data[c]
        , n = this.m_system.m_velocityBuffer.data[c];
    0 === this.m_system.m_iterationIndex ? (d = box2d.b2MulT_X_V2(l.m_xf0, m, d),
        a.GetShape().GetType() === box2d.b2ShapeType.e_circleShape && (d.SelfSub(l.GetLocalCenter()),
            box2d.b2Mul_R_V2(l.m_xf0.q, d, d),
            box2d.b2MulT_R_V2(l.m_xf.q, d, d),
            d.SelfAdd(l.GetLocalCenter())),
        box2d.b2Mul_X_V2(l.m_xf, d, f.p1)) : f.p1.Copy(m);
    box2d.b2AddMul_V2_S_V2(m, this.m_step.dt, n, f.p2);
    f.maxFraction = 1;
    a.RayCast(e, f, b) && (a = e.normal,
        g.x = (1 - e.fraction) * f.p1.x + e.fraction * f.p2.x + box2d.b2_linearSlop * a.x,
        g.y = (1 - e.fraction) * f.p1.y + e.fraction * f.p2.y + box2d.b2_linearSlop * a.y,
...
box2d.b2ParticleSystem.SolveCollisionCallback.prototype.ReportParticle = function (a, b) {
    return !1
}
    ;
...
box2d.b2ParticleSystem.prototype.SolveGravity = function (a) {
    var b = box2d.b2ParticleSystem.prototype.SolveGravity.s_gravity
        , c = this.m_velocityBuffer.data;
    a = box2d.b2Mul_S_V2(a.dt * this.m_def.gravityScale, this.m_world.GetGravity(), b);
    for (b = 0; b < this.m_count; b++)
        c[b].SelfAdd(a)
}
    ;
...
box2d.b2ParticleSystem.prototype.SolveBarrier = function (a) {
    for (var b = box2d.b2ParticleSystem.prototype.SolveBarrier.s_aabb, c = box2d.b2ParticleSystem.prototype.SolveBarrier.s_va, d = box2d.b2ParticleSystem.prototype.SolveBarrier.s_vb, e = box2d.b2ParticleSystem.prototype.SolveBarrier.s_pba, f = box2d.b2ParticleSystem.prototype.SolveBarrier.s_vba, g = box2d.b2ParticleSystem.prototype.SolveBarrier.s_vc, h = box2d.b2ParticleSystem.prototype.SolveBarrier.s_pca, k = box2d.b2ParticleSystem.prototype.SolveBarrier.s_vca, l = box2d.b2ParticleSystem.prototype.SolveBarrier.s_qba, m = box2d.b2ParticleSystem.prototype.SolveBarrier.s_qca, n = box2d.b2ParticleSystem.prototype.SolveBarrier.s_dv, p = box2d.b2ParticleSystem.prototype.SolveBarrier.s_f, q = this.m_positionBuffer.data, r = this.m_velocityBuffer.data, u = 0; u < this.m_count; u++)
        0 !== (this.m_flagsBuffer.data[u] & box2d.b2ParticleSystem.k_barrierWallFlags) && r[u].SetZero();
    for (var u = box2d.b2_barrierCollisionTime * a.dt, t = this.GetParticleMass(), w = 0; w < this.m_pairBuffer.count; w++) {
        ...
        if (x.flags & box2d.b2ParticleFlag.b2_barrierParticle) {
            ...
            for (var E = this.m_groupBuffer[v], F = this.m_groupBuffer[y], v = this.GetLinearVelocity(E, v, x, c), y = this.GetLinearVelocity(F, y, z, d), z = box2d.b2Sub_V2_V2(z, x, e), y = box2d.b2Sub_V2_V2(y, v, f), B = this.GetInsideBoundsEnumerator(B), G; 0 <= (G = B.GetNext());) {
                var H = q[G]
                ...
                if (E !== I && F !== I) {
                    ...
                    this.IsRigidGroup(I) ? (t = I.GetMass(),
                        A = I.GetInertia(),
                        0 < t && I.m_linearVelocity.SelfMulAdd(1 / t, C),
                        0 < A && (I.m_angularVelocity += box2d.b2Cross_V2_V2(box2d.b2Sub_V2_V2(H, I.GetCenter(), box2d.b2Vec2.s_t0), C) / A)) : r[G].SelfAdd(A);
...
box2d.b2ParticleSystem.prototype.SolveStaticPressure = function (a) {
    ...
    for (var b = box2d.b2_maxParticlePressure * b, c = this.m_def.staticPressureRelaxation, d = 0; d < this.m_def.staticPressureIterations; d++) {
        for (var e = 0; e < this.m_count; e++)
            this.m_accumulationBuffer[e] = 0;
        ...
        for (e = 0; e < this.m_count; e++)
            f = this.m_weightBuffer[e],
                this.m_staticPressureBuffer[e] = this.m_flagsBuffer.data[e] & box2d.b2ParticleFlag.b2_staticPressureParticle ? box2d.b2Clamp((this.m_accumulationBuffer[e] + a * (f - box2d.b2_minParticleWeight)) / (f + c), 0, b) : 0
    }
}
    ;
box2d.b2ParticleSystem.prototype.ComputeWeight = function () {
    for (var a = 0; a < this.m_count; a++)
        this.m_weightBuffer[a] = 0;
...
box2d.b2ParticleSystem.prototype.SolvePressure = function (a) {
    for (var b = box2d.b2ParticleSystem.prototype.SolvePressure.s_f, c = this.m_positionBuffer.data, d = this.m_velocityBuffer.data, e = this.GetCriticalPressure(a), f = this.m_def.pressureStrength * e, g = box2d.b2_maxParticlePressure * e, h = 0; h < this.m_count; h++) {
    ...
    if (this.m_allParticleFlags & box2d.b2ParticleSystem.k_noPressureFlags)
        for (h = 0; h < this.m_count; h++)
            this.m_flagsBuffer.data[h] & box2d.b2ParticleSystem.k_noPressureFlags && (this.m_accumulationBuffer[h] = 0);
    if (this.m_allParticleFlags & box2d.b2ParticleFlag.b2_staticPressureParticle)
        for (box2d.b2Assert(null !== this.m_staticPressureBuffer),
            h = 0; h < this.m_count; h++)
            this.m_flagsBuffer.data[h] & box2d.b2ParticleFlag.b2_staticPressureParticle && (this.m_accumulationBuffer[h] += this.m_staticPressureBuffer[h]);
...
box2d.b2ParticleSystem.prototype.SolveDamping = function (a) {
    ...
    for (var g = this.GetParticleInvMass(), h = 0; h < this.m_bodyContactBuffer.count; h++) {
        var k = this.m_bodyContactBuffer.data[h]
            , l = k.index
            , m = k.body
            , n = k.weight
            ...
            , q = k.normal
            , k = d[l]
            , r = box2d.b2Sub_V2_V2(m.GetLinearVelocityFromWorldPoint(k, box2d.b2Vec2.s_t0), e[l], b)
            , r = box2d.b2Dot_V2_V2(r, q);
        0 > r && (n = box2d.b2Max(f * n, box2d.b2Min(-a * r, .5)),
...
box2d.b2ParticleSystem.prototype.SolveRigidDamping = function () {
    for (var a = box2d.b2ParticleSystem.prototype.SolveRigidDamping.s_t0, b = box2d.b2ParticleSystem.prototype.SolveRigidDamping.s_t1, c = box2d.b2ParticleSystem.prototype.SolveRigidDamping.s_p, d = box2d.b2ParticleSystem.prototype.SolveRigidDamping.s_v, e = [0], f = [0], g = [0], h = [0], k = [0], l = [0], m = this.m_positionBuffer.data, n = this.m_def.dampingStrength, p = 0; p < this.m_bodyContactBuffer.count; p++) {
        ...
        if (this.IsRigidGroup(u)) {
            var t = q.body
                ...
                , x = q.weight
                , q = m[r]
                , v = box2d.b2Sub_V2_V2(t.GetLinearVelocityFromWorldPoint(q, a), u.GetLinearVelocityFromWorldPoint(q, b), d)
                , v = box2d.b2Dot_V2_V2(v, w);
            0 > v && (this.InitDampingParameterWithRigidGroupOrParticle(e, f, g, !0, u, r, q, w),
                this.InitDampingParameter(h, k, l, t.GetMass(), t.GetInertia() - t.GetMass() * t.GetLocalCenter().LengthSquared(), t.GetWorldCenter(), q, w),
                x = n * box2d.b2Min(x, 1) * this.ComputeDampingImpulse(e[0], f[0], g[0], h[0], k[0], l[0], v),
                this.ApplyDamping(e[0], f[0], g[0], !0, u, r, x, w),
                t.ApplyLinearImpulse(box2d.b2Mul_S_V2(-x, w, box2d.b2Vec2.s_t0), q, !0))
        }
    }
    for (p = 0; p < this.m_contactBuffer.count; p++) {
        ...
        u !== y && (z || B) && (q = box2d.b2Mid_V2_V2(m[r], m[t], c),
            v = box2d.b2Sub_V2_V2(this.GetLinearVelocity(y, t, q, a), this.GetLinearVelocity(u, r, q, b), d),
            v = box2d.b2Dot_V2_V2(v, w),
            0 > v && (this.InitDampingParameterWithRigidGroupOrParticle(e, f, g, z, u, r, q, w),
                this.InitDampingParameterWithRigidGroupOrParticle(h, k, l, B, y, t, q, w),
                x = n * x * this.ComputeDampingImpulse(e[0], f[0], g[0], h[0], k[0], l[0], v),
...
box2d.b2ParticleSystem.prototype.SolveExtraDamping = function () {
    for (var a = box2d.b2ParticleSystem.prototype.SolveExtraDamping.s_v, b = box2d.b2ParticleSystem.prototype.SolveExtraDamping.s_f, c = this.m_velocityBuffer.data, d = this.m_positionBuffer.data, e = this.GetParticleInvMass(), f = 0; f < this.m_bodyContactBuffer.count; f++) {
        var g = this.m_bodyContactBuffer.data[f]
            , h = g.index;
        if (this.m_flagsBuffer.data[h] & box2d.b2ParticleSystem.k_extraDampingFlags) {
            var k = g.body
                , l = g.mass
                , m = g.normal
                , g = d[h]
                , n = box2d.b2Sub_V2_V2(k.GetLinearVelocityFromWorldPoint(g, box2d.b2Vec2.s_t0), c[h], a)
                , n = box2d.b2Dot_V2_V2(n, m);
            0 > n && (l = box2d.b2Mul_S_V2(.5 * l * n, m, b),
                c[h].SelfMulAdd(e, l),
...
box2d.b2ParticleSystem.prototype.SolveWall = function () {
    for (var a = this.m_velocityBuffer.data, b = 0; b < this.m_count; b++)
        this.m_flagsBuffer.data[b] & box2d.b2ParticleFlag.b2_wallParticle && a[b].SetZero()
}
    ;
box2d.b2ParticleSystem.prototype.SolveRigid = function (a) {
    for (var b = box2d.b2ParticleSystem.prototype.SolveRigid.s_position, c = box2d.b2ParticleSystem.prototype.SolveRigid.s_rotation, d = box2d.b2ParticleSystem.prototype.SolveRigid.s_transform, e = box2d.b2ParticleSystem.prototype.SolveRigid.s_velocityTransform, f = this.m_positionBuffer.data, g = this.m_velocityBuffer.data, h = this.m_groupList; h; h = h.GetNext())
        if (h.m_groupFlags & box2d.b2ParticleGroupFlag.b2_rigidParticleGroup) {
            h.UpdateStatistics();
            var k = c;
            k.SetAngle(a.dt * h.m_angularVelocity);
            var l = box2d.b2Add_V2_V2(h.m_center, box2d.b2Sub_V2_V2(box2d.b2Mul_S_V2(a.dt, h.m_linearVelocity, box2d.b2Vec2.s_t0), box2d.b2Mul_R_V2(k, h.m_center, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t0), b)
                , m = d;
...
box2d.b2ParticleSystem.prototype.SolveElastic = function (a) {
    for (var b = box2d.b2ParticleSystem.prototype.SolveElastic.s_pa, c = box2d.b2ParticleSystem.prototype.SolveElastic.s_pb, d = box2d.b2ParticleSystem.prototype.SolveElastic.s_pc, e = box2d.b2ParticleSystem.prototype.SolveElastic.s_r, f = box2d.b2ParticleSystem.prototype.SolveElastic.s_t0, g = this.m_positionBuffer.data, h = this.m_velocityBuffer.data, k = a.inv_dt * this.m_def.elasticStrength, l = 0; l < this.m_triadBuffer.count; l++) {
        ...
        if (m.flags & box2d.b2ParticleFlag.b2_elasticParticle) {
            ...
            v.y -= z;
            y = e;
            y.s = box2d.b2Cross_V2_V2(r, w) + box2d.b2Cross_V2_V2(u, x) + box2d.b2Cross_V2_V2(t, v);
            y.c = box2d.b2Dot_V2_V2(r, w) + box2d.b2Dot_V2_V2(u, x) + box2d.b2Dot_V2_V2(t, v);
...
box2d.b2ParticleSystem.prototype.SolveSpring = function (a) {
    for (var b = box2d.b2ParticleSystem.prototype.SolveSpring.s_pa, c = box2d.b2ParticleSystem.prototype.SolveSpring.s_pb, d = box2d.b2ParticleSystem.prototype.SolveSpring.s_d, e = box2d.b2ParticleSystem.prototype.SolveSpring.s_f, f = this.m_positionBuffer.data, g = this.m_velocityBuffer.data, h = a.inv_dt * this.m_def.springStrength, k = 0; k < this.m_pairBuffer.count; k++) {
...
box2d.b2ParticleSystem.prototype.SolveTensile = function (a) {
    ...
    for (var b = this.m_def.surfaceTensionNormalStrength * f, m = box2d.b2_maxParticleForce * f, f = 0; f < this.m_contactBuffer.count; f++)
        if (g = this.m_contactBuffer.data[f],
            ...
            var h = g.indexA
                ...
                , p = box2d.b2Sub_V2_V2(this.m_accumulation2Buffer[k], this.m_accumulation2Buffer[h], c)
...
box2d.b2ParticleSystem.prototype.SolveViscous = function () {
    for (var a = box2d.b2ParticleSystem.prototype.SolveViscous.s_v, b = box2d.b2ParticleSystem.prototype.SolveViscous.s_f, c = this.m_positionBuffer.data, d = this.m_velocityBuffer.data, e = this.m_def.viscousStrength, f = this.GetParticleInvMass(), g = 0; g < this.m_bodyContactBuffer.count; g++) {
        ...
        if (this.m_flagsBuffer.data[k] & box2d.b2ParticleFlag.b2_viscousParticle) {
            var l = h.body
                ...
                , n = h.mass
                , h = c[k]
                , p = box2d.b2Sub_V2_V2(l.GetLinearVelocityFromWorldPoint(h, box2d.b2Vec2.s_t0), d[k], a)
    ...
    for (g = 0; g < this.m_contactBuffer.count; g++)
        h = this.m_contactBuffer.data[g],
            h.flags & box2d.b2ParticleFlag.b2_viscousParticle && (k = h.indexA,
                l = h.indexB,
                m = h.weight,
...
box2d.b2ParticleSystem.prototype.SolveRepulsive = function (a) {
    ...
    for (var d = 0; d < this.m_contactBuffer.count; d++) {
        ...
        if (e.flags & box2d.b2ParticleFlag.b2_repulsiveParticle) {
            var f = e.indexA
                , g = e.indexB;
            this.m_groupBuffer[f] !== this.m_groupBuffer[g] && (e = box2d.b2Mul_S_V2(a * e.weight, e.normal, b),
                c[f].SelfSub(e),
                c[g].SelfAdd(e))
        }
    }
...
box2d.b2ParticleSystem.prototype.SolvePowder = function (a) {
    ...
    for (var e = 1 - box2d.b2_particleStride, f = this.GetParticleInvMass(), g = 0; g < this.m_bodyContactBuffer.count; g++) {
        var h = this.m_bodyContactBuffer.data[g]
            , k = h.index;
    ...
    for (g = 0; g < this.m_contactBuffer.count; g++)
        h = this.m_contactBuffer.data[g],
            h.flags & box2d.b2ParticleFlag.b2_powderParticle && (l = h.weight,
                l > e && (k = h.indexA,
                    m = h.indexB,
                    p = h.normal,
...
box2d.b2ParticleSystem.prototype.SolveSolid = function (a) {
    ...
    for (var d = 0; d < this.m_contactBuffer.count; d++) {
        var e = this.m_contactBuffer.data[d]
            , f = e.indexA
            , g = e.indexB;
        this.m_groupBuffer[f] !== this.m_groupBuffer[g] && (e = box2d.b2Mul_S_V2(a * (this.m_depthBuffer[f] + this.m_depthBuffer[g]) * e.weight, e.normal, b),
            c[f].SelfSub(e),
            c[g].SelfAdd(e))
    }
}
    ...
    if (a)
        for (var b = 0; b < this.m_contactBuffer.count; b++) {
            var c = this.m_contactBuffer.data[b]
                , d = c.indexA
                , c = c.indexB;
            this.m_flagsBuffer.data[d] & this.m_flagsBuffer.data[c] & box2d.b2ParticleFlag.b2_colorMixingParticle && box2d.b2ParticleColor.MixColors(this.m_colorBuffer.data[d], this.m_colorBuffer.data[c], a)
        }
}
    ;
box2d.b2ParticleSystem.prototype.SolveZombie = function () {
    ...
    for (var d = 0, c = 0; c < this.m_count; c++) {
        ...
        if (e & box2d.b2ParticleFlag.b2_zombieParticle) {
            ...
            e & box2d.b2ParticleFlag.b2_destructionListenerParticle && f && f.SayGoodbyeParticle(this, c);
            this.m_handleIndexBuffer.data && (f = this.m_handleIndexBuffer.data[c]) && (f.SetIndex(box2d.b2_invalidParticleIndex),
                this.m_handleIndexBuffer.data[c] = null);
            b[c] = box2d.b2_invalidParticleIndex
        } else
            b[c] = a,
                c !== a && (this.m_handleIndexBuffer.data && ((f = this.m_handleIndexBuffer.data[c]) && f.SetIndex(a),
                    this.m_handleIndexBuffer.data[a] = f),
                    this.m_flagsBuffer.data[a] = this.m_flagsBuffer.data[c],
                    this.m_lastBodyContactStepBuffer.data && (this.m_lastBodyContactStepBuffer.data[a] = this.m_lastBodyContactStepBuffer.data[c]),
                    this.m_bodyContactCountBuffer.data && (this.m_bodyContactCountBuffer.data[a] = this.m_bodyContactCountBuffer.data[c]),
                    this.m_consecutiveContactStepsBuffer.data && (this.m_consecutiveContactStepsBuffer.data[a] = this.m_consecutiveContactStepsBuffer.data[c]),
                    ...
                    this.m_staticPressureBuffer && (this.m_staticPressureBuffer[a] = this.m_staticPressureBuffer[c]),
                    this.m_depthBuffer && (this.m_depthBuffer[a] = this.m_depthBuffer[c]),
                    this.m_colorBuffer.data && this.m_colorBuffer.data[a].Copy(this.m_colorBuffer.data[c]),
                    this.m_userDataBuffer.data && (this.m_userDataBuffer.data[a] = this.m_userDataBuffer.data[c]),
                    this.m_expirationTimeBuffer.data && (this.m_expirationTimeBuffer.data[a] = this.m_expirationTimeBuffer.data[c])),
                a++ ,
                d |= e
    }
    for (c = 0; c < this.m_proxyBuffer.count; c++)
        e = this.m_proxyBuffer.data[c],
            e.index = b[e.index];
    ...
    for (c = 0; c < this.m_bodyContactBuffer.count; c++)
        e = this.m_bodyContactBuffer.data[c],
            e.index = b[e.index];
    ...
    if (this.m_indexByExpirationTimeBuffer.data)
        for (e = c = 0; e < this.m_count; e++)
            f = b[this.m_indexByExpirationTimeBuffer.data[e]],
                f !== box2d.b2_invalidParticleIndex && (this.m_indexByExpirationTimeBuffer.data[c++] = f);
    for (e = this.m_groupList; e; e = e.GetNext()) {
        for (var f = a, g = 0, h = !1, c = e.m_firstIndex; c < e.m_lastIndex; c++) {
            var k = b[c];
            0 <= k ? (f = box2d.b2Min(f, k),
                g = box2d.b2Max(g, k + 1)) : h = !0
        }
        f < g ? (e.m_firstIndex = f,
            e.m_lastIndex = g,
            h && e.m_groupFlags & box2d.b2ParticleGroupFlag.b2_solidParticleGroup && this.SetGroupFlags(e, e.m_groupFlags | box2d.b2ParticleGroupFlag.b2_particleGroupNeedsUpdateDepth)) : (e.m_firstIndex = 0,
                e.m_lastIndex = 0,
                e.m_groupFlags & box2d.b2ParticleGroupFlag.b2_particleGroupCanBeEmpty || this.SetGroupFlags(e, e.m_groupFlags | box2d.b2ParticleGroupFlag.b2_particleGroupWillBeDestroyed))
    }
    this.m_count = a;
    ...
    for (e = this.m_groupList; e;)
        a = e.GetNext(),
            e.m_groupFlags & box2d.b2ParticleGroupFlag.b2_particleGroupWillBeDestroyed && this.DestroyParticleGroup(e),
            e = a
}
    ;
box2d.b2ParticleSystem.prototype.SolveLifetimes = function (a) {
    ...
    this.m_expirationTimeBufferRequiresSorting && (box2d.std_sort(c, 0, d, function (a, c) {
        var d = b[a]
            , e = b[c]
            , f = 0 >= d;
        return f === 0 >= e ? d > e : f
...
box2d.b2ParticleSystem.prototype.RotateBuffer = function (a, b, c) {
    ...
    if (a !== b && b !== c) {
        ...
        this.m_lastBodyContactStepBuffer.data && box2d.std_rotate(this.m_lastBodyContactStepBuffer.data, a, b, c);
        this.m_bodyContactCountBuffer.data && box2d.std_rotate(this.m_bodyContactCountBuffer.data, a, b, c);
        this.m_consecutiveContactStepsBuffer.data && box2d.std_rotate(this.m_consecutiveContactStepsBuffer.data, a, b, c);
        ...
        this.m_staticPressureBuffer && box2d.std_rotate(this.m_staticPressureBuffer, a, b, c);
        this.m_depthBuffer && box2d.std_rotate(this.m_depthBuffer, a, b, c);
        this.m_colorBuffer.data && box2d.std_rotate(this.m_colorBuffer.data, a, b, c);
        this.m_userDataBuffer.data && box2d.std_rotate(this.m_userDataBuffer.data, a, b, c);
        if (this.m_handleIndexBuffer.data) {
        ...
        if (this.m_expirationTimeBuffer.data) {
            ...
            for (var f = this.GetParticleCount(), g = this.m_indexByExpirationTimeBuffer.data, e = 0; e < f; ++e)
                g[e] = d(g[e])
        }
        for (e = 0; e < this.m_proxyBuffer.count; e++)
            f = this.m_proxyBuffer.data[e],
                f.index = d(f.index);
        for (e = 0; e < this.m_contactBuffer.count; e++)
        ...
        for (e = 0; e < this.m_bodyContactBuffer.count; e++)
            f = this.m_bodyContactBuffer.data[e],
                f.index = d(f.index);
...
box2d.b2ParticleSystem.prototype.SetGroupFlags = function (a, b) {
    ...
    (c ^ b) & box2d.b2ParticleGroupFlag.b2_solidParticleGroup && (b |= box2d.b2ParticleGroupFlag.b2_particleGroupNeedsUpdateDepth);
    c & ~b && (this.m_needsUpdateAllGroupFlags = !0);
    ~this.m_allGroupFlags & b && (b & box2d.b2ParticleGroupFlag.b2_solidParticleGroup && (this.m_depthBuffer = this.RequestBuffer(this.m_depthBuffer)),
...
box2d.b2ParticleSystem.prototype.RemoveSpuriousBodyContacts = function () {
    ...
    var a = box2d.b2ParticleSystem.prototype.RemoveSpuriousBodyContacts.s_n
        ...
        , f = 0
        , g = 0;
    this.m_bodyContactBuffer.count = box2d.std_remove_if(this.m_bodyContactBuffer.data, function (h) {
        h.index !== e && (f = 0,
            e = h.index);
        if (3 < f++)
            return ++g,
...
box2d.b2ParticleSystem.prototype.DetectStuckParticle = function (a) {
    0 >= this.m_stuckThreshold || (++this.m_bodyContactCountBuffer.data[a],
        2 === this.m_bodyContactCountBuffer.data[a] && (++this.m_consecutiveContactStepsBuffer.data[a],
            this.m_consecutiveContactStepsBuffer.data[a] > this.m_stuckThreshold && (this.m_stuckParticleBuffer.data[this.m_stuckParticleBuffer.Append()] = a)),
...
box2d.b2ParticleSystem.prototype.ValidateParticleIndex = function (a) {
    return 0 <= a && a < this.GetParticleCount() && a !== box2d.b2_invalidParticleIndex
}
    ;
...
box2d.b2ParticleSystem.prototype.PrepareForceBuffer = function () {
    if (!this.m_hasForce) {
        for (var a = 0; a < this.m_count; a++)
            this.m_forceBuffer[a].SetZero();
        this.m_hasForce = !0
    }
}
    ;
box2d.b2ParticleSystem.prototype.IsRigidGroup = function (a) {
    return null !== a && 0 !== (a.m_groupFlags & box2d.b2ParticleGroupFlag.b2_rigidParticleGroup)
}
    ;
box2d.b2ParticleSystem.prototype.GetLinearVelocity = function (a, b, c, d) {
    return this.IsRigidGroup(a) ? a.GetLinearVelocityFromWorldPoint(c, d) : d.Copy(this.m_velocityBuffer.data[b])
}
    ;
box2d.b2ParticleSystem.prototype.InitDampingParameter = function (a, b, c, d, e, f, g, h) {
    a[0] = 0 < d ? 1 / d : 0;
    b[0] = 0 < e ? 1 / e : 0;
    c[0] = box2d.b2Cross_V2_V2(box2d.b2Sub_V2_V2(g, f, box2d.b2Vec2.s_t0), h)
}
    ;
box2d.b2ParticleSystem.prototype.InitDampingParameterWithRigidGroupOrParticle = function (a, b, c, d, e, f, g, h) {
    d ? this.InitDampingParameter(a, b, c, e.GetMass(), e.GetInertia(), e.GetCenter(), g, h) : this.InitDampingParameter(a, b, c, this.m_flagsBuffer.data[f] & box2d.b2ParticleFlag.b2_wallParticle ? 0 : this.GetParticleMass(), 0, g, g, h)
}
    ;
box2d.b2ParticleSystem.prototype.ComputeDampingImpulse = function (a, b, c, d, e, f, g) {
    a = a + b * c * c + d + e * f * f;
    return 0 < a ? g / a : 0
}
    ;
box2d.b2ParticleSystem.prototype.ApplyDamping = function (a, b, c, d, e, f, g, h) {
    d ? (e.m_linearVelocity.SelfMulAdd(g * a, h),
        e.m_angularVelocity += g * c * b) : this.m_velocityBuffer.data[f].SelfMulAdd(g * a, h)
}
    ;
...
box2d.b2StackQueue.prototype.Push = function (a) {
    if (this.m_back >= this.m_capacity) {
        ...
        this.m_front = 0;
        this.m_back >= this.m_capacity && (0 < this.m_capacity ? (this.m_buffer.concat(box2d.b2MakeArray(this.m_capacity)),
            this.m_capacity *= 2) : (this.m_buffer.concat(box2d.b2MakeArray(1)),
                this.m_capacity = 1))
    }
...
box2d.b2VoronoiDiagram.prototype.Generate = function (a, b) {
    ...
    for (var c = 1 / a, d = new box2d.b2Vec2(+box2d.b2_maxFloat, +box2d.b2_maxFloat), e = new box2d.b2Vec2(-box2d.b2_maxFloat, -box2d.b2_maxFloat), f = 0, g = 0; g < this.m_generatorCount; g++) {
        var h = this.m_generatorBuffer[g];
        h.necessary && (box2d.b2Min_V2_V2(d, h.center, d),
            box2d.b2Max_V2_V2(e, h.center, e),
            ++f)
    }
    if (0 === f)
        this.m_countY = this.m_countX = 0;
    else {
        d.x -= b;
        d.y -= b;
        e.x += b;
        ...
        for (g = 0; g < this.m_generatorCount; g++) {
            ...
            0 <= f && 0 <= k && f < this.m_countX && k < this.m_countY && e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f, k, f + k * this.m_countX, h))
        }
        for (; !e.Empty();)
            g = e.Front(),
                f = g.m_x,
                ...
                h = g.m_generator,
                e.Pop(),
                this.m_diagram[c] || (this.m_diagram[c] = h,
                    0 < f && e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f - 1, k, c - 1, h)),
                    0 < k && e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f, k - 1, c - this.m_countX, h)),
                    f < this.m_countX - 1 && e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f + 1, k, c + 1, h)),
                    k < this.m_countY - 1 && e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f, k + 1, c + this.m_countX, h)));
        for (k = 0; k < this.m_countY; k++)
            for (f = 0; f < this.m_countX - 1; f++)
                c = f + k * this.m_countX,
                    d = this.m_diagram[c],
                    g = this.m_diagram[c + 1],
                    d !== g && (e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f, k, c, g)),
                        e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f + 1, k, c + 1, d)));
        for (k = 0; k < this.m_countY - 1; k++)
            for (f = 0; f < this.m_countX; f++)
                c = f + k * this.m_countX,
                    ...
                    d !== g && (e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f, k, c, g)),
                        e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f, k + 1, c + this.m_countX, d)));
        for (; !e.Empty();)
            if (g = e.Front(),
                f = g.m_x,
                k = g.m_y,
                ...
                var h = d.center.x - f
                    ...
                    , l = g.center.x - f
                    , m = g.center.y - k;
                h * h + d * d > l * l + m * m && (this.m_diagram[c] = g,
                    0 < f && e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f - 1, k, c - 1, g)),
                    0 < k && e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f, k - 1, c - this.m_countX, g)),
                    f < this.m_countX - 1 && e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f + 1, k, c + 1, g)),
                    k < this.m_countY - 1 && e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f, k + 1, c + this.m_countX, g)))
            }
    }
}
    ;
...
box2d.b2VoronoiDiagram.prototype.GetNodes = function (a) {
    for (var b = 0; b < this.m_countY - 1; b++)
        for (var c = 0; c < this.m_countX - 1; c++) {
            ...
            f !== g && (e !== f && e !== g && (e.necessary || f.necessary || g.necessary) && a(e.tag, f.tag, g.tag),
                d !== f && d !== g && (e.necessary || f.necessary || g.necessary) && a(f.tag, d.tag, g.tag))
        }
}
    ;
...
box2d.b2Rope.prototype.Step = function (a, b) {
    if (0 !== a) {
        ...
        c = 1 / a;
        for (d = 0; d < this.m_count; ++d)
            box2d.b2Mul_S_V2(c, box2d.b2Sub_V2_V2(this.m_ps[d], this.m_p0s[d], box2d.b2Vec2.s_t0), this.m_vs[d])
    }
}
    ;
    ...
    for (var a = this.m_count - 2, b = 0; b < a; ++b) {
        ...
        if (0 !== m * n) {
            var p = box2d.b2Cross_V2_V2(k, l)
                ...
                , k = m
                , m = f * box2d.b2Dot_V2_V2(l, l) + g * box2d.b2Dot_V2_V2(n, n) + h * box2d.b2Dot_V2_V2(k, k);
            if (0 !== m) {
                m = 1 / m;
...
box2d.b2Rope.prototype.Draw = function (a) {
    for (var b = new box2d.b2Color(.4, .5, .7), c = 0; c < this.m_count - 1; ++c)
    ...
    if (this.m_bodyList)
        for (this.useWorldGravity && this.gravity.Copy(this.GetWorld().GetGravity()),
            ...
            if (b.IsAwake()) {
                ...
                d.x /= f;
                d.y /= f;
                e < box2d.b2_epsilon || (f = this.gravity.Clone().SelfNeg(),
                    ...
                    b.ApplyForce(d, c),
                    b.ApplyTorque(-b.GetInertia() / b.GetMass() * e * b.GetAngularVelocity() * this.angularDrag))
            }
        }
}
    ;
...
box2d.b2ConstantAccelController.prototype.Step = function (a) {
    a = box2d.b2Mul_S_V2(a.dt, this.A, box2d.b2ConstantAccelController.prototype.Step.s_dtA);
    for (var b = this.m_bodyList; b; b = b.nextBody) {
        var c = b.body;
        c.IsAwake() && c.SetLinearVelocity(box2d.b2Add_V2_V2(c.GetLinearVelocity(), a, box2d.b2Vec2.s_t0))
    }
}
    ;
    ...
    if (this.invSqr)
        for (a = this.m_bodyList; a; a = a.nextBody)
            for (var b = a.body, c = b.GetWorldCenter(), d = b.GetMass(), e = this.m_bodyList; e !== a; e = e.nextBody) {
                var f = e.body
                    ...
                    , l = g.y - c.y
                    , m = k * k + l * l;
                m < box2d.b2_epsilon || (k = box2d.b2GravityController.prototype.Step.s_f.Set(k, l),
        ...
        for (a = this.m_bodyList; a; a = a.nextBody)
            for (b = a.body,
                c = b.GetWorldCenter(),
                d = b.GetMass(),
                e = this.m_bodyList; e !== a; e = e.nextBody)
                f = e.body,
                    g = f.GetWorldCenter(),
                    h = f.GetMass(),
                    k = g.x - c.x,
...
box2d.b2TensorDampingController.prototype.Step = function (a) {
    ...
    if (!(a <= box2d.b2_epsilon)) {
        ...
        for (var b = this.m_bodyList; b; b = b.nextBody) {
            var c = b.body;
            if (c.IsAwake()) {
                var d = c.GetWorldVector(box2d.b2Mul_M22_V2(this.T, c.GetLocalVector(c.GetLinearVelocity(), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t1), box2d.b2TensorDampingController.prototype.Step.s_damping);
                c.SetLinearVelocity(box2d.b2Add_V2_V2(c.GetLinearVelocity(), box2d.b2Mul_S_V2(a, d, box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t1))
            }
        }
    }
}
...
(function (exports, Laya) {
    ...
    class ContactListener {
        ...
        PreSolve(contact, oldManifold) {
            // console.log("oldManifold>>>>",oldManifold);
